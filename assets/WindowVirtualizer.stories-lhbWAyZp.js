import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-02-cdWP6.js";import{S as U,d as G}from"./common-BqtzafjA.js";import{u as D,a as F,A as J,c as q,r as b,U as X,d as Y,e as K,j as Q,f as Z,k as ee,l as ne}from"./useLatestRef-B-C45j_1.js";import{u as te,L as re}from"./useChildren-1yx12cLR.js";import{r as se}from"./index-egG3nm26.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DuTlWdU1.js";const h=r.forwardRef(({children:l,data:i,bufferSize:s,itemSize:o,shift:t,horizontal:c,cache:u,ssrCount:p,as:d="div",item:f="div",onScroll:g,onScrollEnd:x},y)=>{d=d;const[S,n]=te(l,i),I=r.useRef(null),_=D(g),w=D(x),$=r.useRef(!!p),[a,V,k,W]=F(()=>{const m=!!c,v=Z(n,o,p,u,!o);return[v,ee(v,m),ne(v,m),m]});n!==a.$getItemsLength()&&a.$update(J,[n,t]);const[M,N]=r.useReducer(a.$getStateVersion,void 0,a.$getStateVersion),B=a.$isScrolling(),H=a.$getTotalSize(),O=[];q(()=>{$[b]=!1,a.$subscribe(X,v=>{v?se.flushSync(N):N()}),a.$subscribe(Y,()=>{_[b]&&_[b]()}),a.$subscribe(K,()=>{w[b]&&w[b]()});const m=I[b];return V.$observeRoot(m),k.$observe(m),()=>{a.$dispose(),V.$dispose(),k.$dispose()}},[]),q(()=>{k.$fixScrollJump()},[M]),r.useImperativeHandle(y,()=>({get cache(){return a.$getCacheSnapshot()},findStartIndex:()=>a.$findItemIndex(a.$getScrollOffset()),findEndIndex:()=>a.$findItemIndex(a.$getScrollOffset()+a.$getViewportSize()),scrollToIndex:k.$scrollToIndex}),[]);for(let[m,v]=a.$getRange(s);m<=v;m++){const P=S(m);O.push(e.jsx(re,{_resizer:V.$observeItem,_index:m,_offset:a.$getItemOffset(m),_hide:a.$isUnmeasuredItem(m),_as:f,_children:P,_isHorizontal:W,_isSSR:$[b]},Q(P,m)))}return e.jsx(d,{ref:I,style:{contain:"size style",overflowAnchor:"none",flex:"none",position:"relative",width:W?H:"100%",height:W?"100%":H,pointerEvents:B?"none":void 0},children:O})});h.__docgenInfo={description:"{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",methods:[{name:"cache",docblock:null,modifiers:["get"],params:[],returns:null},{name:"findStartIndex",docblock:null,modifiers:[],params:[],returns:null},{name:"findEndIndex",docblock:null,modifiers:[],params:[],returns:null}],displayName:"WindowVirtualizer",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ((data: T, index: number) => ReactElement)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:`Elements rendered by this component.

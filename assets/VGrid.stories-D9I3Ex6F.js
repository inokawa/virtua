import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as m}from"./iframe-D5mdy-iQ.js";import{a as se,A as W,g as I,u as A,c as j,r as v,U as D,d as ie,e as le,f as q,p as de,q as ae,n as ce}from"./useLatestRef-v5V7Khko.js";import{r as Z}from"./index-BMl_gUJN.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DChRQvNm.js";const ue=t=>m.useCallback(n=>{for(const d of t)d&&(typeof d=="function"?d(n):d&&(d.current=n))},t),L=(t,n)=>`${t}-${n}`,me=m.memo(({_children:t,_resizer:n,_rowIndex:d,_colIndex:p,_top:b,_left:h,_height:l,_width:a,_hide:c,_element:u})=>{const g=m.useRef(null);return j(()=>n.$observeItem(g[v],d,p),[p,d]),e.jsx(u,{ref:g,style:m.useMemo(()=>({contain:"layout style",display:"grid",position:"absolute",top:b,[ce()?"right":"left"]:h,visibility:c?"hidden":void 0,minHeight:l,minWidth:a}),[b,h,a,l,c]),children:t})}),x=m.forwardRef(({children:t,row:n,col:d,cellHeight:p=40,cellWidth:b=100,bufferSize:h,initialRowCount:l,initialColCount:a,item:c="div",domRef:u,innerDomRef:g,onScroll:f,onScrollEnd:y,style:P,...U},B)=>{const[r,s,S,w]=se(()=>{const o=q(n,p,l),i=q(d,b,a);return[o,i,de(o,i),ae(o,i)]});n!==r.$getItemsLength()&&r.$update(W,[n]),d!==s.$getItemsLength()&&s.$update(W,[d]);const[F,V]=m.useReducer(r.$getStateVersion,void 0,r.$getStateVersion),[X,G]=m.useReducer(s.$getStateVersion,void 0,s.$getStateVersion),J=r.$isScrolling(),K=s.$isScrolling(),Y=I(r),Q=I(s),N=m.useRef(null),M=A(f),_=A(y);j(()=>{const o=N[v];return r.$subscribe(D,i=>{i?Z.flushSync(V):V()}),s.$subscribe(D,i=>{i?Z.flushSync(G):G()}),r.$subscribe(ie,()=>{M[v]&&M[v](r.$getScrollOffset())}),r.$subscribe(le,()=>{_[v]&&_[v]()}),S.$observeRoot(o),w.$observe(o),()=>{r.$dispose(),s.$dispose(),S.$dispose(),w.$dispose()}},[]),j(()=>{w.$fixScrollJump()},[F,X]),m.useImperativeHandle(B,()=>({get scrollTop(){return r.$getScrollOffset()},get scrollLeft(){return s.$getScrollOffset()},get scrollHeight(){return I(r)},get scrollWidth(){return I(s)},get viewportHeight(){return r.$getViewportSize()},get viewportWidth(){return s.$getViewportSize()},findStartIndex:()=>[s.$findItemIndex(s.$getStartSpacerSize()+s.$getScrollOffset()),r.$findItemIndex(r.$getStartSpacerSize()+r.$getScrollOffset())],findEndIndex:()=>[s.$findItemIndex(s.$getStartSpacerSize()+s.$getScrollOffset()+s.$getViewportSize()),r.$findItemIndex(r.$getStartSpacerSize()+r.$getScrollOffset()+r.$getViewportSize())],getItemOffset:(o,i)=>[s.$getItemOffset(o),r.$getItemOffset(i)],getItemSize:(o,i)=>[s.$getItemSize(o),r.$getItemSize(i)],resizeCols(o){S.$resizeCols(o)},resizeRows(o){S.$resizeRows(o)},scrollToIndex:w.$scrollToIndex,scrollTo:w.$scrollTo,scrollBy:w.$scrollBy}),[]);const ee=m.useMemo(()=>{const o=new Map;return(i,H)=>{let k=o.get(L(i,H));return k||o.set(L(i,H),k=t({rowIndex:i,colIndex:H})),k}},[t]),[ne,re]=r.$getRange(h),[te,oe]=s.$getRange(h),O=[];for(let o=ne;o<=re;o++)for(let i=te;i<=oe;i++)O.push(e.jsx(me,{_resizer:S,_rowIndex:o,_colIndex:i,_top:r.$getItemOffset(o),_left:s.$getItemOffset(i),_height:r.$getItemSize(o),_width:s.$getItemSize(i),_hide:r.$isUnmeasuredItem(o)||s.$isUnmeasuredItem(i),_element:c,_children:ee(o,i)},L(o,i)));return e.jsx("div",{ref:ue([N,u]),...U,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",...P},children:e.jsx("div",{ref:g,style:{contain:"size style",overflowAnchor:"none",flex:"none",position:"relative",width:Q,height:Y,pointerEvents:J||K?"none":void 0},children:O})})});x.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",methods:[{name:"scrollTop",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollLeft",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"findStartIndex",docblock:null,modifiers:[],params:[],returns:null},{name:"findEndIndex",docblock:null,modifiers:[],params:[],returns:null},{name:"getItemOffset",docblock:null,modifiers:[],params:[{name:"indexX",optional:!1,type:null},{name:"indexY",optional:!1,type:null}],returns:null},{name:"getItemSize",docblock:null,modifiers:[],params:[{name:"indexX",optional:!1,type:null},{name:"indexY",optional:!1,type:null}],returns:null},{name:"resizeCols",docblock:null,modifiers:[],params:[{name:"cols",optional:!1,type:null}],returns:null},{name:"resizeRows",docblock:null,modifiers:[],params:[{name:"rows",optional:!1,type:null}],returns:null}],displayName:"VGrid",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(arg: {
  /**
   * row index of cell
   */
  rowIndex: number;
...
}`,...z.parameters?.docs?.source}}};const ve=["Default","Fixed","DynamicHeight","DynamicWidth","Resizeable","ScrollTo"];export{T as Default,E as DynamicHeight,C as DynamicWidth,R as Fixed,$ as Resizeable,z as ScrollTo,ve as __namedExportsOrder,we as default};

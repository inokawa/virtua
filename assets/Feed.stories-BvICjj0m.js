import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{f as n}from"./iframe-D8Mnq5OL.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{n as i,t as a}from"./VList-D8E1j2HX.js";import{n as o,t as s}from"./en-DltMjSLJ.js";import{i as c,n as l,r as u}from"./common-B5D_Jy0j.js";var d,f,p,m,h,g,_;function v(){return(v=t((()=>{i(),d=e(n(),1),u(),s(),f=r(),p={component:a},m={borderTop:`solid 1px #ccc`,background:`#fff`,padding:32,paddingTop:48,paddingBottom:48,whiteSpace:`pre-wrap`},h=({content:e})=>(0,f.jsxs)(`div`,{style:m,children:[e,` `]}),g={name:`Feed`,render:()=>{let e=(0,d.useRef)(0),t=()=>{let t=e.current++;return t%3==1?{type:`image`,id:t,src:o.image.url()}:{type:`text`,id:t,value:o.lorem.paragraphs(Math.floor(Math.random()*10)+1)}},n=e=>c(e,t),[r,i]=(0,d.useState)(!1),s=async(e=!1)=>{i(e),await l(1e3)},u=(0,d.useRef)(null),[p,m]=(0,d.useState)(()=>n(60)),g=(0,d.useMemo)(()=>p.map(e=>(0,f.jsx)(h,{content:e.type===`image`?(0,f.jsx)(`img`,{src:e.src,style:{maxWidth:`100%`}}):e.value},e.id)),[p]),_=p.length,v=(0,d.useRef)(-1),y=(0,d.useRef)(-1),b=(0,d.useRef)(!1);return(0,d.useEffect)(()=>{u.current?.scrollToIndex(p.length/2+1),b.current=!0},[]),(0,f.jsx)(a,{ref:u,style:{flex:1},shift:!!r,onScroll:async()=>{if(!b.current||!u.current)return;let e=u.current.scrollOffset,t=e+u.current.viewportSize;y.current<_&&u.current.findItemIndex(t)+10>_?(y.current=_,await s(),m(e=>[...e,...n(30)])):v.current<_&&u.current.findItemIndex(e)-10<0&&(v.current=_,await s(!0),m(e=>[...n(30),...e]))},children:g})}},_=[`Default`],g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: "Feed",
  render: () => {
    const id = useRef(0);
...
}`,...g.parameters?.docs?.source}}}})))()}v();export{g as Default,_ as __namedExportsOrder,p as default};
import{j as s,a as _}from"./jsx-runtime-c3d7f245.js";import{r as a}from"./index-c6dae603.js";import{u as c,a as k,r as ue,b as ye,c as K,d as U,m as Y,e as $,f as _e}from"./resizer-5270f707.js";import"./index-7f713258.js";const E=(n,e)=>`${n}-${e}`,we=a.memo(({_children:n,_resizer:e,_verticalStore:r,_horizontalStore:o,_rowIndex:u,_colIndex:l,_element:p})=>{const w=a.useRef(null),g=c(r._subscribe,()=>r._getItemOffset(u)),b=c(o._subscribe,()=>o._getItemOffset(l)),v=c(r._subscribe,()=>r._isUnmeasuredItem(u)),x=c(o._subscribe,()=>o._isUnmeasuredItem(l)),z=c(r._subscribe,()=>r._getItemSize(u)),I=c(o._subscribe,()=>o._getItemSize(l));return k(()=>e._observeItem(w[ue],u,l),[l,u]),s(p,{ref:w,style:a.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:g,[r._isRtl()?"right":"left"]:b,visibility:v||x?"hidden":"visible",minHeight:z,minWidth:I}),[g,b,I,z,v,x]),children:n})}),be=a.forwardRef(({children:n,scrollWidth:e,scrollHeight:r,scrolling:o,attrs:u},l)=>s("div",{ref:l,...u,children:s("div",{style:a.useMemo(()=>({position:"relative",visibility:"hidden",width:e,height:r,pointerEvents:o?"none":"auto"}),[e,r,o]),children:n})})),ve=({_children:n,_ref:e,_vStore:r,_hStore:o,_element:u,_scrolling:l,_attrs:p})=>{const w=c(r._subscribe,r._getScrollSize),g=c(o._subscribe,o._getScrollSize);return s(u,{ref:e,scrollWidth:g,scrollHeight:w,scrolling:l,attrs:a.useMemo(()=>({...p,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",padding:0,margin:0,...p.style}}),[p]),children:n})},m=a.forwardRef(({children:n,row:e,col:r,cellHeight:o=40,cellWidth:u=100,overscan:l=2,initialRowCount:p,initialColCount:w,rtl:g,element:b=be,cellElement:v="div",...x},z)=>{const[I,q]=a.useState(!1),[he,me]=a.useState(!1),[f,y,M,D,J]=ye(()=>{const d=()=>{},t=K(e,o,!1,!!g,p,q,d),i=K(r,u,!0,!!g,w,me,d),h=_e(t,i);return[t,i,h,U(t,()=>h._isJustResized()),U(i,()=>h._isJustResized(!0))]});f._updateCacheLength(e),y._updateCacheLength(r);const[j,pe]=c(f._subscribe,f._getRange),[A,ge]=c(y._subscribe,y._getRange),W=c(f._subscribe,f._getJump),H=c(y._subscribe,y._getJump),T=a.useRef(null);k(()=>{const d=T[ue],t=M._observeRoot(d),i=D._initRoot(d),h=J._initRoot(d);return()=>{t(),i(),h()}},[]),k(()=>{W.length&&D._fixScrollJump(W,j)},[W]),k(()=>{H.length&&J._fixScrollJump(H,A)},[H]);const P=a.useMemo(()=>{const d=new Map;return(t,i)=>{let h=d.get(E(t,i));return h||d.set(E(t,i),h=n({rowIndex:t,colIndex:i})),h}},[n]),N=Y(j-l,0),O=$(pe+l,e-1),F=Y(A-l,0),L=$(ge+l,r-1),fe=a.useMemo(()=>{const d=[];for(let t=N;t<=O;t++)for(let i=F;i<=L;i++)d.push(s(we,{_resizer:M,_verticalStore:f,_horizontalStore:y,_rowIndex:t,_colIndex:i,_element:v,_children:P(t,i)},E(t,i)));return d},[P,N,O,F,L]);return s(ve,{_ref:T,_vStore:f,_hStore:y,_element:b,_scrolling:I||he,_children:fe,_attrs:x})});try{m.displayName="VGrid",m.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
//# sourceMappingURL=VGrid.stories-d69b21ef.js.map

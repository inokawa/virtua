import{j as l}from"./jsx-runtime-CRdFn2pK.js";import"./index-CVQug6lh.js";import{r as t}from"./iframe-BvAKqPok.js";import{r as a}from"./common-BcHFrF5x.js";import{V as T}from"./VList-BfHBVb-S.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-CrEL19Tp.js";import"./useLatestRef-DhNElndx.js";import"./useChildren-Dfk25ci5.js";import"./index-CTaNL9Sn.js";import"./index-GHjdeYM9.js";const F={component:T},c={name:"Loop",render:()=>{const m=t.useRef(0),p=()=>({id:m.current++}),u=e=>a(e,p),n=t.useRef(null),[f,o]=t.useState(()=>u(200)),i=t.useRef(-1),s=t.useRef(!1);return t.useLayoutEffect(()=>{n.current?.scrollToIndex(200/2)},[]),l.jsx(T,{ref:n,style:{flex:1},shift:s.current,onScroll:e=>{if(s.current=e-i.current<0,i.current=e,!n.current)return;const d=s.current;e<100?(o(r=>[...u(200/4),...r]),setTimeout(()=>{s.current=!d,o(r=>[...r.slice(0,600/4)])},50)):n.current.scrollSize-n.current.viewportSize-e<100&&(o(r=>[...r,...u(200/4)]),setTimeout(()=>{s.current=!d,o(r=>[...r.slice(200/4)])},50))},children:f.map(e=>l.jsx("div",{style:{height:100,backgroundColor:e.id%100===0?"darkgray":e.id%10===0?"smokegray":"white",borderBottom:"solid 1px #ccc"},children:e.id},e.id))})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  name: "Loop",
  render: () => {
...
}`,...c.parameters?.docs?.source}}};const g=["Default"];export{c as Default,g as __namedExportsOrder,F as default};

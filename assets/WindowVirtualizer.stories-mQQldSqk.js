import{j as e}from"./jsx-runtime-8jz8AX3D.js";import{r}from"./iframe-LulOvcvi.js";import{S as ge,d as xe}from"./common-D06Lj-lt.js";import{b as q,a as ye,A as ve,u as M,r as w,U as be,c as we,d as Se,n as Ie,e as Ce,o as ke,p as Te}from"./useLatestRef--kb8og7S.js";import{u as je,L as Re}from"./useChildren-DoabCROk.js";import{r as ze}from"./index-BnKoFU31.js";const h=r.forwardRef(({children:l,count:i,overscan:s,itemSize:o,shift:t,horizontal:c,cache:u,ssrCount:p,as:a="div",item:f="div",onScroll:g,onScrollEnd:x},y)=>{a=a;const[C,n]=je(l,i),v=r.useRef(null),S=q(g),I=q(x),H=r.useRef(!!p),[d,W,k,N]=ye(()=>{const m=!!c,b=Ce(n,o,s,p,u,!o);return[b,ke(b,m),Te(b,m),m]});n!==d.$getItemsLength()&&d.$update(ve,[n,t]);const[ue,$]=r.useReducer(d.$getStateVersion,void 0,d.$getStateVersion),[pe,me]=d.$getRange(),he=d.$isScrolling(),O=d.$getTotalSize(),P=[];M(()=>{H[w]=!1;const m=d.$subscribe(be,fe=>{fe?ze.flushSync($):$()}),b=d.$subscribe(we,()=>{S[w]&&S[w]()}),T=d.$subscribe(Se,()=>{I[w]&&I[w]()}),D=v[w];return W.$observeRoot(D),k.$observe(D),()=>{m(),b(),T(),W.$dispose(),k.$dispose()}},[]),M(()=>{k.$fixScrollJump()},[ue]),r.useImperativeHandle(y,()=>({get cache(){return d.$getCacheSnapshot()},findStartIndex:d.$findStartIndex,findEndIndex:d.$findEndIndex,scrollToIndex:k.$scrollToIndex}),[]);for(let m=pe,b=me;m<=b;m++){const T=C(m);P.push(e.jsx(Re,{_resizer:W.$observeItem,_index:m,_offset:d.$getItemOffset(m),_hide:d.$isUnmeasuredItem(m),_as:f,_children:T,_isHorizontal:N,_isSSR:H[w]},Ie(T,m)))}return e.jsx(a,{ref:v,style:{flex:"none",position:"relative",visibility:"hidden",width:N?O:"100%",height:N?"100%":O,pointerEvents:he?"none":void 0},children:P})});h.__docgenInfo={description:"{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",methods:[{name:"cache",docblock:null,modifiers:["get"],params:[],returns:null}],displayName:"WindowVirtualizer",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ((index: number) => ReactElement)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:`Elements rendered by this component.
...
@defaultValue "div"`,defaultValue:{value:'"div"',computed:!1}},onScroll:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked whenever scroll offset changes."},onScrollEnd:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked when scrolling stops."}}};const V=l=>{const i=[20,40,80,77];return Array.from({length:l}).map((s,o)=>e.jsx("div",{style:{height:i[o%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:o},o))},Le=l=>Array.from({length:l}).map((i,s)=>e.jsxs("div",{style:{width:s%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",s]},s)),$e={component:h},j={render:()=>e.jsx("div",{style:{padding:"200px 100px"},children:e.jsx("div",{style:{border:"solid 1px gray"},children:e.jsx(h,{children:V(1e3)})})})},R={render:()=>e.jsx("div",{style:{padding:"100px 200px"},children:e.jsx("div",{style:{display:"inline-block",border:"solid 1px gray",height:400},children:e.jsx(h,{horizontal:!0,children:Le(1e3)})})})},z={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column"},children:[e.jsx("div",{style:{background:"white",height:60,marginBottom:40},children:"header"}),e.jsxs("div",{style:{display:"flex",flexDirection:"row"},children:[e.jsx("div",{style:{flex:1,display:"flex",paddingTop:600,margin:10},children:e.jsx(h,{children:V(1e3)})}),e.jsx("div",{style:{flex:3,margin:10},children:e.jsx(h,{children:Array.from({length:1e3}).map((l,i)=>e.jsx("div",{style:{height:200,borderRadius:8,margin:16,background:"#fff"},children:i},i))})}),e.jsx("div",{style:{flex:2,padding:20,paddingTop:300},children:e.jsx("div",{style:{top:0,height:400,position:"sticky",background:"white"}})})]}),e.jsx("div",{style:{background:"white",height:60,marginTop:40},children:"footer"})]})},L={render:()=>{const l=(g,x=0)=>{const y=[20,40,80,77];return Array.from({length:g}).map((C,n)=>(n+=x,e.jsx("div",{style:{height:y[n%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n},n)))},[i,s]=r.useState(!1),o=async()=>{s(!0),await xe(1e3),s(!1)},t=100,[c,u]=r.useState(()=>l(t)),p=r.useRef(-1),a=c.length,f=r.useRef(null);return e.jsx("div",{style:{padding:"200px 100px 0px 100px"},children:e.jsxs(h,{ref:f,onScroll:async()=>{f.current&&p.current<a&&f.current.findEndIndex()+50>a&&(p.current=a,await o(),u(g=>[...g,...l(t,g.length)]))},children:[c,i&&e.jsx(ge,{})]})})}},Ee=({id:l})=>{const i="window-list-cache-"+l,s=r.useRef(null),[o,t]=r.useMemo(()=>{const c=sessionStorage.getItem(i);if(!c)return[];try{return JSON.parse(c)}catch{return[]}},[]);return r.useLayoutEffect(()=>{if(!s.current)return;const c=s.current;window.scrollTo(0,o??0);let u=0;const p=()=>{u=window.scrollY};return window.addEventListener("scroll",p),p(),()=>{window.removeEventListener("scroll",p),sessionStorage.setItem(i,JSON.stringify([u,c.cache]))}},[]),e.jsx(h,{ref:s,cache:t,children:V(1e3)})},E={render:()=>{const[l,i]=r.useState(!0),[s,o]=r.useState("1");return e.jsxs("div",{style:{position:"relative"},children:[e.jsxs("div",{style:{position:"fixed",top:0,left:0,zIndex:10},children:[e.jsx("button",{onClick:()=>{i(t=>!t)},children:l?"hide":"show"}),["1","2","3"].map(t=>e.jsxs("label",{children:[e.jsx("input",{type:"radio",checked:s===t,onChange:()=>{o(t)}}),t]},t))]}),l&&e.jsx(Ee,{id:s},s)]})}},_={render:()=>{const l=r.useRef(0),i=(n,v)=>Array.from({length:n}).map((S,I)=>(I+=v,{id:l.current++,index:I})),[s,o]=r.useState(!1),[t,c]=r.useState(4),[u,p]=r.useState(!1),[a,f]=r.useState(!0),[g,x]=r.useState(()=>i(t,0)),y=()=>{x(a?n=>{var v,S;return u?[...i(t,(((v=n[0])==null?void 0:v.index)??0)-t),...n]:[...n,...i(t,(((S=n[n.length-1])==null?void 0:S.index)??0)+1)]}:u?n=>n.slice(t):n=>n.slice(0,-t))};r.useEffect(()=>{if(!s)return;const n=setInterval(y,500);return()=>{clearInterval(n)}},[y,s]);const C=[20,40,80,77];return e.jsxs("div",{style:{display:"flex",flexDirection:"column"},children:[e.jsxs("div",{style:{position:"fixed",width:"100%",top:0,zIndex:1,backdropFilter:"blur(1px)"},children:[e.jsxs("div",{children:[e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:u,onChange:()=>{p(n=>!n)}}),"prepend"]}),e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:a,onChange:()=>{f(!0)}}),"increase"]}),e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:!a,onChange:()=>{f(!1)}}),"decrease"]}),e.jsx("input",{style:{marginLeft:4},value:t,type:"number",min:1,max:1e4,step:1,onChange:n=>{c(Number(n.target.value))}})]}),e.jsxs("div",{children:[e.jsxs("label",{style:{marginRight:16},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:s,onChange:()=>{o(n=>!n)}}),"auto"]}),e.jsx("button",{onClick:()=>{y()},children:"update"})]})]}),e.jsx("div",{style:{flex:1},children:e.jsx(h,{shift:u,children:g.map(n=>e.jsx("div",{style:{height:C[Math.abs(n.index)%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n.index},n.id))})})]})}},A={render:()=>{const[i,s]=r.useState(567),[o,t]=r.useState("start"),[c,u]=r.useState(!1),p=r.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{position:"fixed",top:30,left:150,zIndex:1,padding:10,border:"1px solid #ccc",backgroundColor:"white"},children:[e.jsx("input",{type:"number",value:i,onChange:a=>{s(Number(a.target.value))}}),e.jsx("button",{onClick:()=>{var a;(a=p.current)==null||a.scrollToIndex(i,{align:o,smooth:c})},children:"scroll to index"}),e.jsx("button",{onClick:()=>{s(Math.round(1e3*Math.random()))},children:"randomize"}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="start",onChange:()=>{t("start")}}),"start"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="center",onChange:()=>{t("center")}}),"center"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="end",onChange:()=>{t("end")}}),"end"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:c,onChange:()=>{u(a=>!a)}}),"smooth"]})]}),e.jsx("div",{style:{padding:"100px"},children:e.jsx("div",{style:{border:"1px solid darkgrey"},id:"window-virtualizer-parent",children:e.jsx(h,{ref:p,children:V(1e3)})})})]})}};var B,U,G;j.parameters={...j.parameters,docs:{...(B=j.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: "200px 100px"
    }}>
...
}`,...(se=(re=E.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};var ie,oe,ae;_.parameters={..._.parameters,docs:{...(ie=_.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => {
    const id = useRef(0);
...
}`,...(ae=(oe=_.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};var le,de,ce;A.parameters={...A.parameters,docs:{...(le=A.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: () => {
    const LENGTH = 1000;
...
}`,...(ce=(de=A.parameters)==null?void 0:de.docs)==null?void 0:ce.source}}};const Oe=["Default","Horizontal","Complex","InfiniteScrolling","ScrollRestoration","IncreasingItems","ScrollTo"];export{z as Complex,j as Default,R as Horizontal,_ as IncreasingItems,L as InfiniteScrolling,E as ScrollRestoration,A as ScrollTo,Oe as __namedExportsOrder,$e as default};

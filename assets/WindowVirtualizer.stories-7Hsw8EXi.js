import{a as e,j as l}from"./jsx-runtime-sgeEVxPu.js";import{r as i}from"./index-yp3VsGQP.js";import{S as ce,d as ue}from"./common-4ZgZpLnL.js";import{a as pe,A as me,b as he,u as M,r as C,U as fe,c as ge,l as ye,o as ve,d as be,n as we,S as xe,e as Se,s as Ie,t as _e}from"./useRerender-Ag38ecjg.js";import{u as Re,a as Ce,L as ke}from"./useChildren-DAFWgDSh.js";import{r as ze}from"./index-8dy-jdxy.js";const g=i.forwardRef(({children:o,count:s,overscan:t=4,itemSize:d,shift:r,horizontal:m,cache:c,ssrCount:p,as:h="div",item:v="div",onScrollEnd:b,onRangeChange:f},S)=>{h=h;const[y,n]=Re(o,s),w=i.useRef(null),I=Ce(b),_=i.useRef(!!p),[u,A,W,N]=pe(()=>{const a=!!m,x=Se(n,d,p,c,!d);return[x,Ie(x,a),_e(x,a),a]});n!==u._getItemsLength()&&u._update(me,[n,r]);const B=he(u),[D,O]=u._getRange(),H=u._getScrollDirection(),le=u._getJumpCount(),P=u._getTotalSize(),U=[];M(()=>{_[C]=!1;const a=u._subscribe(fe+ge,de=>{de?ze.flushSync(B):B()}),x=u._subscribe(ye,()=>{I[C]&&I[C]()}),R=w[C];return A._observeRoot(R),W._observe(R),()=>{a(),x(),A._dispose(),W._dispose()}},[]),M(()=>{const a=u._flushJump();a&&W._fixScrollJump(a)},[le]),i.useEffect(()=>{f&&f(D,O)},[D,O]),i.useImperativeHandle(S,()=>({get cache(){return u._getCacheSnapshot()}}),[]);for(let a=ve(D,t,H),x=be(O,t,H,n);a<=x;a++){const R=y(a);U.push(e(ke,{_resizer:A._observeItem,_index:a,_offset:u._getItemOffset(a),_hide:u._isUnmeasuredItem(a),_element:v,_children:R,_isHorizontal:N,_isSSR:_[C]},we(R,a)))}return e(h,{ref:w,style:{flex:"none",position:"relative",visibility:"hidden",width:N?P:"100%",height:N?"100%":P,pointerEvents:H!==xe?"none":"auto"},children:U})});try{g.displayName="WindowVirtualizer",g.__docgenInfo={description:"{@link Virtualizer } controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizer}.",displayName:"WindowVirtualizer",props:{children:{defaultValue:null,description:`Elements rendered by this component.
...
@defaultValue "div"`,name:"item",required:!1,type:{name:"keyof IntrinsicElements | CustomItemComponent"}},onScrollEnd:{defaultValue:null,description:"Callback invoked when scrolling stops.",name:"onScrollEnd",required:!1,type:{name:"(() => void)"}},onRangeChange:{defaultValue:null,description:"Callback invoked when visible items range changes.",name:"onRangeChange",required:!1,type:{name:"((startIndex: number, endIndex: number) => void)"}}}}}catch{}const q=o=>{const s=[20,40,80,77];return Array.from({length:o}).map((t,d)=>e("div",{style:{height:s[d%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:d},d))},Ve=o=>Array.from({length:o}).map((s,t)=>l("div",{style:{width:t%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",t]},t)),Oe={component:g},k={render:()=>e("div",{style:{padding:"200px 100px"},children:e("div",{style:{border:"solid 1px gray"},children:e(g,{children:q(1e3)})})})},z={render:()=>e("div",{style:{padding:"100px 200px"},children:e("div",{style:{display:"inline-block",border:"solid 1px gray",height:400},children:e(g,{horizontal:!0,children:Ve(1e3)})})})},V={render:()=>l("div",{style:{display:"flex",flexDirection:"column"},children:[e("div",{style:{background:"white",height:60,marginBottom:40},children:"header"}),l("div",{style:{display:"flex",flexDirection:"row"},children:[e("div",{style:{flex:1,display:"flex",paddingTop:600,margin:10},children:e(g,{children:q(1e3)})}),e("div",{style:{flex:3,margin:10},children:e(g,{children:Array.from({length:1e3}).map((o,s)=>e("div",{style:{height:200,borderRadius:8,margin:16,background:"#fff"},children:s},s))})}),e("div",{style:{flex:2,padding:20,paddingTop:300},children:e("div",{style:{top:0,height:400,position:"sticky",background:"white"}})})]}),e("div",{style:{background:"white",height:60,marginTop:40},children:"footer"})]})},E={render:()=>{const o=(v,b=0)=>{const f=[20,40,80,77];return Array.from({length:v}).map((S,y)=>(y+=b,e("div",{style:{height:f[y%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:y},y)))},[s,t]=i.useState(!1),d=async()=>{t(!0),await ue(1e3),t(!1)},r=100,[m,c]=i.useState(()=>o(r)),p=i.useRef(-1),h=m.length;return e("div",{style:{padding:"200px 100px 0px 100px"},children:l(g,{onRangeChange:async(v,b)=>{b+50>h&&p.current<h&&(p.current=h,await d(),c(f=>[...f,...o(r,f.length)]))},children:[m,s&&e(ce,{})]})})}},Ee=({id:o})=>{const s="window-list-cache-"+o,t=i.useRef(null),[d,r]=i.useMemo(()=>{const m=sessionStorage.getItem(s);if(!m)return[];try{return JSON.parse(m)}catch{return[]}},[]);return i.useLayoutEffect(()=>{if(!t.current)return;const m=t.current;window.scrollTo(0,d??0);let c=0;const p=()=>{c=window.scrollY};return window.addEventListener("scroll",p),p(),()=>{window.removeEventListener("scroll",p),sessionStorage.setItem(s,JSON.stringify([c,m.cache]))}},[]),e(g,{ref:t,cache:r,children:q(1e3)})},T={render:()=>{const[o,s]=i.useState(!0),[t,d]=i.useState("1");return l("div",{style:{position:"relative"},children:[l("div",{style:{position:"fixed",top:0,left:0,zIndex:10},children:[e("button",{onClick:()=>{s(r=>!r)},children:o?"hide":"show"}),["1","2","3"].map(r=>l("label",{children:[e("input",{type:"radio",checked:t===r,onChange:()=>{d(r)}}),r]},r))]}),o&&e(Ee,{id:t},t)]})}},L={render:()=>{const o=i.useRef(0),s=(n,w)=>Array.from({length:n}).map((I,_)=>(_+=w,{id:o.current++,index:_})),[t,d]=i.useState(!1),[r,m]=i.useState(4),[c,p]=i.useState(!1),[h,v]=i.useState(!0),[b,f]=i.useState(()=>s(r,0)),S=()=>{f(h?n=>{var w,I;return c?[...s(r,(((w=n[0])==null?void 0:w.index)??0)-r),...n]:[...n,...s(r,(((I=n[n.length-1])==null?void 0:I.index)??0)+1)]}:c?n=>n.slice(r):n=>n.slice(0,-r))};i.useEffect(()=>{if(!t)return;const n=setInterval(S,500);return()=>{clearInterval(n)}},[S,t]);const y=[20,40,80,77];return l("div",{style:{display:"flex",flexDirection:"column"},children:[l("div",{style:{position:"fixed",width:"100%",top:0,zIndex:1,backdropFilter:"blur(1px)"},children:[l("div",{children:[l("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:!c,onChange:()=>{p(!1)}}),"append"]}),l("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:c,onChange:()=>{p(!0)}}),"prepend"]}),l("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:h,onChange:()=>{v(!0)}}),"increase"]}),l("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:!h,onChange:()=>{v(!1)}}),"decrease"]}),e("input",{style:{marginLeft:4},value:r,type:"number",min:1,max:1e4,step:1,onChange:n=>{m(Number(n.target.value))}})]}),l("div",{children:[l("label",{style:{marginRight:16},children:[e("input",{type:"checkbox",style:{marginLeft:4},checked:t,onChange:()=>{d(n=>!n)}}),"auto"]}),e("button",{onClick:()=>{S()},children:"update"})]})]}),e("div",{style:{flex:1},children:e(g,{shift:c,children:b.map(n=>e("div",{style:{height:y[Math.abs(n.index)%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n.index},n.id))})})]})}};var j,F,J;k.parameters={...k.parameters,docs:{...(j=k.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: "200px 100px"
    }}>

import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-Bb63iTYX.js";import{S as X,d as Y}from"./common-BqtzafjA.js";import{a as q,u as K,A as Q,b as M,r as b,U as Z,c as ee,d as ne,n as te,e as re,o as se,p as oe}from"./useLatestRef-CPHvhl0P.js";import{u as ie,L as ae}from"./useChildren-UqILbHoM.js";import{r as le}from"./index-DbtEPA8V.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BUt4b3i1.js";const h=r.forwardRef(({children:a,count:o,overscan:s,itemSize:i,shift:t,horizontal:c,cache:u,ssrCount:p,as:l="div",item:f="div",onScroll:g,onScrollEnd:x},y)=>{l=l;const[S,n]=ie(a,o),I=r.useRef(null),V=q(g),w=q(x),H=r.useRef(!!p),[d,W,C,N]=K(()=>{const m=!!c,v=re(n,i,s,p,u,!i);return[v,se(v,m),oe(v,m),m]});n!==d.$getItemsLength()&&d.$update(Q,[n,t]);const[B,$]=r.useReducer(d.$getStateVersion,void 0,d.$getStateVersion),[U,G]=d.$getRange(),F=d.$isScrolling(),O=d.$getTotalSize(),P=[];M(()=>{H[b]=!1;const m=d.$subscribe(Z,J=>{J?le.flushSync($):$()}),v=d.$subscribe(ee,()=>{V[b]&&V[b]()}),k=d.$subscribe(ne,()=>{w[b]&&w[b]()}),D=I[b];return W.$observeRoot(D),C.$observe(D),()=>{m(),v(),k(),W.$dispose(),C.$dispose()}},[]),M(()=>{C.$fixScrollJump()},[B]),r.useImperativeHandle(y,()=>({get cache(){return d.$getCacheSnapshot()},findStartIndex:d.$findStartIndex,findEndIndex:d.$findEndIndex,scrollToIndex:C.$scrollToIndex}),[]);for(let m=U,v=G;m<=v;m++){const k=S(m);P.push(e.jsx(ae,{_resizer:W.$observeItem,_index:m,_offset:d.$getItemOffset(m),_hide:d.$isUnmeasuredItem(m),_as:f,_children:k,_isHorizontal:N,_isSSR:H[b]},te(k,m)))}return e.jsx(l,{ref:I,style:{contain:"size paint style",overflowAnchor:"none",overflow:"clip",flex:"none",position:"relative",width:N?O:"100%",height:N?"100%":O,pointerEvents:F?"none":void 0},children:P})});h.__docgenInfo={description:"{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",methods:[{name:"cache",docblock:null,modifiers:["get"],params:[],returns:null}],displayName:"WindowVirtualizer",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ((index: number) => ReactElement)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:`Elements rendered by this component.

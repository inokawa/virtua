import{a as r,j as a}from"./jsx-runtime-CWvgoIdH.js";import{r as m}from"./index-D3g0PtM7.js";import{u as k,r as ie,i as we,a as xe,A,b as M,g as x,U as q,c as j,S as J,d as U,e as _e,f as Ie}from"./useRerender-BqRENOZ3.js";import{r as W}from"./index-4KpVZEbj.js";const R=(t,e)=>`${t}-${e}`,Se=m.memo(({_children:t,_resizer:e,_rowIndex:c,_colIndex:u,_top:f,_left:h,_height:n,_width:i,_hide:y,_element:T})=>{const w=m.useRef(null);return k(()=>e._observeItem(w[ie],c,u),[u,c]),r(T,{ref:w,style:m.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:f,[we()?"right":"left"]:h,visibility:y?"hidden":"visible",minHeight:n,minWidth:i}),[f,h,i,n,y]),children:t})}),p=m.forwardRef(({children:t,row:e,col:c,cellHeight:u=40,cellWidth:f=100,overscan:h=2,initialRowCount:n,initialColCount:i,item:y="div",style:T,...w},H)=>{const[s,d,G,v]=xe(()=>{const o=U(e,u,n),l=U(c,f,i);return[o,l,_e(o,l),Ie(o,l)]});e!==s._getItemsLength()&&s._update(A,[e]),c!==d._getItemsLength()&&d._update(A,[c]);const N=M(s),E=M(d),[se,de]=s._getRange(),[ae,ce]=d._getRange(),O=s._getScrollDirection(),L=d._getScrollDirection(),ue=s._getJumpCount(),he=d._getJumpCount(),me=x(s),pe=x(d),z=m.useRef(null);k(()=>{const o=z[ie],l=s._subscribe(q,g=>{g?W.flushSync(N):N()}),b=d._subscribe(q,g=>{g?W.flushSync(E):E()});return G._observeRoot(o),v._observe(o),()=>{l(),b(),G._dispose(),v._dispose()}},[]),k(()=>{v._fixScrollJump()},[ue,he]),m.useImperativeHandle(H,()=>({get scrollOffset(){return[d._getScrollOffset(),s._getScrollOffset()]},get scrollSize(){return[x(d),x(s)]},get viewportSize(){return[d._getViewportSize(),s._getViewportSize()]},scrollToIndex:v._scrollToIndex,scrollTo:v._scrollTo,scrollBy:v._scrollBy}),[]);const fe=m.useMemo(()=>{const o=new Map;return(l,b)=>{let g=o.get(R(l,b));return g||o.set(R(l,b),g=t({rowIndex:l,colIndex:b})),g}},[t]),[ge,ve]=j(se,de,h,O,e),[be,ye]=j(ae,ce,h,L,c),D=[];for(let o=ge;o<=ve;o++)for(let l=be;l<=ye;l++)D.push(r(Se,{_resizer:G,_rowIndex:o,_colIndex:l,_top:s._getItemOffset(o),_left:d._getItemOffset(l),_height:s._getItemSize(o),_width:d._getItemSize(l),_hide:s._isUnmeasuredItem(o)||d._isUnmeasuredItem(l),_element:y,_children:fe(o,l)},R(o,l)));return r("div",{ref:z,...w,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",...T},children:r("div",{style:{overflowAnchor:"none",flex:"none",position:"relative",visibility:"hidden",width:pe,height:me,pointerEvents:O!==J||L!==J?"none":"auto"},children:D})})});try{p.displayName="VGrid",p.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
}`,...(le=(oe=C.parameters)==null?void 0:oe.docs)==null?void 0:le.source}}};const ke=["Default","Fixed","DynamicHeight","DynamicWidth","ScrollTo"];export{_ as Default,S as DynamicHeight,V as DynamicWidth,I as Fixed,C as ScrollTo,ke as __namedExportsOrder,Re as default};

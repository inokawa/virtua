import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{r as n}from"./index-DRjF_FHU.js";import{S as E,d as $}from"./common-B4Hkentz.js";import{V as a}from"./Virtualizer-tXQiGAK5.js";import"./useRerender-CoF9yDGp.js";import"./useChildren-DqJQo84Z.js";import"./index-uWwxbAOW.js";const le={component:a},R=r=>{const t=[20,40,80,77];return Array.from({length:r}).map((o,s)=>e.jsx("div",{style:{height:t[s%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:s},s))},f={render:()=>e.jsxs("div",{style:{width:"100%",height:"100vh",overflowY:"auto",overflowAnchor:"none"},children:[e.jsx("div",{style:{backgroundColor:"burlywood",height:400},children:"header"}),e.jsx(a,{startMargin:400,children:R(1e3)}),e.jsx("div",{style:{backgroundColor:"steelblue",height:600},children:"footer"})]})},g={render:()=>e.jsxs("div",{style:{width:"100%",height:"100vh",overflowY:"auto",overflowAnchor:"none"},children:[e.jsx("div",{style:{position:"sticky",backgroundColor:"burlywood",height:40,top:0,zIndex:1},children:"header"}),e.jsx(a,{startMargin:40,children:R(1e3)}),e.jsx("div",{style:{position:"sticky",backgroundColor:"steelblue",height:60,bottom:0},children:"footer"})]})},v={render:()=>{const r=n.useRef(null),t=40,o=60;return e.jsx("div",{ref:r,style:{width:"100%",height:"100vh",overflowY:"auto",overflowAnchor:"none"},children:e.jsx("div",{style:{backgroundColor:"burlywood",padding:t},children:e.jsx("div",{style:{backgroundColor:"steelblue",padding:o},children:e.jsx(a,{scrollRef:r,startMargin:t+o,children:R(1e3)})})})})}},m={render:()=>{const r=n.useRef(0),t=i=>{const u=[20,40,80,77];return Array.from({length:i}).map(()=>{const H=r.current++;return e.jsx("div",{style:{height:u[H%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:H},H)})},[o,s]=n.useState(!1),[h,Q]=n.useState(!1),[X,Z]=n.useState(!1),S=async(i=!1)=>{s(i);const u=i?Q:Z;u(!0),await $(1e3),u(!1)},d=n.useRef(null),w=100,[b,j]=n.useState(()=>t(w*2)),k=50,c=b.length,C=n.useRef(-1),T=n.useRef(-1),F=n.useRef(!1);n.useEffect(()=>{var i;(i=d.current)==null||i.scrollToIndex(b.length/2+1),F.current=!0},[]);const x=100;return e.jsxs("div",{style:{height:"100vh",overflowY:"auto",overflowAnchor:"none"},children:[e.jsx(E,{height:x,style:h?void 0:{visibility:"hidden"}}),e.jsx(a,{ref:d,shift:!!o,startMargin:x,onScroll:async()=>{F.current&&d.current&&(T.current<c&&d.current.endIndex+k>c?(T.current=c,await S(),j(i=>[...i,...t(w)])):C.current<c&&d.current.startIndex-k<0&&(C.current=c,await S(!0),j(i=>[...t(w).reverse(),...i])))},children:b}),e.jsx(E,{height:x,style:X?void 0:{visibility:"hidden"}})]})}},ee=n.forwardRef(({children:r,style:t},o)=>e.jsx("ul",{ref:o,style:{...t,margin:0,overflow:"hidden"},children:r})),te=n.forwardRef(({children:r,style:t},o)=>e.jsx("li",{ref:o,style:{...t,marginLeft:30},children:r})),p={render:()=>e.jsxs("div",{style:{width:400,height:400,border:"solid 1px darkgray",borderRadius:8,background:"lightgray",display:"flex",flexDirection:"column",overflow:"hidden"},children:[e.jsx("div",{style:{padding:4},children:"header"}),e.jsx("div",{style:{overflowY:"auto",flex:1,background:"#fff"},children:e.jsx(a,{as:ee,item:te,overscan:10,children:Array.from({length:1e3}).map((r,t)=>t)})})]})},K=[100,200,300,100,200,300,100,300,400,200],l=30,re=n.forwardRef(({children:r,style:t},o)=>e.jsxs("table",{ref:o,style:{height:t==null?void 0:t.height,position:"relative",tableLayout:"fixed",borderCollapse:"collapse",whiteSpace:"nowrap"},border:1,children:[e.jsx("thead",{style:{position:"sticky",top:0,zIndex:1,height:l,minHeight:l,maxHeight:l},children:e.jsx("tr",{children:K.map((s,h)=>e.jsx("th",{style:{color:"white",background:"darkgray",minWidth:s},children:h},h))})}),e.jsx("tbody",{style:{...t,contain:void 0,position:"absolute",top:l,left:0},children:r})]})),y={render:()=>e.jsx("div",{style:{width:"100%",height:"75%",overflow:"auto"},children:e.jsx(a,{count:1e3,as:re,item:"tr",startMargin:l,children:r=>e.jsx(n.Fragment,{children:K.map((t,o)=>e.jsxs("td",{style:{minWidth:t,background:"#fff"},children:[r,", ",o]},o))},r)})})};var I,A,z;f.parameters={...f.parameters,docs:{...(I=f.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => {

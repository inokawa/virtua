import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as m}from"./iframe--Fla_Brs.js";import{a as se,A as W,g as S,u as A,c as j,r as v,U as D,d as ie,e as le,f as q,p as de,q as ae,n as ce}from"./useLatestRef-PImEpDJq.js";import{r as Z}from"./index-BnvemuMh.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BA7OWh_S.js";const ue=r=>m.useCallback(n=>{for(const l of r)l&&(typeof l=="function"?l(n):l&&(l.current=n))},r),$=(r,n)=>`${r}-${n}`,me=m.memo(({_children:r,_resizer:n,_rowIndex:l,_colIndex:p,_top:b,_left:h,_height:s,_width:a,_hide:c,_element:u})=>{const g=m.useRef(null);return j(()=>n.$observeItem(g[v],l,p),[p,l]),e.jsx(u,{ref:g,style:m.useMemo(()=>({contain:"layout style",display:"grid",position:"absolute",top:b,[ce()?"right":"left"]:h,visibility:c?"hidden":void 0,minHeight:s,minWidth:a}),[b,h,a,s,c]),children:r})}),x=m.forwardRef(({children:r,row:n,col:l,cellHeight:p=40,cellWidth:b=100,bufferSize:h,initialRowCount:s,initialColCount:a,item:c="div",domRef:u,innerDomRef:g,onScroll:f,onScrollEnd:y,style:P,...U},B)=>{const[i,d,I,w]=se(()=>{const t=q(n,p,s),o=q(l,b,a);return[t,o,de(t,o),ae(t,o)]});n!==i.$getItemsLength()&&i.$update(W,[n]),l!==d.$getItemsLength()&&d.$update(W,[l]);const[F,V]=m.useReducer(i.$getStateVersion,void 0,i.$getStateVersion),[X,G]=m.useReducer(d.$getStateVersion,void 0,d.$getStateVersion),J=i.$isScrolling(),K=d.$isScrolling(),Y=S(i),Q=S(d),N=m.useRef(null),M=A(f),_=A(y);j(()=>{const t=N[v];return i.$subscribe(D,o=>{o?Z.flushSync(V):V()}),d.$subscribe(D,o=>{o?Z.flushSync(G):G()}),i.$subscribe(ie,()=>{M[v]&&M[v](i.$getScrollOffset())}),i.$subscribe(le,()=>{_[v]&&_[v]()}),I.$observeRoot(t),w.$observe(t),()=>{i.$dispose(),d.$dispose(),I.$dispose(),w.$dispose()}},[]),j(()=>{w.$fixScrollJump()},[F,X]),m.useImperativeHandle(B,()=>({get scrollTop(){return i.$getScrollOffset()},get scrollLeft(){return d.$getScrollOffset()},get scrollHeight(){return S(i)},get scrollWidth(){return S(d)},get viewportHeight(){return i.$getViewportSize()},get viewportWidth(){return d.$getViewportSize()},findRowIndex:i.$findItemIndex,findColIndex:d.$findItemIndex,getItemOffset:(t,o)=>[d.$getItemOffset(t),i.$getItemOffset(o)],getItemSize:(t,o)=>[d.$getItemSize(t),i.$getItemSize(o)],resizeCols(t){I.$resizeCols(t)},resizeRows(t){I.$resizeRows(t)},scrollToIndex:w.$scrollToIndex,scrollTo:w.$scrollTo,scrollBy:w.$scrollBy}),[]);const ee=m.useMemo(()=>{const t=new Map;return(o,z)=>{let L=t.get($(o,z));return L||t.set($(o,z),L=r({rowIndex:o,colIndex:z})),L}},[r]),[ne,re]=i.$getRange(h),[te,oe]=d.$getRange(h),O=[];for(let t=ne;t<=re;t++)for(let o=te;o<=oe;o++)O.push(e.jsx(me,{_resizer:I,_rowIndex:t,_colIndex:o,_top:i.$getItemOffset(t),_left:d.$getItemOffset(o),_height:i.$getItemSize(t),_width:d.$getItemSize(o),_hide:i.$isUnmeasuredItem(t)||d.$isUnmeasuredItem(o),_element:c,_children:ee(t,o)},$(t,o)));return e.jsx("div",{ref:ue([N,u]),...U,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",...P},children:e.jsx("div",{ref:g,style:{contain:"size style",overflowAnchor:"none",flex:"none",position:"relative",width:Q,height:Y,pointerEvents:J||K?"none":void 0},children:O})})});x.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",methods:[{name:"scrollTop",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollLeft",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"getItemOffset",docblock:null,modifiers:[],params:[{name:"indexX",optional:!1,type:null},{name:"indexY",optional:!1,type:null}],returns:null},{name:"getItemSize",docblock:null,modifiers:[],params:[{name:"indexX",optional:!1,type:null},{name:"indexY",optional:!1,type:null}],returns:null},{name:"resizeCols",docblock:null,modifiers:[],params:[{name:"cols",optional:!1,type:null}],returns:null},{name:"resizeRows",docblock:null,modifiers:[],params:[{name:"rows",optional:!1,type:null}],returns:null}],displayName:"VGrid",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(arg: {
  /**
   * row index of cell
   */
  rowIndex: number;
...
}`,...k.parameters?.docs?.source}}};const ve=["Default","Fixed","DynamicHeight","DynamicWidth","Resizeable","ScrollTo"];export{T as Default,E as DynamicHeight,C as DynamicWidth,R as Fixed,H as Resizeable,k as ScrollTo,ve as __namedExportsOrder,we as default};

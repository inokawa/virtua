import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as m}from"./iframe-CRZqp-6U.js";import{V as i}from"./VList-BNOVt-mV.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-ZEN33gmK.js";import"./useLatestRef-C4QKQZaW.js";import"./useChildren-DbVFOZ33.js";import"./index-C4R1impB.js";import"./index-YeWn7W2l.js";const g={component:i},t={name:"DynamicColumns",render:()=>{const[s,l]=m.useState(3);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100vh"},children:[e.jsx("div",{children:e.jsxs("label",{children:["columns",e.jsx("input",{type:"number",value:s,min:1,max:100,step:1,style:{marginLeft:4},onChange:n=>{l(Number(n.target.value))}})]})}),e.jsx(i,{style:{flex:1},children:Array.from({length:1e3}).map((n,r)=>r).reduce((n,r)=>(r%s===0&&n.push([]),n[n.length-1].push(r),n),[]).map((n,r)=>e.jsx("div",{style:{display:"flex",borderBottom:"solid 1px #ccc",height:100},children:n.map(o=>e.jsx("div",{style:{flex:1/s,background:"#fff",borderRight:"solid 1px #ccc"},children:o},o))},r))})]})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  name: "DynamicColumns",
  render: () => {

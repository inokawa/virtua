import{a as l,j as u}from"./jsx-runtime-e162df28.js";import{r as h}from"./index-5284b0bf.js";import{b as p,c as O,r as he,a as xe,D as Ie,d as P,j as Se,h as B,m as F,i as K}from"./DefaultWindow-43a756a8.js";import"./index-480187bb.js";const E=(t,e)=>`${t}-${e}`,Ce=h.memo(({_children:t,_resizer:e,_vStore:s,_hStore:i,_rowIndex:m,_colIndex:d,_element:n,_isRtl:a})=>{const b=h.useRef(null),x=p(s,()=>s._getItemOffset(m),!0),I=p(i,()=>i._getItemOffset(d),!0),S=p(s,()=>s._isUnmeasuredItem(m),!0),C=p(i,()=>i._isUnmeasuredItem(d),!0),V=p(s,()=>s._getItemSize(m),!0),R=p(i,()=>i._getItemSize(d),!0);return O(()=>e._observeItem(b[he],m,d),[d,m]),l(n,{ref:b,style:h.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:x,[a?"right":"left"]:I,visibility:S||C?"hidden":"visible",minHeight:V,minWidth:R}),[x,I,R,V,S,C]),children:t})}),Ve=({_children:t,_ref:e,_vStore:s,_hStore:i,_element:m,_scrolling:d,_attrs:n})=>{const a=p(s,s._getCorrectedScrollSize),b=p(i,i._getCorrectedScrollSize);return l(m,{ref:e,width:b,height:a,scrolling:d,attrs:h.useMemo(()=>({...n,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",padding:0,margin:0,...n.style}}),[n]),children:t})},y=h.forwardRef(({children:t,row:e,col:s,cellHeight:i=40,cellWidth:m=100,overscan:d=2,initialRowCount:n,initialColCount:a,rtl:b,element:x=Ie,cellElement:I="div",...S},C)=>{const[V,R]=h.useState(!1),[M,me]=h.useState(!1),[f,g,W,w,_,pe]=xe(()=>{const r=!!b,o=()=>{},c=P(e,i,n,!1,R,o),v=P(s,m,a,!1,me,o);return[c,v,Se(c,v),B(c,!1,r),B(v,!0,r),r]});f._updateCacheLength(e),g._updateCacheLength(s);const[fe,ge]=p(f,f._getRange),[ve,ye]=p(g,g._getRange),be=p(f,f._getJumpCount),we=p(g,g._getJumpCount),L=h.useRef(null);O(()=>{const r=L[he],o=W._observeRoot(r),c=w._initRoot(r),v=_._initRoot(r);return()=>{o(),c(),v()}},[]),O(()=>{const r=f._flushJump();r&&w._fixScrollJump(r)},[be]),O(()=>{const r=g._flushJump();r&&_._fixScrollJump(r)},[we]),h.useImperativeHandle(C,()=>({get scrollOffset(){return[g._getScrollOffset(),f._getScrollOffset()]},get scrollSize(){return[_._getActualScrollSize(),w._getActualScrollSize()]},get viewportSize(){return[g._getViewportSize(),f._getViewportSize()]},scrollToIndex(r,o){_._scrollToIndex(r),w._scrollToIndex(o)},scrollTo(r,o){_._scrollTo(r),w._scrollTo(o)},scrollBy(r,o){_._scrollTo(g._getScrollOffset()+r),w._scrollTo(f._getScrollOffset()+o)}}),[]);const q=h.useMemo(()=>{const r=new Map;return(o,c)=>{let v=r.get(E(o,c));return v||r.set(E(o,c),v=t({rowIndex:o,colIndex:c})),v}},[t]),D=F(fe-d,0),j=K(ge+d,e-1),A=F(ve-d,0),J=K(ye+d,s-1),_e=h.useMemo(()=>{const r=[];for(let o=D;o<=j;o++)for(let c=A;c<=J;c++)r.push(l(Ce,{_resizer:W,_vStore:f,_hStore:g,_rowIndex:o,_colIndex:c,_element:I,_children:q(o,c),_isRtl:pe},E(o,c)));return r},[q,D,j,A,J]);return l(Ve,{_ref:L,_vStore:f,_hStore:g,_element:x,_scrolling:V||M,_children:_e,_attrs:S})});try{y.displayName="VGrid",y.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
@defaultValue "div"`,name:"cellElement",required:!1,type:{name:"CustomCellComponentOrElement"}}}}}catch{}const ze={component:y},G={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4},children:[t," / ",e]})})},T={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100,height:(t%2+1)*100},children:[t," / ",e]})})},k={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100},children:[u("div",{children:[t," / ",e]}),Array.from({length:t%8+1},()=>l("div",{children:"Hello world!"}))]})})},z={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,height:(t%2+1)*100},children:[u("div",{children:[t," / ",e]}),l("div",{children:Array.from({length:e%4+1},()=>l("span",{children:"Hello world!"}))})]})})},H={render:()=>l(y,{style:{height:"100vh",direction:"rtl"},row:1e3,col:500,rtl:!0,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:100},children:[t," / ",e]})})},N={render:()=>{const[e,s]=h.useState([567,567]),[i,m]=h.useState([1e3,1e3]),d=h.useRef(null);return u("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[u("div",{children:[u("label",{children:["col",l("input",{type:"number",value:e[0],onChange:n=>{s(a=>[Number(n.target.value),a[1]])}})]}),u("label",{children:["row",l("input",{type:"number",value:e[1],onChange:n=>{s(a=>[a[0],Number(n.target.value)])}})]}),l("button",{onClick:()=>{var n;(n=d.current)==null||n.scrollToIndex(e[0],e[1])},children:"scroll to index"}),l("button",{onClick:()=>{s([Math.round(1e3*Math.random()),Math.round(1e3*Math.random())])},children:"randomize"})]}),l("div",{children:u("div",{children:[u("label",{children:["x",l("input",{type:"number",value:i[0],onChange:n=>{m(a=>[Number(n.target.value),a[1]])}})]}),u("label",{children:["y",l("input",{type:"number",value:i[1],onChange:n=>{m(a=>[a[0],Number(n.target.value)])}})]}),l("button",{onClick:()=>{var n;(n=d.current)==null||n.scrollTo(i[0],i[1])},children:"scroll to offset"}),l("button",{onClick:()=>{var n;(n=d.current)==null||n.scrollBy(i[0],i[1])},children:"scroll by offset"})]})}),l(y,{ref:d,style:{height:"100vh"},row:1e3,col:1e3,children:({rowIndex:n,colIndex:a})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:160,height:80},children:[n," / ",a]})})]})}};var U,Y,$;G.parameters={...G.parameters,docs:{...(U=G.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
}`,...(ue=(ce=N.parameters)==null?void 0:ce.docs)==null?void 0:ue.source}}};const He=["Default","Fixed","DynamicHeight","DynamicWidth","Rtl","ScrollTo"];export{G as Default,k as DynamicHeight,z as DynamicWidth,T as Fixed,H as Rtl,N as ScrollTo,He as __namedExportsOrder,ze as default};
//# sourceMappingURL=VGrid.stories-207192f0.js.map

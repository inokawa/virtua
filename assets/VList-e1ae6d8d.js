import{a as S}from"./jsx-runtime-e162df28.js";import{r}from"./index-5284b0bf.js";import{i as J,u as E,a as A,b,c as q,r as u,e as Y,D as B,d as F,f as K,g as U,m as G,h as Q}from"./DefaultWindow-13f0d725.js";import{L as X}from"./ListItem-1adc5afa.js";const Z=({_children:a,_ref:d,_store:c,_element:h,_scrolling:g,_attrs:l,_isHorizontal:i})=>{const m=b(c,c._getCorrectedScrollSize);return S(h,{ref:d,width:i?m:void 0,height:i?void 0:m,scrolling:g,attrs:r.useMemo(()=>({...l,style:{overflow:i?"auto hidden":"hidden auto",display:i?"inline-block":"block",contain:"strict",width:"100%",height:"100%",padding:0,margin:0,...l.style}}),[l]),children:a})},T=r.forwardRef(({children:a,overscan:d=4,initialItemSize:c,initialItemCount:h,horizontal:g,mode:l,element:i=B,itemElement:m="div",onScroll:L,onScrollStop:W,onRangeChange:w,...H},M)=>{const _=r.useMemo(()=>{const e=[];return r.Children.forEach(a,t=>{J(t)||e.push(t)}),e},[a]),f=_.length,C=E(L),z=E(W),[j,O]=r.useState(!1),[n,I,s,V,P]=A(()=>{const e=!!g,t=l==="rtl",o=F(f,c,h,l==="reverse",p=>{O(p),p||z[u]&&z[u]()},p=>{C[u]&&C[u](p)});return[o,K(o,e),U(o,e,t),e,t]});n._updateCacheLength(f);const[v,y]=b(n,n._getRange),N=b(n,n._getJumpCount),R=r.useRef(null);q(()=>{const e=R[u],t=I._observeRoot(e),o=s._initRoot(e);return()=>{t(),o()}},[]),q(()=>{const e=n._flushJump();e&&s._fixScrollJump(e)},[N]),r.useEffect(()=>{w&&w({start:v,end:y,count:f})},[v,y]),r.useImperativeHandle(M,()=>({get scrollOffset(){return n._getScrollOffset()},get scrollSize(){return s._getActualScrollSize()},get viewportSize(){return n._getViewportSize()},scrollToIndex:s._scrollToIndex,scrollTo:s._scrollTo,scrollBy(e){s._scrollTo(n._getScrollOffset()+e)}}),[]);const k=G(v-d,0),x=Q(y+d,f-1),D=r.useMemo(()=>{const e=[];for(let t=k;t<=x;t++){const o=_[t];Y(o)&&e.push(S(X,{_resizer:I,_store:n,_index:t,_element:m,_children:o,_isHorizontal:V,_isRtl:P},(o==null?void 0:o.key)||t))}return e},[_,k,x]);return S(Z,{_ref:R,_store:n,_element:i,_scrolling:j,_children:D,_attrs:H,_isHorizontal:V})});try{T.displayName="VList",T.__docgenInfo={description:"Virtualized list component. See {@link VListProps} and {@link VListHandle}.",displayName:"VList",props:{children:{defaultValue:null,description:"Elements rendered by this component.",name:"children",required:!0,type:{name:"ReactNode"}},overscan:{defaultValue:{value:"4"},description:`Number of items to render above/below the visible bounds of the list. You can increase to avoid showing blank items in fast scrolling.
...
//# sourceMappingURL=VList-e1ae6d8d.js.map

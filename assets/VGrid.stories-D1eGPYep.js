import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as m}from"./iframe-B1ox_VXR.js";import{a as ie,A,g as S,u as W,c as k,r as v,U as D,d as le,e as de,f as Z,o as ae,p as ce}from"./useLatestRef-CdAaAf7A.js";import{r as q}from"./index-Bu2owHoD.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dr5cpnNU.js";const ue=r=>m.useCallback(n=>{for(const l of r)l&&(typeof l=="function"?l(n):l&&(l.current=n))},r),j=(r,n)=>`${r}-${n}`,me=m.memo(({_children:r,_resizer:n,_rowIndex:l,_colIndex:p,_top:b,_left:h,_height:o,_width:a,_hide:c,_element:u})=>{const g=m.useRef(null);return k(()=>n.$observeItem(g[v],l,p),[p,l]),e.jsx(u,{ref:g,style:m.useMemo(()=>({contain:"layout style",display:"grid",position:"absolute",top:b,left:h,visibility:c?"hidden":void 0,minHeight:o,minWidth:a}),[b,h,a,o,c]),children:r})}),w=m.forwardRef(({children:r,row:n,col:l,cellHeight:p=40,cellWidth:b=100,bufferSize:h,ssrRowCount:o,ssrColCount:a,item:c="div",domRef:u,innerDomRef:g,onScroll:f,onScrollEnd:y,style:P,...U},B)=>{const[s,d,I,x]=ie(()=>{const t=Z(n,p,o),i=Z(l,b,a);return[t,i,ae(t,i),ce(t,i)]});n!==s.$getItemsLength()&&s.$update(A,[n]),l!==d.$getItemsLength()&&d.$update(A,[l]);const[F,V]=m.useReducer(s.$getStateVersion,void 0,s.$getStateVersion),[J,G]=m.useReducer(d.$getStateVersion,void 0,d.$getStateVersion),K=s.$isScrolling(),X=d.$isScrolling(),Q=S(s),Y=S(d),N=m.useRef(null),M=W(f),_=W(y);k(()=>{const t=N[v];return s.$subscribe(D,i=>{i?q.flushSync(V):V()}),d.$subscribe(D,i=>{i?q.flushSync(G):G()}),s.$subscribe(le,()=>{M[v]&&M[v](s.$getScrollOffset())}),s.$subscribe(de,()=>{_[v]&&_[v]()}),I.$observeRoot(t),x.$observe(t),()=>{s.$dispose(),d.$dispose(),I.$dispose(),x.$dispose()}},[]),k(()=>{x.$fixScrollJump()},[F,J]),m.useImperativeHandle(B,()=>({get scrollTop(){return s.$getScrollOffset()},get scrollLeft(){return d.$getScrollOffset()},get scrollHeight(){return S(s)},get scrollWidth(){return S(d)},get viewportHeight(){return s.$getViewportSize()},get viewportWidth(){return d.$getViewportSize()},findRowIndex:s.$findItemIndex,findColIndex:d.$findItemIndex,getRowOffset:s.$getItemOffset,getColOffset:d.$getItemOffset,getRowSize:s.$getItemSize,getColSize:d.$getItemSize,resizeCols(t){I.$resizeCols(t)},resizeRows(t){I.$resizeRows(t)},scrollToIndex:x.$scrollToIndex,scrollTo:x.$scrollTo,scrollBy:x.$scrollBy}),[]);const ee=m.useMemo(()=>{const t=new Map;return(i,z)=>{let L=t.get(j(i,z));return L||t.set(j(i,z),L=r({rowIndex:i,colIndex:z})),L}},[r]),ne=x.$isNegative(),[re,te]=s.$getRange(h),[oe,se]=d.$getRange(h),O=[];for(let t=re;t<=te;t++)for(let i=oe;i<=se;i++)O.push(e.jsx(me,{_resizer:I,_rowIndex:t,_colIndex:i,_top:s.$getItemOffset(t),_left:d.$getItemOffset(i,ne),_height:s.$getItemSize(t),_width:d.$getItemSize(i),_hide:s.$isUnmeasuredItem(t)||d.$isUnmeasuredItem(i),_element:c,_children:ee(t,i)},j(t,i)));return e.jsx("div",{ref:ue([N,u]),...U,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",...P},children:e.jsx("div",{ref:g,style:{contain:"size style",overflowAnchor:"none",flex:"none",position:"relative",width:Y,height:Q,pointerEvents:K||X?"none":void 0},children:O})})});w.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",methods:[{name:"scrollTop",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollLeft",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"resizeCols",docblock:null,modifiers:[],params:[{name:"cols",optional:!1,type:null}],returns:null},{name:"resizeRows",docblock:null,modifiers:[],params:[{name:"rows",optional:!1,type:null}],returns:null}],displayName:"VGrid",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(arg: {
  /**
   * row index of cell
   */
  rowIndex: number;
...
}`,...$.parameters?.docs?.source}}};const ve=["Default","Fixed","DynamicHeight","DynamicWidth","Resizeable","ScrollTo"];export{T as Default,C as DynamicHeight,E as DynamicWidth,R as Fixed,H as Resizeable,$ as ScrollTo,ve as __namedExportsOrder,xe as default};

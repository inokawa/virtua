import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-DEauTc84.js";import{S as F,d as J}from"./common-BqtzafjA.js";import{a as q,u as X,A as Y,b as M,r as b,U as K,c as Q,d as Z,n as ee,e as ne,o as te,p as re}from"./useLatestRef-B2VpOXKi.js";import{u as se,L as ie}from"./useChildren-DXnE-Mi3.js";import{r as oe}from"./index-BHBBZ8Lz.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DHsCBXAw.js";const h=r.forwardRef(({children:a,data:i,bufferSize:s,itemSize:o,shift:t,horizontal:c,cache:u,ssrCount:p,as:l="div",item:f="div",onScroll:g,onScrollEnd:x},y)=>{l=l;const[S,n]=se(a,i),I=r.useRef(null),V=q(g),w=q(x),H=r.useRef(!!p),[d,W,k,N]=X(()=>{const m=!!c,v=ne(n,o,p,u,!o);return[v,te(v,m),re(v,m),m]});n!==d.$getItemsLength()&&d.$update(Y,[n,t]);const[B,$]=r.useReducer(d.$getStateVersion,void 0,d.$getStateVersion),U=d.$isScrolling(),O=d.$getTotalSize(),P=[];M(()=>{H[b]=!1;const m=d.$subscribe(K,G=>{G?oe.flushSync($):$()}),v=d.$subscribe(Q,()=>{V[b]&&V[b]()}),C=d.$subscribe(Z,()=>{w[b]&&w[b]()}),D=I[b];return W.$observeRoot(D),k.$observe(D),()=>{m(),v(),C(),W.$dispose(),k.$dispose()}},[]),M(()=>{k.$fixScrollJump()},[B]),r.useImperativeHandle(y,()=>({get cache(){return d.$getCacheSnapshot()},findStartIndex:d.$findStartIndex,findEndIndex:d.$findEndIndex,scrollToIndex:k.$scrollToIndex}),[]);for(let[m,v]=d.$getRange(s);m<=v;m++){const C=S(m);P.push(e.jsx(ie,{_resizer:W.$observeItem,_index:m,_offset:d.$getItemOffset(m),_hide:d.$isUnmeasuredItem(m),_as:f,_children:C,_isHorizontal:N,_isSSR:H[b]},ee(C,m)))}return e.jsx(l,{ref:I,style:{contain:"size paint style",overflowAnchor:"none",overflow:"clip",flex:"none",position:"relative",width:N?O:"100%",height:N?"100%":O,pointerEvents:U?"none":void 0},children:P})});h.__docgenInfo={description:"{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",methods:[{name:"cache",docblock:null,modifiers:["get"],params:[],returns:null}],displayName:"WindowVirtualizer",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ((data: T, index: number) => ReactElement)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:`Elements rendered by this component.

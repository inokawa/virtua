import{j as e}from"./jsx-runtime-CRdFn2pK.js";import"./index-CVQug6lh.js";import{r}from"./iframe-BvAKqPok.js";import{S as G,d as F}from"./common-BcHFrF5x.js";import{u as D,a as J,A as X,c as q,r as b,U as Y,d as K,e as Q,j as Z,f as ee,k as ne,l as te}from"./useLatestRef-DhNElndx.js";import{u as re,L as se}from"./useChildren-Dfk25ci5.js";import{r as ie}from"./index-CTaNL9Sn.js";import"./preload-helper-PPVm8Dsz.js";import"./index-GHjdeYM9.js";const f=r.forwardRef(({children:l,data:i,bufferSize:s,itemSize:o,shift:t,horizontal:c,cache:u,ssrCount:p,as:d="div",item:h="div",onScroll:g,onScrollEnd:x},y)=>{d=d;const[I,n]=re(l,i),k=r.useRef(null),_=D(g),w=D(x),W=r.useRef(!!p),[a,V,S,N]=J(()=>{const m=!!c,v=ee(n,o,p,u,!o);return[v,ne(v,m),te(v,m),m]});n!==a.$getItemsLength()&&a.$update(X,[n,t]);const[M,$]=r.useReducer(a.$getStateVersion,void 0,a.$getStateVersion),B=a.$isScrolling(),H=a.$getTotalSize(),U=S.$isNegative(),O=[];q(()=>{W[b]=!1,a.$subscribe(Y,v=>{v?ie.flushSync($):$()}),a.$subscribe(K,()=>{_[b]&&_[b]()}),a.$subscribe(Q,()=>{w[b]&&w[b]()});const m=k[b];return V.$observeRoot(m),S.$observe(m),()=>{a.$dispose(),V.$dispose(),S.$dispose()}},[]),q(()=>{S.$fixScrollJump()},[M]),r.useImperativeHandle(y,()=>({get cache(){return a.$getCacheSnapshot()},get scrollOffset(){return a.$getScrollOffset()},get viewportSize(){return a.$getViewportSize()},findItemIndex:a.$findItemIndex,getItemOffset:a.$getItemOffset,getItemSize:a.$getItemSize,scrollToIndex:S.$scrollToIndex}),[]);for(let[m,v]=a.$getRange(s);m<=v;m++){const P=I(m);O.push(e.jsx(se,{_resizer:V.$observeItem,_index:m,_offset:a.$getItemOffset(m,U),_hide:a.$isUnmeasuredItem(m),_as:h,_children:P,_isHorizontal:N,_isSSR:W[b]},Z(P,m)))}return e.jsx(d,{ref:k,style:{contain:"size style",overflowAnchor:"none",flex:"none",position:"relative",width:N?H:"100%",height:N?"100%":H,pointerEvents:B?"none":void 0},children:O})});f.__docgenInfo={description:"{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",methods:[{name:"cache",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollOffset",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportSize",docblock:null,modifiers:["get"],params:[],returns:null}],displayName:"WindowVirtualizer",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ((data: T, index: number) => ReactElement)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:`Elements rendered by this component.
...
@defaultValue "div"`,defaultValue:{value:'"div"',computed:!1}},onScroll:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked whenever scroll offset changes."},onScrollEnd:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked when scrolling stops."}}};const E=l=>{const i=[20,40,80,77];return Array.from({length:l}).map((s,o)=>e.jsx("div",{style:{height:i[o%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:o},o))},oe=l=>Array.from({length:l}).map((i,s)=>e.jsxs("div",{style:{width:s%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",s]},s)),xe={component:f},C={render:()=>e.jsx("div",{style:{padding:"200px 100px"},children:e.jsx("div",{style:{border:"solid 1px gray"},children:e.jsx(f,{children:E(1e3)})})})},T={render:()=>e.jsx("div",{style:{padding:"100px 200px"},children:e.jsx("div",{style:{display:"inline-block",border:"solid 1px gray",height:400},children:e.jsx(f,{horizontal:!0,children:oe(1e3)})})})},j={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column"},children:[e.jsx("div",{style:{background:"white",height:60,marginBottom:40},children:"header"}),e.jsxs("div",{style:{display:"flex",flexDirection:"row"},children:[e.jsx("div",{style:{flex:1,display:"flex",paddingTop:600,margin:10},children:e.jsx(f,{children:E(1e3)})}),e.jsx("div",{style:{flex:3,margin:10},children:e.jsx(f,{children:Array.from({length:1e3}).map((l,i)=>e.jsx("div",{style:{height:200,borderRadius:8,margin:16,background:"#fff"},children:i},i))})}),e.jsx("div",{style:{flex:2,padding:20,paddingTop:300},children:e.jsx("div",{style:{top:0,height:400,position:"sticky",background:"white"}})})]}),e.jsx("div",{style:{background:"white",height:60,marginTop:40},children:"footer"})]})},R={render:()=>{const l=(g,x=0)=>{const y=[20,40,80,77];return Array.from({length:g}).map((I,n)=>(n+=x,e.jsx("div",{style:{height:y[n%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n},n)))},[i,s]=r.useState(!1),o=async()=>{s(!0),await F(1e3),s(!1)},t=100,[c,u]=r.useState(()=>l(t)),p=r.useRef(-1),d=c.length,h=r.useRef(null);return e.jsx("div",{style:{padding:"200px 100px 0px 100px"},children:e.jsxs(f,{ref:h,onScroll:async()=>{h.current&&p.current<d&&h.current.findItemIndex(h.current.scrollOffset+h.current.viewportSize)+50>d&&(p.current=d,await o(),u(g=>[...g,...l(t,g.length)]))},children:[c,i&&e.jsx(G,{})]})})}},ae=({id:l})=>{const i="window-list-cache-"+l,s=r.useRef(null),[o,t]=r.useMemo(()=>{const c=sessionStorage.getItem(i);if(!c)return[];try{return JSON.parse(c)}catch{return[]}},[]);return r.useLayoutEffect(()=>{if(!s.current)return;const c=s.current;window.scrollTo(0,o??0);let u=0;const p=()=>{u=window.scrollY};return window.addEventListener("scroll",p),p(),()=>{window.removeEventListener("scroll",p),sessionStorage.setItem(i,JSON.stringify([u,c.cache]))}},[]),e.jsx(f,{ref:s,cache:t,children:E(1e3)})},z={render:()=>{const[l,i]=r.useState(!0),[s,o]=r.useState("1");return e.jsxs("div",{style:{position:"relative"},children:[e.jsxs("div",{style:{position:"fixed",top:0,left:0,zIndex:10},children:[e.jsx("button",{onClick:()=>{i(t=>!t)},children:l?"hide":"show"}),["1","2","3"].map(t=>e.jsxs("label",{children:[e.jsx("input",{type:"radio",checked:s===t,onChange:()=>{o(t)}}),t]},t))]}),l&&e.jsx(ae,{id:s},s)]})}},L={render:()=>{const l=r.useRef(0),i=(n,k)=>Array.from({length:n}).map((_,w)=>(w+=k,{id:l.current++,index:w})),[s,o]=r.useState(!1),[t,c]=r.useState(4),[u,p]=r.useState(!1),[d,h]=r.useState(!0),[g,x]=r.useState(()=>i(t,0)),y=()=>{x(d?n=>u?[...i(t,(n[0]?.index??0)-t),...n]:[...n,...i(t,(n[n.length-1]?.index??0)+1)]:u?n=>n.slice(t):n=>n.slice(0,-t))};r.useEffect(()=>{if(!s)return;const n=setInterval(y,500);return()=>{clearInterval(n)}},[y,s]);const I=[20,40,80,77];return e.jsxs("div",{style:{display:"flex",flexDirection:"column"},children:[e.jsxs("div",{style:{position:"fixed",width:"100%",top:0,zIndex:1,backdropFilter:"blur(1px)"},children:[e.jsxs("div",{children:[e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:u,onChange:()=>{p(n=>!n)}}),"prepend"]}),e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:d,onChange:()=>{h(!0)}}),"increase"]}),e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:!d,onChange:()=>{h(!1)}}),"decrease"]}),e.jsx("input",{style:{marginLeft:4},value:t,type:"number",min:1,max:1e4,step:1,onChange:n=>{c(Number(n.target.value))}})]}),e.jsxs("div",{children:[e.jsxs("label",{style:{marginRight:16},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:s,onChange:()=>{o(n=>!n)}}),"auto"]}),e.jsx("button",{onClick:()=>{y()},children:"update"})]})]}),e.jsx("div",{style:{flex:1},children:e.jsx(f,{shift:u,children:g.map(n=>e.jsx("div",{style:{height:I[Math.abs(n.index)%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n.index},n.id))})})]})}},A={render:()=>{const[i,s]=r.useState(567),[o,t]=r.useState("start"),[c,u]=r.useState(!1),p=r.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{position:"fixed",top:30,left:150,zIndex:1,padding:10,border:"1px solid #ccc",backgroundColor:"white"},children:[e.jsx("input",{type:"number",value:i,onChange:d=>{s(Number(d.target.value))}}),e.jsx("button",{onClick:()=>{p.current?.scrollToIndex(i,{align:o,smooth:c})},children:"scroll to index"}),e.jsx("button",{onClick:()=>{s(Math.round(1e3*Math.random()))},children:"randomize"}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="start",onChange:()=>{t("start")}}),"start"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="center",onChange:()=>{t("center")}}),"center"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="end",onChange:()=>{t("end")}}),"end"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:c,onChange:()=>{u(d=>!d)}}),"smooth"]})]}),e.jsx("div",{style:{padding:"100px"},children:e.jsx("div",{style:{border:"1px solid darkgrey"},children:e.jsx(f,{ref:p,children:E(1e3)})})})]})}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: "200px 100px"
    }}>
...
}`,...A.parameters?.docs?.source}}};const ye=["Default","Horizontal","Complex","InfiniteScrolling","ScrollRestoration","IncreasingItems","ScrollTo"];export{j as Complex,C as Default,T as Horizontal,L as IncreasingItems,R as InfiniteScrolling,z as ScrollRestoration,A as ScrollTo,ye as __namedExportsOrder,xe as default};

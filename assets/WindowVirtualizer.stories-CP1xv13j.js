import{j as e}from"./jsx-runtime-nnBHNMqC.js";import"./index-CaRMSPmq.js";import{r}from"./iframe-BY4JgEuj.js";import{S as U,d as G}from"./common-DDIGkhOt.js";import{u as q,a as F,A as J,c as M,r as b,U as X,d as Y,e as K,j as Q,f as Z,k as ee,l as ne}from"./useLatestRef-BRcDC_63.js";import{u as te,L as re}from"./useChildren-CRxL9NEJ.js";import{r as se}from"./index-CIfxW1Lk.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CVsapkyO.js";const h=r.forwardRef(({children:a,data:i,bufferSize:s,itemSize:o,shift:t,horizontal:c,cache:u,ssrCount:p,as:d="div",item:f="div",onScroll:g,onScrollEnd:x},y)=>{d=d;const[S,n]=te(a,i),I=r.useRef(null),_=q(g),w=q(x),N=r.useRef(!!p),[l,V,k,W]=F(()=>{const m=!!c,v=Z(n,o,p,u,!o);return[v,ee(v,m),ne(v,m),m]});n!==l.$getItemsLength()&&l.$update(J,[n,t]);const[O,$]=r.useReducer(l.$getStateVersion,void 0,l.$getStateVersion),B=l.$isScrolling(),H=l.$getTotalSize(),P=[];M(()=>{N[b]=!1,l.$subscribe(X,v=>{v?se.flushSync($):$()}),l.$subscribe(Y,()=>{_[b]&&_[b]()}),l.$subscribe(K,()=>{w[b]&&w[b]()});const m=I[b];return V.$observeRoot(m),k.$observe(m),()=>{l.$dispose(),V.$dispose(),k.$dispose()}},[]),M(()=>{k.$fixScrollJump()},[O]),r.useImperativeHandle(y,()=>({get cache(){return l.$getCacheSnapshot()},findStartIndex:l.$findStartIndex,findEndIndex:l.$findEndIndex,scrollToIndex:k.$scrollToIndex}),[]);for(let[m,v]=l.$getRange(s);m<=v;m++){const D=S(m);P.push(e.jsx(re,{_resizer:V.$observeItem,_index:m,_offset:l.$getItemOffset(m),_hide:l.$isUnmeasuredItem(m),_as:f,_children:D,_isHorizontal:W,_isSSR:N[b]},Q(D,m)))}return e.jsx(d,{ref:I,style:{contain:"size style",overflowAnchor:"none",flex:"none",position:"relative",width:W?H:"100%",height:W?"100%":H,pointerEvents:B?"none":void 0},children:P})});h.__docgenInfo={description:"{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",methods:[{name:"cache",docblock:null,modifiers:["get"],params:[],returns:null}],displayName:"WindowVirtualizer",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ((data: T, index: number) => ReactElement)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:`Elements rendered by this component.
...
@defaultValue "div"`,defaultValue:{value:'"div"',computed:!1}},onScroll:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked whenever scroll offset changes."},onScrollEnd:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked when scrolling stops."}}};const A=a=>{const i=[20,40,80,77];return Array.from({length:a}).map((s,o)=>e.jsx("div",{style:{height:i[o%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:o},o))},ie=a=>Array.from({length:a}).map((i,s)=>e.jsxs("div",{style:{width:s%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",s]},s)),ge={component:h},C={render:()=>e.jsx("div",{style:{padding:"200px 100px"},children:e.jsx("div",{style:{border:"solid 1px gray"},children:e.jsx(h,{children:A(1e3)})})})},T={render:()=>e.jsx("div",{style:{padding:"100px 200px"},children:e.jsx("div",{style:{display:"inline-block",border:"solid 1px gray",height:400},children:e.jsx(h,{horizontal:!0,children:ie(1e3)})})})},j={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column"},children:[e.jsx("div",{style:{background:"white",height:60,marginBottom:40},children:"header"}),e.jsxs("div",{style:{display:"flex",flexDirection:"row"},children:[e.jsx("div",{style:{flex:1,display:"flex",paddingTop:600,margin:10},children:e.jsx(h,{children:A(1e3)})}),e.jsx("div",{style:{flex:3,margin:10},children:e.jsx(h,{children:Array.from({length:1e3}).map((a,i)=>e.jsx("div",{style:{height:200,borderRadius:8,margin:16,background:"#fff"},children:i},i))})}),e.jsx("div",{style:{flex:2,padding:20,paddingTop:300},children:e.jsx("div",{style:{top:0,height:400,position:"sticky",background:"white"}})})]}),e.jsx("div",{style:{background:"white",height:60,marginTop:40},children:"footer"})]})},R={render:()=>{const a=(g,x=0)=>{const y=[20,40,80,77];return Array.from({length:g}).map((S,n)=>(n+=x,e.jsx("div",{style:{height:y[n%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n},n)))},[i,s]=r.useState(!1),o=async()=>{s(!0),await G(1e3),s(!1)},t=100,[c,u]=r.useState(()=>a(t)),p=r.useRef(-1),d=c.length,f=r.useRef(null);return e.jsx("div",{style:{padding:"200px 100px 0px 100px"},children:e.jsxs(h,{ref:f,onScroll:async()=>{f.current&&p.current<d&&f.current.findEndIndex()+50>d&&(p.current=d,await o(),u(g=>[...g,...a(t,g.length)]))},children:[c,i&&e.jsx(U,{})]})})}},oe=({id:a})=>{const i="window-list-cache-"+a,s=r.useRef(null),[o,t]=r.useMemo(()=>{const c=sessionStorage.getItem(i);if(!c)return[];try{return JSON.parse(c)}catch{return[]}},[]);return r.useLayoutEffect(()=>{if(!s.current)return;const c=s.current;window.scrollTo(0,o??0);let u=0;const p=()=>{u=window.scrollY};return window.addEventListener("scroll",p),p(),()=>{window.removeEventListener("scroll",p),sessionStorage.setItem(i,JSON.stringify([u,c.cache]))}},[]),e.jsx(h,{ref:s,cache:t,children:A(1e3)})},z={render:()=>{const[a,i]=r.useState(!0),[s,o]=r.useState("1");return e.jsxs("div",{style:{position:"relative"},children:[e.jsxs("div",{style:{position:"fixed",top:0,left:0,zIndex:10},children:[e.jsx("button",{onClick:()=>{i(t=>!t)},children:a?"hide":"show"}),["1","2","3"].map(t=>e.jsxs("label",{children:[e.jsx("input",{type:"radio",checked:s===t,onChange:()=>{o(t)}}),t]},t))]}),a&&e.jsx(oe,{id:s},s)]})}},L={render:()=>{const a=r.useRef(0),i=(n,I)=>Array.from({length:n}).map((_,w)=>(w+=I,{id:a.current++,index:w})),[s,o]=r.useState(!1),[t,c]=r.useState(4),[u,p]=r.useState(!1),[d,f]=r.useState(!0),[g,x]=r.useState(()=>i(t,0)),y=()=>{x(d?n=>u?[...i(t,(n[0]?.index??0)-t),...n]:[...n,...i(t,(n[n.length-1]?.index??0)+1)]:u?n=>n.slice(t):n=>n.slice(0,-t))};r.useEffect(()=>{if(!s)return;const n=setInterval(y,500);return()=>{clearInterval(n)}},[y,s]);const S=[20,40,80,77];return e.jsxs("div",{style:{display:"flex",flexDirection:"column"},children:[e.jsxs("div",{style:{position:"fixed",width:"100%",top:0,zIndex:1,backdropFilter:"blur(1px)"},children:[e.jsxs("div",{children:[e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:u,onChange:()=>{p(n=>!n)}}),"prepend"]}),e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:d,onChange:()=>{f(!0)}}),"increase"]}),e.jsxs("label",{style:{marginRight:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:!d,onChange:()=>{f(!1)}}),"decrease"]}),e.jsx("input",{style:{marginLeft:4},value:t,type:"number",min:1,max:1e4,step:1,onChange:n=>{c(Number(n.target.value))}})]}),e.jsxs("div",{children:[e.jsxs("label",{style:{marginRight:16},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:s,onChange:()=>{o(n=>!n)}}),"auto"]}),e.jsx("button",{onClick:()=>{y()},children:"update"})]})]}),e.jsx("div",{style:{flex:1},children:e.jsx(h,{shift:u,children:g.map(n=>e.jsx("div",{style:{height:S[Math.abs(n.index)%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n.index},n.id))})})]})}},E={render:()=>{const[i,s]=r.useState(567),[o,t]=r.useState("start"),[c,u]=r.useState(!1),p=r.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{position:"fixed",top:30,left:150,zIndex:1,padding:10,border:"1px solid #ccc",backgroundColor:"white"},children:[e.jsx("input",{type:"number",value:i,onChange:d=>{s(Number(d.target.value))}}),e.jsx("button",{onClick:()=>{p.current?.scrollToIndex(i,{align:o,smooth:c})},children:"scroll to index"}),e.jsx("button",{onClick:()=>{s(Math.round(1e3*Math.random()))},children:"randomize"}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="start",onChange:()=>{t("start")}}),"start"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="center",onChange:()=>{t("center")}}),"center"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"radio",style:{marginLeft:4},checked:o==="end",onChange:()=>{t("end")}}),"end"]}),e.jsxs("label",{style:{marginLeft:4},children:[e.jsx("input",{type:"checkbox",style:{marginLeft:4},checked:c,onChange:()=>{u(d=>!d)}}),"smooth"]})]}),e.jsx("div",{style:{padding:"100px"},children:e.jsx("div",{style:{border:"1px solid darkgrey"},id:"window-virtualizer-parent",children:e.jsx(h,{ref:p,children:A(1e3)})})})]})}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: "200px 100px"
    }}>
...
}`,...E.parameters?.docs?.source}}};const xe=["Default","Horizontal","Complex","InfiniteScrolling","ScrollRestoration","IncreasingItems","ScrollTo"];export{j as Complex,C as Default,T as Horizontal,L as IncreasingItems,R as InfiniteScrolling,z as ScrollRestoration,E as ScrollTo,xe as __namedExportsOrder,ge as default};

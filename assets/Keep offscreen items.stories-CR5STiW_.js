import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as s}from"./iframe-rSo0l5md.js";import{f as j}from"./chunk-4X5ZEQ5K-BPNiwWK2.js";import{V as p}from"./VList-CYWpmqlw.js";import"./preload-helper-BQ24v_F8.js";import"./Virtualizer-CRFmbFBb.js";import"./useLatestRef-QGFyE2IX.js";import"./useChildren-2kwtgTyd.js";import"./index-fa07GDGl.js";const T={component:p},E=[20,40,80,77],S=({i,onMount:n})=>(s.useEffect(()=>{n(i)},[]),e.jsx("div",{style:{height:E[i%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:i})),a={render:()=>{const[i,n]=s.useState([]);return e.jsxs("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[e.jsx("div",{children:e.jsx("button",{onClick:()=>{n([])},children:"clear"})}),e.jsx(p,{count:1e3,keepMounted:i,children:t=>e.jsx(S,{i:t,onMount:d=>{n(c=>{const l=new Set(c);return l.add(d),Array.from(l).sort((o,u)=>o-u)})}},t)})]})}},k={border:"solid 1px #ccc",background:"#fff",margin:10,padding:10,borderRadius:8,whiteSpace:"pre-wrap"},w=({value:i})=>{const n=s.useRef(null);return s.useEffect(()=>{var t;(t=n.current)==null||t.focus()},[]),e.jsx("textarea",{style:{width:"100%"},rows:6,ref:n,defaultValue:i})},M=({id:i,value:n,isEditing:t,toggleEditing:d})=>e.jsxs("div",{style:{...k},children:[t?e.jsx(w,{value:n}):n,e.jsx("div",{children:e.jsx("button",{onClick:()=>d(i),children:t?"Stop editing":"Edit"})})]}),f={render:()=>{const i=s.useRef(0),n=({value:r=j.lorem.paragraphs(1)}={})=>({id:i.current++,value:r}),[t,d]=s.useState(()=>Array.from({length:20},()=>n())),[c,l]=s.useState(null),o=s.useRef(null),u=s.useRef(!1);s.useLayoutEffect(()=>{u.current=!1}),s.useEffect(()=>{o.current&&o.current.scrollToIndex(t.length-1,{align:"end"})},[]);const b=s.useCallback(r=>{l(m=>r===m?null:r)},[]);return e.jsxs("div",{style:{width:"90vw",height:"90vh",display:"flex",flexDirection:"column"},children:[e.jsxs("div",{style:{padding:10},children:['1. Click "edit" button on any item',e.jsx("br",{}),"2. Modify text",e.jsx("br",{}),"3. Scroll that item out of view and back - the editor state is not lost, and item in edit mode is not unmounted when goes offscreen"]}),e.jsx(p,{ref:o,style:{flex:1},reverse:!0,keepMounted:c?[t.findIndex(r=>r.id===c)]:void 0,shift:!0,onScroll:r=>{o.current&&r<100&&(u.current=!0,d(m=>[...Array.from({length:20},()=>n()),...m]))},children:t.map(r=>e.jsx(M,{isEditing:r.id===c,toggleEditing:b,...r},r.id))})]})}};var x,g,h;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => {

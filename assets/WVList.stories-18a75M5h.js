import{a as e,j as l}from"./jsx-runtime-sgeEVxPu.js";import{r as s}from"./index-yp3VsGQP.js";import{S as he,d as fe}from"./common-jfrYHwuZ.js";import{a as ge,A as ye,b as ve,u as U,r as N,U as be,c as xe,l as Se,d as we,e as Ie,n as Re,S as _e,v as Ce,V as ke,f as Le,g as Te,p as Ve,q as Ee}from"./useRerender-NAuSx9YU.js";import{u as ze,a as Ae,L as We}from"./useChildren-_rCnKnJe.js";import{r as Ne}from"./index-8dy-jdxy.js";const f=s.forwardRef(({children:i,count:o,overscan:t=4,initialItemSize:d,initialItemCount:r,shift:p,horizontal:u,cache:m,components:{Root:g=ke,Item:S="div"}=Le,onScrollStop:w,onRangeChange:h,...v},b)=>{const[n,y]=ze(i,o),I=Ae(w),[c,D,H,R]=ge(()=>{const a=!!u,x=Te(y,d,r,m,!d);return[x,Ve(x,a),Ee(x,a),a]});y!==c._getItemsLength()&&c._update(ye,[y,p]);const q=ve(),[z,A]=c._getRange(),W=c._getScrollDirection(),le=c._getJumpCount(),B=c._getTotalSize(),P=s.useRef(null);U(()=>{const a=P[N],x=c._subscribe(be+xe,me=>{me?Ne.flushSync(q):q()}),_=c._subscribe(Se,()=>{I[N]&&I[N]()}),ue=D._observeRoot(a),pe=H._observe(a);return()=>{x(),_(),ue(),pe()}},[]),U(()=>{const a=c._flushJump();a&&H._fixScrollJump(a)},[le]),s.useEffect(()=>{h&&h(z,A)},[z,A]),s.useImperativeHandle(b,()=>({get cache(){return c._getCache()}}),[]);const ce=we(z,t,W),de=Ie(A,t,W,y),M=[];for(let a=ce;a<=de;a++){const x=n(a),_=x.key;M.push(e(We,{_resizer:D,_index:a,_offset:c._getItemOffset(a),_hide:c._isUnmeasuredItem(a),_element:S,_children:x,_isHorizontal:R},Re(_)?_:"_"+a))}return e(g,{ref:P,width:R?B:void 0,height:R?void 0:B,scrolling:W!==_e,attrs:s.useMemo(()=>({...v,style:{display:R?"inline-block":"block",width:R?"auto":"100%",height:R?"100%":"auto",...v.style}}),Ce(v)),children:M})});try{f.displayName="WVList",f.__docgenInfo={description:"Virtualized list component controlled by the window scrolling. See {@link WVListProps} and {@link WVListHandle}.",displayName:"WVList",props:{children:{defaultValue:null,description:`Elements rendered by this component.

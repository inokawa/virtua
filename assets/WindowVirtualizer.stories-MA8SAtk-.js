import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-5pQJk-CT.js";import{S as X,d as Y}from"./common-BqtzafjA.js";import{a as q,u as K,A as Q,b as M,r as b,U as Z,c as ee,d as ne,n as te,e as re,o as se,p as ie}from"./useLatestRef-bBzzMY-n.js";import{u as oe,L as ae}from"./useChildren-wyt5jskI.js";import{r as le}from"./index-B3mityPg.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ClHJ2JXX.js";const h=r.forwardRef(({children:a,data:i,overscan:s,itemSize:o,shift:t,horizontal:c,cache:u,ssrCount:p,as:l="div",item:f="div",onScroll:g,onScrollEnd:x},y)=>{l=l;const[S,n]=oe(a,i),I=r.useRef(null),V=q(g),w=q(x),H=r.useRef(!!p),[d,W,k,N]=K(()=>{const m=!!c,v=re(n,o,s,p,u,!o);return[v,se(v,m),ie(v,m),m]});n!==d.$getItemsLength()&&d.$update(Q,[n,t]);const[B,$]=r.useReducer(d.$getStateVersion,void 0,d.$getStateVersion),[U,G]=d.$getRange(),F=d.$isScrolling(),O=d.$getTotalSize(),P=[];M(()=>{H[b]=!1;const m=d.$subscribe(Z,J=>{J?le.flushSync($):$()}),v=d.$subscribe(ee,()=>{V[b]&&V[b]()}),C=d.$subscribe(ne,()=>{w[b]&&w[b]()}),D=I[b];return W.$observeRoot(D),k.$observe(D),()=>{m(),v(),C(),W.$dispose(),k.$dispose()}},[]),M(()=>{k.$fixScrollJump()},[B]),r.useImperativeHandle(y,()=>({get cache(){return d.$getCacheSnapshot()},findStartIndex:d.$findStartIndex,findEndIndex:d.$findEndIndex,scrollToIndex:k.$scrollToIndex}),[]);for(let m=U,v=G;m<=v;m++){const C=S(m);P.push(e.jsx(ae,{_resizer:W.$observeItem,_index:m,_offset:d.$getItemOffset(m),_hide:d.$isUnmeasuredItem(m),_as:f,_children:C,_isHorizontal:N,_isSSR:H[b]},te(C,m)))}return e.jsx(l,{ref:I,style:{contain:"size paint style",overflowAnchor:"none",overflow:"clip",flex:"none",position:"relative",width:N?O:"100%",height:N?"100%":O,pointerEvents:F?"none":void 0},children:P})});h.__docgenInfo={description:"{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",methods:[{name:"cache",docblock:null,modifiers:["get"],params:[],returns:null}],displayName:"WindowVirtualizer",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ((data: T, index: number) => ReactElement)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:`Elements rendered by this component.
...
}`,...A.parameters?.docs?.source}}};const be=["Default","Horizontal","Complex","InfiniteScrolling","ScrollRestoration","IncreasingItems","ScrollTo"];export{R as Complex,T as Default,j as Horizontal,E as IncreasingItems,z as InfiniteScrolling,L as ScrollRestoration,A as ScrollTo,be as __namedExportsOrder,ve as default};

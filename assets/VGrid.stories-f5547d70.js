import{j as t,a as m}from"./jsx-runtime-f8a6c6ea.js";import{r as u}from"./index-5284b0bf.js";import{u as g,a as N,r as ve,c as Ie,d as Y,f as $,m as Q,g as X,j as Se}from"./resizer-a7c3115e.js";import"./index-480187bb.js";const M=(n,e)=>`${n}-${e}`,Ce=u.memo(({_children:n,_resizer:e,_verticalStore:l,_horizontalStore:s,_rowIndex:d,_colIndex:a,_element:p,_isRtl:r})=>{const c=u.useRef(null),x=g(l,()=>l._getItemOffset(d),!0),I=g(s,()=>s._getItemOffset(a),!0),S=g(l,()=>l._isUnmeasuredItem(d),!0),C=g(s,()=>s._isUnmeasuredItem(a),!0),V=g(l,()=>l._getItemSize(d),!0),R=g(s,()=>s._getItemSize(a),!0);return N(()=>e._observeItem(c[ve],d,a),[a,d]),t(p,{ref:c,style:u.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:x,[r?"right":"left"]:I,visibility:S||C?"hidden":"visible",minHeight:V,minWidth:R}),[x,I,R,V,S,C]),children:n})}),Ve=u.forwardRef(({children:n,scrollWidth:e,scrollHeight:l,scrolling:s,attrs:d},a)=>t("div",{ref:a,...d,children:t("div",{style:u.useMemo(()=>({position:"relative",visibility:"hidden",width:e,height:l,pointerEvents:s?"none":"auto"}),[e,l,s]),children:n})})),Re=({_children:n,_ref:e,_vStore:l,_hStore:s,_element:d,_scrolling:a,_attrs:p})=>{const r=g(l,l._getScrollSize),c=g(s,s._getScrollSize);return t(d,{ref:e,scrollWidth:c,scrollHeight:r,scrolling:a,attrs:u.useMemo(()=>({...p,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",padding:0,margin:0,...p.style}}),[p]),children:n})},b=u.forwardRef(({children:n,row:e,col:l,cellHeight:s=40,cellWidth:d=100,overscan:a=2,initialRowCount:p,initialColCount:r,rtl:c,element:x=Ve,cellElement:I="div",...S},C)=>{const[V,R]=u.useState(!1),[q,ye]=u.useState(!1),[f,v,D,_,w,be]=Ie(()=>{const i=!!c,o=()=>{},h=Y(e,s,p,!1,R,o),y=Y(l,d,r,!1,ye,o),L=Se(h,y);return[h,y,L,$(h,!1,i,()=>L._isJustResized()),$(y,!0,i,()=>L._isJustResized(!0)),i]});f._updateCacheLength(e),v._updateCacheLength(l);const[A,_e]=g(f,f._getRange),[J,we]=g(v,v._getRange),W=g(f,f._getJump),E=g(v,v._getJump),j=u.useRef(null);N(()=>{const i=j[ve],o=D._observeRoot(i),h=_._initRoot(i),y=w._initRoot(i);return()=>{o(),h(),y()}},[]),N(()=>{W.length&&_._fixScrollJump(W,A)},[W]),N(()=>{E.length&&w._fixScrollJump(E,J)},[E]),u.useImperativeHandle(C,()=>({get scrollOffset(){return[v._getScrollOffset(),f._getScrollOffset()]},get scrollSize(){return[w._getActualScrollSize(),_._getActualScrollSize()]},get viewportSize(){return[v._getViewportSize(),f._getViewportSize()]},scrollToIndex(i,o){w._scrollToIndex(i,l),_._scrollToIndex(o,e)},scrollTo(i,o){w._scrollTo(i),_._scrollTo(o)},scrollBy(i,o){w._scrollTo(v._getScrollOffset()+i),_._scrollTo(f._getScrollOffset()+o)}}),[e,l]);const P=u.useMemo(()=>{const i=new Map;return(o,h)=>{let y=i.get(M(o,h));return y||i.set(M(o,h),y=n({rowIndex:o,colIndex:h})),y}},[n]),B=Q(A-a,0),F=X(_e+a,e-1),K=Q(J-a,0),U=X(we+a,l-1),xe=u.useMemo(()=>{const i=[];for(let o=B;o<=F;o++)for(let h=K;h<=U;h++)i.push(t(Ce,{_resizer:D,_verticalStore:f,_horizontalStore:v,_rowIndex:o,_colIndex:h,_element:I,_children:P(o,h),_isRtl:be},M(o,h)));return i},[P,B,F,K,U]);return t(Re,{_ref:j,_vStore:f,_hStore:v,_element:x,_scrolling:V||q,_children:xe,_attrs:S})});try{b.displayName="VGrid",b.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
@defaultValue "div"`,name:"cellElement",required:!1,type:{name:"CustomCellComponentOrElement"}}}}}catch{}const ke={component:b},G={render:()=>t(b,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>m("div",{style:{border:"solid 1px gray",background:"white",padding:4},children:[n," / ",e]})})},O={render:()=>t(b,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>m("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100,height:(n%2+1)*100},children:[n," / ",e]})})},T={render:()=>t(b,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>m("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100},children:[m("div",{children:[n," / ",e]}),Array.from({length:n%8+1},()=>t("div",{children:"Hello world!"}))]})})},H={render:()=>t(b,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>m("div",{style:{border:"solid 1px gray",background:"white",padding:4,height:(n%2+1)*100},children:[m("div",{children:[n," / ",e]}),t("div",{children:Array.from({length:e%4+1},()=>t("span",{children:"Hello world!"}))})]})})},k={render:()=>t(b,{style:{height:"100vh",direction:"rtl"},row:1e3,col:500,rtl:!0,children:({rowIndex:n,colIndex:e})=>m("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:100},children:[n," / ",e]})})},z={render:()=>{const[l,s]=u.useState([567,567]),[d,a]=u.useState([1e3,1e3]),p=u.useRef(null);return m("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[m("div",{children:[m("label",{children:["col",t("input",{type:"number",value:l[0],onChange:r=>{s(c=>[Number(r.target.value),c[1]])}})]}),m("label",{children:["row",t("input",{type:"number",value:l[1],onChange:r=>{s(c=>[c[0],Number(r.target.value)])}})]}),t("button",{onClick:()=>{var r;(r=p.current)==null||r.scrollToIndex(l[0],l[1])},children:"scroll to index"}),t("button",{onClick:()=>{s([Math.round(1e3*Math.random()),Math.round(1e3*Math.random())])},children:"randomize"})]}),t("div",{children:m("div",{children:[m("label",{children:["x",t("input",{type:"number",value:d[0],onChange:r=>{a(c=>[Number(r.target.value),c[1]])}})]}),m("label",{children:["y",t("input",{type:"number",value:d[1],onChange:r=>{a(c=>[c[0],Number(r.target.value)])}})]}),t("button",{onClick:()=>{var r;(r=p.current)==null||r.scrollTo(d[0],d[1])},children:"scroll to offset"}),t("button",{onClick:()=>{var r;(r=p.current)==null||r.scrollBy(d[0],d[1])},children:"scroll by offset"})]})}),t(b,{ref:p,style:{height:"100vh"},row:1e3,col:1e3,children:({rowIndex:r,colIndex:c})=>m("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:160,height:80},children:[r," / ",c]})})]})}};var Z,ee,ne;G.parameters={...G.parameters,docs:{...(Z=G.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
//# sourceMappingURL=VGrid.stories-f5547d70.js.map

import{a as e,j as l}from"./jsx-runtime-sgeEVxPu.js";import{r as i}from"./index-yp3VsGQP.js";import{S as ce,d as ue}from"./common-4ZgZpLnL.js";import{a as pe,A as me,b as he,u as M,r as C,U as fe,c as ge,l as ye,o as ve,d as be,m as we,S as xe,e as Se,q as Ie,s as _e}from"./useRerender-ga2IJ1ad.js";import{u as Re,a as Ce,L as ke}from"./useChildren-psD8wSO9.js";import{r as ze}from"./index-8dy-jdxy.js";const g=i.forwardRef(({children:o,count:s,overscan:t=4,itemSize:d,shift:r,horizontal:m,cache:c,ssrCount:p,as:h="div",item:v="div",onScrollEnd:b,onRangeChange:f},S)=>{h=h;const[y,n]=Re(o,s),w=i.useRef(null),I=Ce(b),_=i.useRef(!!p),[u,A,W,N]=pe(()=>{const a=!!m,x=Se(n,d,p,c,!d);return[x,Ie(x,a),_e(x,a),a]});n!==u._getItemsLength()&&u._update(me,[n,r]);const B=he(u),[D,O]=u._getRange(),q=u._getScrollDirection(),le=u._getJumpCount(),P=u._getTotalSize(),U=[];M(()=>{_[C]=!1;const a=u._subscribe(fe+ge,de=>{de?ze.flushSync(B):B()}),x=u._subscribe(ye,()=>{I[C]&&I[C]()}),R=w[C];return A._observeRoot(R),W._observe(R),()=>{a(),x(),A._dispose(),W._dispose()}},[]),M(()=>{const a=u._flushJump();a&&W._fixScrollJump(a)},[le]),i.useEffect(()=>{f&&f(D,O)},[D,O]),i.useImperativeHandle(S,()=>({get cache(){return u._getCacheSnapshot()}}),[]);for(let a=ve(D,t,q),x=be(O,t,q,n);a<=x;a++){const R=y(a);U.push(e(ke,{_resizer:A._observeItem,_index:a,_offset:u._getItemOffset(a),_hide:u._isUnmeasuredItem(a),_element:v,_children:R,_isHorizontal:N,_isSSR:_[C]},we(R,a)))}return e(h,{ref:w,style:{flex:"none",position:"relative",visibility:"hidden",width:N?P:"100%",height:N?"100%":P,pointerEvents:q!==xe?"none":"auto"},children:U})});try{g.displayName="WindowVirtualizer",g.__docgenInfo={description:"{@link Virtualizer } controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizer}.",displayName:"WindowVirtualizer",props:{children:{defaultValue:null,description:`Elements rendered by this component.

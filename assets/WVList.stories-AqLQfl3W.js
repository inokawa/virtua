import{a as e,j as l}from"./jsx-runtime-sgeEVxPu.js";import{r as s}from"./index-yp3VsGQP.js";import{S as he,d as fe}from"./common-jfrYHwuZ.js";import{a as ge,A as ye,b as ve,u as j,r as D,U as be,c as xe,d as we,e as Se,l as Ie,v as Re,V as Ce,f as _e,g as ke,o as Le,p as Ve,S as Te}from"./useRerender-5UbPLih8.js";import{u as Ee,a as ze,L as Ae}from"./useChildren-7Kvug2i9.js";import{r as We}from"./index-8dy-jdxy.js";const f=s.forwardRef(({children:i,count:o,overscan:t=4,initialItemSize:c,initialItemCount:r,shift:p,horizontal:u,cache:m,components:{Root:g=Ce,Item:w="div"}=_e,onScrollStop:S,onRangeChange:h,...v},b)=>{const[n,y]=Ee(i,o),I=ze(S),[d,O,q,R]=ge(()=>{const a=!!u,x=ke(y,c,r,m,!c);return[x,Le(x,a),Ve(x,a),a]});y!==d._getItemsLength()&&d._update(ye,[y,p]);const B=ve(),[z,A]=d._getRange(),W=d._getScrollDirection(),ce=d._getJumpCount(),M=d._getTotalSize(),P=s.useRef(null),N=W!==Te;j(()=>{const a=P[D],x=d._subscribe(be+xe,me=>{me?We.flushSync(B):B()}),C=O._observeRoot(a),pe=q._observe(a);return()=>{x(),C(),pe()}},[]),j(()=>{const a=d._flushJump();a&&q._fixScrollJump(a)},[ce]),s.useEffect(()=>{N||I[D]&&I[D]()},[N]),s.useEffect(()=>{h&&h(z,A)},[z,A]),s.useImperativeHandle(b,()=>({get cache(){return d._getCache()}}),[]);const de=we(z,t,W),ue=Se(A,t,W,y),U=[];for(let a=de;a<=ue;a++){const x=n(a),C=x.key;U.push(e(Ae,{_resizer:O,_index:a,_offset:d._getItemOffset(a),_hide:d._isUnmeasuredItem(a),_element:w,_children:x,_isHorizontal:R},Ie(C)?C:"_"+a))}return e(g,{ref:P,width:R?M:void 0,height:R?void 0:M,scrolling:N,attrs:s.useMemo(()=>({...v,style:{display:R?"inline-block":"block",width:R?"auto":"100%",height:R?"100%":"auto",...v.style}}),Re(v)),children:U})});try{f.displayName="WVList",f.__docgenInfo={description:"Virtualized list component controlled by the window scrolling. See {@link WVListProps} and {@link WVListHandle}.",displayName:"WVList",props:{children:{defaultValue:null,description:`Elements rendered by this component.
...
}`,...(te=(ne=V.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};var re,se,oe;T.parameters={...T.parameters,docs:{...(re=T.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: () => {
...
}`,...(oe=(se=T.parameters)==null?void 0:se.docs)==null?void 0:oe.source}}};var ie,ae,le;E.parameters={...E.parameters,docs:{...(ie=E.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => {
    const id = useRef(0);

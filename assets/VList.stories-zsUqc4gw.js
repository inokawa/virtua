import{a as e,j as a,F as Pe}from"./jsx-runtime-sgeEVxPu.js";import{r as n}from"./index-yp3VsGQP.js";import{S as G,d as $}from"./common-jfrYHwuZ.js";import{V as m}from"./VList-UkioHAUs.js";import"./useRerender-ldYO7iu_.js";import"./useChildren-ETyTt_Of.js";import"./index-8dy-jdxy.js";const nn={component:m},R=r=>{const t=[20,40,80,77];return Array.from({length:r}).map((s,i)=>e("div",{style:{height:t[i%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:i},i))},w={render:()=>e(m,{style:{height:"100vh"},children:R(1e3)})},Ge=r=>Array.from({length:r}).map((t,s)=>a("div",{style:{width:s%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",s]},s)),T={render:()=>e("div",{style:{padding:10},children:e(m,{style:{width:"100%",height:200},horizontal:!0,children:Ge(1e3)})})},A={render:()=>e(m,{style:{width:400,height:400,padding:"80px 20px",background:"lightgray"},children:Array.from({length:1e3}).map((r,t)=>e("div",{style:{height:100,borderRadius:8,margin:10,padding:10,background:"white"},children:t},t))})},L={render:()=>{const r=n.useRef(null);return n.useEffect(()=>{var t;(t=r.current)==null||t.scrollToIndex(999)},[]),e(m,{ref:r,style:{height:"100vh"},reverse:!0,children:R(1e3)})}},_={render:()=>{const r="item";return a(Pe,{children:[e(m,{style:{height:"100vh"},children:Array.from({length:1e3}).map((t,s)=>e("div",{className:r,style:{borderBottom:"solid 1px #ccc",background:"#fff"},children:s},s))}),e("style",{children:`
          .${r} {
            height: 40px;

import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{f as n}from"./iframe-D8Mnq5OL.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{n as i,t as a}from"./VList-D8E1j2HX.js";import{i as o,r as s}from"./common-B5D_Jy0j.js";var c,l,u,d,f;function p(){return(p=t((()=>{i(),c=e(n(),1),s(),l=r(),u={component:a},d={name:`Loop`,render:()=>{let e=(0,c.useRef)(0),t=()=>({id:e.current++}),n=e=>o(e,t),r=(0,c.useRef)(null),[i,s]=(0,c.useState)(()=>n(200)),u=(0,c.useRef)(-1),d=(0,c.useRef)(!1);return(0,c.useLayoutEffect)(()=>{r.current?.scrollToIndex(100)},[]),(0,l.jsx)(a,{ref:r,style:{flex:1},shift:d.current,onScroll:e=>{if(d.current=e-u.current<0,u.current=e,!r.current)return;let t=d.current;e<100?(s(e=>[...n(50),...e]),setTimeout(()=>{d.current=!t,s(e=>[...e.slice(0,150)])},50)):r.current.scrollSize-r.current.viewportSize-e<100&&(s(e=>[...e,...n(50)]),setTimeout(()=>{d.current=!t,s(e=>[...e.slice(50)])},50))},children:i.map(e=>(0,l.jsx)(`div`,{style:{height:100,backgroundColor:e.id%100==0?`darkgray`:e.id%10==0?`smokegray`:`white`,borderBottom:`solid 1px #ccc`},children:e.id},e.id))})}},f=[`Default`],d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: "Loop",
  render: () => {

import{j as e,a as W}from"./jsx-runtime-c3d7f245.js";import{r as i}from"./index-c6dae603.js";import{S as ne}from"./components-951de649.js";import{f as te,u as re,a as se,b,c as N,r as z,e as ie,v as oe,W as ae,d as le,g as de,h as ce,m as ue,i as me}from"./Window-6d7940bf.js";import{L as pe}from"./ListItem-97e57b12.js";import"./index-eb008d06.js";const u=i.forwardRef(({children:r,overscan:o=4,initialItemSize:a,initialItemCount:m,horizontal:g,cache:S,element:R=ae,itemElement:y="div",onScrollStop:p,onRangeChange:l,...d},T)=>{const c=i.useMemo(()=>te(r),[r]),v=c.length,L=re(p),[n,E,H,f]=se(()=>{const t=!!g,s=le(v,a,m,!1,S);return[s,de(s,t),ce(s,t),t]});n._updateCacheLength(v);const[I,V]=b(n,n._getRange),k=b(n,n._getIsScrolling),$=b(n,n._getJumpCount),q=b(n,n._getCorrectedScrollSize,!0),A=i.useRef(null);N(()=>{const t=A[z],s=E._observeRoot(t),h=H._initRoot(t);return()=>{s(),h()}},[]),N(()=>{const t=n._flushJump();t&&H._fixScrollJump(t)},[$]),i.useEffect(()=>{k||L[z]&&L[z]()},[k]),i.useEffect(()=>{l&&l({start:I,end:V,count:v})},[I,V]),i.useImperativeHandle(T,()=>({get cache(){return n._getCache()}}),[]);const B=ue(I-o,0),M=me(V+o,v-1),ee=i.useMemo(()=>{const t=[];for(let s=B;s<=M;s++){const h=c[s];ie(h)&&t.push(e(pe,{_resizer:E,_store:n,_index:s,_element:y,_children:h,_isHorizontal:f,_isRtl:!1},h.key||s))}return t},[c,B,M]);return e(R,{ref:A,width:f?q:void 0,height:f?void 0:q,scrolling:k,attrs:i.useMemo(()=>({...d,style:{overflow:"visible",display:f?"inline-block":"block",width:f?"auto":"100%",height:f?"100%":"auto",padding:0,margin:0,...d.style}}),oe(d)),children:ee})});try{u.displayName="WVList",u.__docgenInfo={description:"Virtualized list component controlled by the window scrolling. See {@link WVListProps}.",displayName:"WVList",props:{children:{defaultValue:null,description:"Elements rendered by this component.",name:"children",required:!0,type:{name:"ReactNode"}},overscan:{defaultValue:{value:"4"},description:`Number of items to render above/below the visible bounds of the list. You can increase to avoid showing blank items in fast scrolling.
...
//# sourceMappingURL=WVList.stories-176e152c.js.map

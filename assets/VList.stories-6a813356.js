import{j as e,a,F as Ne}from"./jsx-runtime-c3d7f245.js";import{r as n}from"./index-c6dae603.js";import{S as He,d as De}from"./common-4271bb5e.js";import{V as h}from"./VList-4da9f765.js";import"./useRerender-d11e87b6.js";import"./useChildren-aecb96b5.js";import"./index-eb008d06.js";const qe={component:h},w=r=>{const t=[20,40,80,77];return Array.from({length:r}).map((s,i)=>e("div",{style:{height:t[i%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:i},i))},C={render:()=>e(h,{style:{height:"100vh"},children:w(1e3)})},Me=r=>Array.from({length:r}).map((t,s)=>a("div",{style:{width:s%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",s]},s)),L={render:()=>e("div",{style:{padding:10},children:e(h,{style:{width:"100%",height:200},horizontal:!0,children:Me(1e3)})})},T={render:()=>e(h,{style:{width:400,height:400,padding:"80px 20px",background:"lightgray"},children:Array.from({length:1e3}).map((r,t)=>e("div",{style:{height:100,borderRadius:8,margin:10,padding:10,background:"white"},children:t},t))})},A={render:()=>{const r=n.useRef(null);return n.useEffect(()=>{var t;(t=r.current)==null||t.scrollToIndex(999)},[]),e(h,{ref:r,style:{height:"100vh"},reverse:!0,children:w(1e3)})}},_={render:()=>{const r="item";return a(Ne,{children:[e(h,{style:{height:"100vh"},children:Array.from({length:1e3}).map((t,s)=>e("div",{className:r,style:{borderBottom:"solid 1px #ccc",background:"#fff"},children:s},s))}),e("style",{children:`
          .${r} {
            height: 40px;
...
//# sourceMappingURL=VList.stories-6a813356.js.map

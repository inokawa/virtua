import{j as o,a}from"./jsx-runtime-c3d7f245.js";import{r as m}from"./index-c6dae603.js";import{b as T,r as ie,l as Ve,u as Te,A as D,a as Re,U as M,c as A,v as Ge,V as Ee,d as He,g as q,m as Ne,n as j,S as J,j as U,k as B}from"./useRerender-cc948b6e.js";import{r as ke}from"./index-eb008d06.js";const H=(l,r)=>`${l}-${r}`,ze=m.memo(({_children:l,_resizer:r,_rowIndex:u,_colIndex:h,_top:f,_left:c,_height:t,_width:i,_hide:x,_element:R})=>{const g=m.useRef(null);return T(()=>r._observeItem(g[ie],u,h),[h,u]),o(R,{ref:g,style:m.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:f,[Ve()?"right":"left"]:c,visibility:x?"hidden":"visible",minHeight:t,minWidth:i}),[f,c,i,t,x]),children:l})}),p=m.forwardRef(({children:l,row:r,col:u,cellHeight:h=40,cellWidth:f=100,overscan:c=2,initialRowCount:t,initialColCount:i,components:{Root:x=Ee,Cell:R="div"}=He,...g},N)=>{const[s,d,k,b,v]=Te(()=>{const e=q(r,h,t),n=q(u,f,i);return[e,n,Ne(e,n),j(e,!1),j(n,!0)]});r!==s._getItemsLength()&&s._update(D,[r]),u!==d._getItemsLength()&&d._update(D,[u]);const z=Re(),[se,de]=s._getRange(),[ae,ce]=d._getRange(),G=s._getScrollDirection(),E=d._getScrollDirection(),ue=s._getJumpCount(),he=d._getJumpCount(),me=s._getCorrectedScrollSize(),pe=d._getCorrectedScrollSize(),O=m.useRef(null),fe=G!==J,ge=E!==J;T(()=>{const e=O[ie],n=Ce=>{Ce?ke.flushSync(z):z()},y=s._subscribe(M+A,n),_=d._subscribe(M+A,n),we=k._observeRoot(e),Se=b._initRoot(e),Ie=v._initRoot(e);return()=>{y(),_(),we(),Se(),Ie()}},[]),T(()=>{const e=s._flushJump();e&&b._fixScrollJump(e)},[ue]),T(()=>{const e=d._flushJump();e&&v._fixScrollJump(e)},[he]),m.useImperativeHandle(N,()=>({get scrollOffset(){return[d._getScrollOffset(),s._getScrollOffset()]},get scrollSize(){return[d._getCorrectedScrollSize(),s._getCorrectedScrollSize()]},get viewportSize(){return[d._getViewportSize(),s._getViewportSize()]},scrollToIndex(e,n){v._scrollToIndex(e),b._scrollToIndex(n)},scrollTo(e,n){v._scrollTo(e),b._scrollTo(n)},scrollBy(e,n){v._scrollBy(e),b._scrollBy(n)}}),[]);const be=m.useMemo(()=>{const e=new Map;return(n,y)=>{let _=e.get(H(n,y));return _||e.set(H(n,y),_=l({rowIndex:n,colIndex:y})),_}},[l]),ve=B(se,c,G),ye=U(de,c,G,r),_e=B(ae,c,E),xe=U(ce,c,E,u),L=[];for(let e=ve;e<=ye;e++)for(let n=_e;n<=xe;n++)L.push(o(ze,{_resizer:k,_rowIndex:e,_colIndex:n,_top:s._getItemOffset(e),_left:d._getItemOffset(n),_height:s._getItemSize(e),_width:d._getItemSize(n),_hide:s._isUnmeasuredItem(e)||d._isUnmeasuredItem(n),_element:R,_children:be(e,n)},H(e,n)));return o(x,{ref:O,width:pe,height:me,scrolling:fe||ge,attrs:m.useMemo(()=>({...g,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",...g.style}}),Ge(g)),children:L})});try{p.displayName="VGrid",p.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
}`,...(F=(P=w.parameters)==null?void 0:P.docs)==null?void 0:F.source}}};var K,$,Y;S.parameters={...S.parameters,docs:{...(K=S.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
}`,...(Y=($=S.parameters)==null?void 0:$.docs)==null?void 0:Y.source}}};var Z,Q,X;I.parameters={...I.parameters,docs:{...(Z=I.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
}`,...(X=(Q=I.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var ee,ne,re;C.parameters={...C.parameters,docs:{...(ee=C.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
//# sourceMappingURL=VGrid.stories-d1262db6.js.map

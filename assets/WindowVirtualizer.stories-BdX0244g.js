import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n}from"./iframe-BdkLKI9i.js";import{t as r}from"./react-dom-DG6tACpb.js";import{t as i}from"./jsx-runtime-DeHZSEgm.js";import{A as a,N as o,_ as s,b as c,c as l,i as u,j as d,k as f,l as p,m,n as h,o as g,r as _,s as v,t as y,u as b,x}from"./useLatestRef-cbDjFGGk.js";import{i as S,n as C,r as w,t as T}from"./useChildren-BvJ9c1iD.js";import{n as E,r as D,t as O}from"./common-BTIholai.js";var k,A,j,M;function N(){return(N=t((()=>{k=n(),o(),a(),x(),m(),p(),v(),_(),y(),S(),A=r(),T(),j=i(),M=(0,k.forwardRef)(({children:e,data:t,bufferSize:n,itemSize:r,shift:i,horizontal:a,cache:o,ssrCount:p,as:m=`div`,item:_=`div`,onScroll:v,onScrollEnd:y},x)=>{m=m;let[S,T]=C(e,t),E=(0,k.useRef)(null),D=h(v),O=h(y),M=(0,k.useRef)(!!p),[N,P,F,I]=u(()=>{let e=!!a,t=f(T,r,o),n=d(t,p);return[n,t,c(n,e),e]});T!==N.$getItemsLength()&&N.$update(5,[T,i]);let[L,R]=(0,k.useReducer)(N.$getStateVersion,void 0,N.$getStateVersion),z=N.$isScrolling(),B=N.$getTotalSize(),V=[];b(()=>(M[l]=!1,N.$subscribe(1,e=>{e?(0,A.flushSync)(R):R()}),N.$subscribe(4,()=>{D.current&&D.current()}),N.$subscribe(8,()=>{O.current&&O.current()}),F.$observe(E[l]),()=>{N.$dispose(),F.$dispose()}),[]),b(()=>{F.$effect()},[L]),(0,k.useImperativeHandle)(x,()=>({get cache(){return P.$snapshot()},get scrollOffset(){return N.$getScrollOffset()},get viewportSize(){return N.$getViewportSize()},findItemIndex:N.$findItemIndex,getItemOffset:N.$getItemOffset,getItemSize:N.$getItemSize,scrollToIndex:(e,t)=>s(F,N,e,t)}),[]);for(let[e,t]=N.$getRange(n);e<=t;e++){let t=S(e);V.push((0,j.jsx)(w,{_resizer:F.$observeItem,_index:e,_offset:N.$getItemOffset(e),_hide:N.$isUnmeasuredItem(e),_as:_,_children:t,_isHorizontal:I,_isSSR:M[l]},g(t,e)))}return(0,j.jsx)(m,{ref:E,style:{contain:`size style`,overflowAnchor:`none`,flex:`none`,position:`relative`,width:I?B:`100%`,height:I?`100%`:B,pointerEvents:z?`none`:void 0},children:V})}),M.__docgenInfo={description:`{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.`,methods:[{name:`cache`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`scrollOffset`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`viewportSize`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`scrollToIndex`,docblock:null,modifiers:[],params:[{name:`index`,optional:!1,type:null},{name:`opts`,optional:!1,type:null}],returns:null}],displayName:`WindowVirtualizer`,props:{children:{required:!0,tsType:{name:`union`,raw:`ReactNode | ((data: T, index: number) => ReactElement)`,elements:[{name:`ReactNode`},{name:`unknown`}]},description:`Elements rendered by this component.

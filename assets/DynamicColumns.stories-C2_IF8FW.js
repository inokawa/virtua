import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as m}from"./iframe-Cc_-dzvX.js";import{V as i}from"./VList-glVWQwii.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-DPToKkWp.js";import"./useLatestRef-CQENRF1m.js";import"./useChildren-9dvHm5nf.js";import"./index-DBaPupaA.js";import"./index-DKcxRtkc.js";const g={component:i},t={name:"DynamicColumns",render:()=>{const[s,l]=m.useState(3);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100vh"},children:[e.jsx("div",{children:e.jsxs("label",{children:["columns",e.jsx("input",{type:"number",value:s,min:1,max:100,step:1,style:{marginLeft:4},onChange:n=>{l(Number(n.target.value))}})]})}),e.jsx(i,{style:{flex:1},children:Array.from({length:1e3}).map((n,r)=>r).reduce((n,r)=>(r%s===0&&n.push([]),n[n.length-1].push(r),n),[]).map((n,r)=>e.jsx("div",{style:{display:"flex",borderBottom:"solid 1px #ccc",height:100},children:n.map(o=>e.jsx("div",{style:{flex:1/s,background:"#fff",borderRight:"solid 1px #ccc"},children:o},o))},r))})]})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  name: "DynamicColumns",
  render: () => {

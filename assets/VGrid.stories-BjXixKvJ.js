import{j as e}from"./jsx-runtime-CRdFn2pK.js";import"./index-CVQug6lh.js";import{r as m}from"./iframe-BvAKqPok.js";import{a as ie,A,g as T,u as W,c as k,U as D,d as le,r as y,e as de,f as Z,o as ae,p as ce}from"./useLatestRef-DhNElndx.js";import{r as q}from"./index-CTaNL9Sn.js";import"./preload-helper-PPVm8Dsz.js";import"./index-GHjdeYM9.js";const ue=r=>m.useCallback(n=>{for(const i of r)i&&(typeof i=="function"?i(n):i&&(i.current=n))},r),j=(r,n)=>`${r}-${n}`,me=m.memo(({_children:r,_resizer:n,_rowIndex:i,_colIndex:p,_top:b,_left:h,_height:o,_width:a,_hide:c,_element:u})=>{const g=m.useRef(null);return k(()=>n.$observeItem(g[y],i,p),[p,i]),e.jsx(u,{ref:g,style:m.useMemo(()=>({contain:"layout style",display:"grid",position:"absolute",top:b,left:h,visibility:c?"hidden":void 0,minHeight:o,minWidth:a}),[b,h,a,o,c]),children:r})}),w=m.forwardRef(({children:r,row:n,col:i,cellHeight:p=40,cellWidth:b=100,bufferSize:h,ssrRowCount:o,ssrColCount:a,item:c="div",domRef:u,innerDomRef:g,onScroll:f,onScrollEnd:I,style:P,...U},B)=>{const[s,d,S,v]=ie(()=>{const t=Z(n,p,o),l=Z(i,b,a);return[t,l,ae(t,l),ce(t,l)]});n!==s.$getItemsLength()&&s.$update(A,[n]),i!==d.$getItemsLength()&&d.$update(A,[i]);const[F,V]=m.useReducer(s.$getStateVersion,void 0,s.$getStateVersion),[J,G]=m.useReducer(d.$getStateVersion,void 0,d.$getStateVersion),K=s.$isScrolling(),X=d.$isScrolling(),Q=T(s),Y=T(d),N=m.useRef(null),M=W(f),_=W(I);k(()=>{s.$subscribe(D,x=>{x?q.flushSync(V):V()}),d.$subscribe(D,x=>{x?q.flushSync(G):G()}),s.$subscribe(le,()=>{M[y]&&M[y](s.$getScrollOffset())}),s.$subscribe(de,()=>{_[y]&&_[y]()});const t=N[y],l=t.parentElement;return S.$observeRoot(l),v.$observe(t,l),()=>{s.$dispose(),d.$dispose(),S.$dispose(),v.$dispose()}},[]),k(()=>{v.$fixScrollJump()},[F,J]),m.useImperativeHandle(B,()=>({get scrollTop(){return s.$getScrollOffset()},get scrollLeft(){return d.$getScrollOffset()},get scrollHeight(){return T(s)},get scrollWidth(){return T(d)},get viewportHeight(){return s.$getViewportSize()},get viewportWidth(){return d.$getViewportSize()},findRowIndex:s.$findItemIndex,findColIndex:d.$findItemIndex,getRowOffset:s.$getItemOffset,getColOffset:d.$getItemOffset,getRowSize:s.$getItemSize,getColSize:d.$getItemSize,resizeCols(t){S.$resizeCols(t)},resizeRows(t){S.$resizeRows(t)},scrollToIndex:v.$scrollToIndex,scrollTo:v.$scrollTo,scrollBy:v.$scrollBy}),[]);const ee=m.useMemo(()=>{const t=new Map;return(l,x)=>{let L=t.get(j(l,x));return L||t.set(j(l,x),L=r({rowIndex:l,colIndex:x})),L}},[r]),ne=v.$isNegative(),[re,te]=s.$getRange(h),[oe,se]=d.$getRange(h),O=[];for(let t=re;t<=te;t++)for(let l=oe;l<=se;l++)O.push(e.jsx(me,{_resizer:S,_rowIndex:t,_colIndex:l,_top:s.$getItemOffset(t),_left:d.$getItemOffset(l,ne),_height:s.$getItemSize(t),_width:d.$getItemSize(l),_hide:s.$isUnmeasuredItem(t)||d.$isUnmeasuredItem(l),_element:c,_children:ee(t,l)},j(t,l)));return e.jsx("div",{ref:u,...U,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",...P},children:e.jsx("div",{ref:ue([N,g]),style:{contain:"size style",overflowAnchor:"none",flex:"none",position:"relative",width:Y,height:Q,pointerEvents:K||X?"none":void 0},children:O})})});w.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",methods:[{name:"scrollTop",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollLeft",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"resizeCols",docblock:null,modifiers:[],params:[{name:"cols",optional:!1,type:null}],returns:null},{name:"resizeRows",docblock:null,modifiers:[],params:[{name:"rows",optional:!1,type:null}],returns:null}],displayName:"VGrid",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(arg: {
  /**
   * row index of cell
   */
  rowIndex: number;
...
@defaultValue "div"`,defaultValue:{value:'"div"',computed:!1}},domRef:{required:!1,tsType:{name:"Ref",elements:[{name:"HTMLDivElement"}],raw:"Ref<HTMLDivElement>"},description:"Reference to the rendered DOM element (the one that scrolls)."},innerDomRef:{required:!1,tsType:{name:"Ref",elements:[{name:"HTMLDivElement"}],raw:"Ref<HTMLDivElement>"},description:"Reference to the inner rendered DOM element (the one that contains all the cells)."},onScroll:{required:!1,tsType:{name:"signature",type:"function",raw:"(offset: number) => void",signature:{arguments:[{type:{name:"number"},name:"offset"}],return:{name:"void"}}},description:"Callback invoked whenever scroll offset changes."},onScrollEnd:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked when scrolling stops."}}};const xe={component:w},R={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:r,colIndex:n})=>e.jsxs("div",{style:{background:"white",padding:4,borderLeft:n!==0?"solid 1px gray":void 0,borderTop:r!==0?"solid 1px gray":void 0},children:[r," / ",n]})})},E={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:r,colIndex:n})=>e.jsxs("div",{style:{background:"white",padding:4,width:(n%2+1)*100,height:(r%2+1)*100,borderLeft:n!==0?"solid 1px gray":void 0,borderTop:r!==0?"solid 1px gray":void 0},children:[r," / ",n]})})},C={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:r,colIndex:n})=>e.jsxs("div",{style:{background:"white",padding:4,width:(n%2+1)*100,borderLeft:n!==0?"solid 1px gray":void 0,borderTop:r!==0?"solid 1px gray":void 0},children:[e.jsxs("div",{children:[r," / ",n]}),Array.from({length:r%8+1},()=>e.jsx("div",{children:"Hello world!"}))]})})},H={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:r,colIndex:n})=>e.jsxs("div",{style:{background:"white",padding:4,height:(r%2+1)*100,borderLeft:n!==0?"solid 1px gray":void 0,borderTop:r!==0?"solid 1px gray":void 0},children:[e.jsxs("div",{children:[r," / ",n]}),e.jsx("div",{children:Array.from({length:n%4+1},()=>e.jsx("span",{children:"Hello world!"}))})]})})},$={render:()=>{const[i,p]=m.useState(()=>new Map),[b,h]=m.useState(()=>new Map),o=m.useRef(null);function a(){const c=()=>Math.random()<.8?40+Math.round(200*Math.random()):80,u=new Map,g=new Map;for(let f=1;f<100;f++)u.set(f,c()),g.set(f,c());o.current?.resizeCols([...u.entries()]),o.current?.resizeRows([...g.entries()]),p(u),h(g)}return e.jsx(w,{ref:o,style:{height:"100vh"},row:100,col:100,cellHeight:80,cellWidth:80,children:({rowIndex:c,colIndex:u})=>e.jsxs("div",{style:{background:"white",padding:4,width:i.get(u)??80,height:b.get(c)??80,borderLeft:u!==0?"solid 1px gray":void 0,borderTop:c!==0?"solid 1px gray":void 0},children:[e.jsxs("div",{children:[c," / ",u]}),u===0&&c===0?e.jsx("button",{onClick:a,children:"random"}):c===0?e.jsx("input",{type:"number",step:5,value:i.get(u)??80,style:{width:50},onChange:g=>{const f=g.target.valueAsNumber;o.current?.resizeCols([[u,f]]),p(I=>new Map(I).set(u,f))}}):u===0?e.jsx("input",{type:"number",step:5,value:b.get(c)??80,style:{width:50},onChange:g=>{const f=g.target.valueAsNumber;o.current?.resizeRows([[c,f]]),h(I=>new Map(I).set(c,f))}}):null]})})}},z={render:()=>{const[n,i]=m.useState([567,567]),[p,b]=m.useState([1e3,1e3]),h=m.useRef(null);return e.jsxs("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[e.jsxs("div",{children:[e.jsxs("label",{children:["col",e.jsx("input",{type:"number",value:n[0],onChange:o=>{i(a=>[Number(o.target.value),a[1]])}})]}),e.jsxs("label",{children:["row",e.jsx("input",{type:"number",value:n[1],onChange:o=>{i(a=>[a[0],Number(o.target.value)])}})]}),e.jsx("button",{onClick:()=>{h.current?.scrollToIndex(n[0],n[1])},children:"scroll to index"}),e.jsx("button",{onClick:()=>{i([Math.round(1e3*Math.random()),Math.round(1e3*Math.random())])},children:"randomize"})]}),e.jsx("div",{children:e.jsxs("div",{children:[e.jsxs("label",{children:["x",e.jsx("input",{type:"number",value:p[0],onChange:o=>{b(a=>[Number(o.target.value),a[1]])}})]}),e.jsxs("label",{children:["y",e.jsx("input",{type:"number",value:p[1],onChange:o=>{b(a=>[a[0],Number(o.target.value)])}})]}),e.jsx("button",{onClick:()=>{h.current?.scrollTo(p[0],p[1])},children:"scroll to offset"}),e.jsx("button",{onClick:()=>{h.current?.scrollBy(p[0],p[1])},children:"scroll by offset"})]})}),e.jsx(w,{ref:h,style:{height:"100vh"},row:1e3,col:1e3,children:({rowIndex:o,colIndex:a})=>e.jsxs("div",{style:{background:"white",padding:4,width:160,height:80,borderLeft:a!==0?"solid 1px gray":void 0,borderTop:o!==0?"solid 1px gray":void 0},children:[o," / ",a]})})]})}};R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
}`,...z.parameters?.docs?.source}}};const ye=["Default","Fixed","DynamicHeight","DynamicWidth","Resizeable","ScrollTo"];export{R as Default,C as DynamicHeight,H as DynamicWidth,E as Fixed,$ as Resizeable,z as ScrollTo,ye as __namedExportsOrder,xe as default};

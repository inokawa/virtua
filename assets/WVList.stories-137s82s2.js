import{a as e,j as c}from"./jsx-runtime-sgeEVxPu.js";import{r as s}from"./index-yp3VsGQP.js";import{S as he,d as fe}from"./common-jfrYHwuZ.js";import{a as ge,A as ye,b as ve,u as M,r as W,U as be,c as xe,l as Se,d as we,e as Ie,n as Re,S as _e,v as Ce,V as ke,f as Le,g as Te,p as Ve,q as Ee}from"./useRerender-yG4Yh5zB.js";import{u as ze,a as Ae,L as We}from"./useChildren-RL_s2hLH.js";import{r as Ne}from"./index-8dy-jdxy.js";const f=s.forwardRef(({children:i,count:o,overscan:t=4,initialItemSize:d,initialItemCount:r,shift:p,horizontal:u,cache:m,components:{Root:g=ke,Item:S="div"}=Le,onScrollStop:w,onRangeChange:h,...v},b)=>{const[n,y]=ze(i,o),I=Ae(w),[l,O,D,R]=ge(()=>{const a=!!u,x=Te(y,d,r,m,!d);return[x,Ve(x,a),Ee(x,a),a]});y!==l._getItemsLength()&&l._update(ye,[y,p]);const H=ve(l),[E,z]=l._getRange(),A=l._getScrollDirection(),ae=l._getJumpCount(),q=l._getTotalSize(),B=s.useRef(null);M(()=>{const a=B[W],x=l._subscribe(be+xe,me=>{me?Ne.flushSync(H):H()}),de=l._subscribe(Se,()=>{I[W]&&I[W]()}),ue=O._observeRoot(a),pe=D._observe(a);return()=>{x(),de(),ue(),pe()}},[]),M(()=>{const a=l._flushJump();a&&D._fixScrollJump(a)},[ae]),s.useEffect(()=>{h&&h(E,z)},[E,z]),s.useImperativeHandle(b,()=>({get cache(){return l._getCache()}}),[]);const le=we(E,t,A),ce=Ie(z,t,A,y),P=[];for(let a=le;a<=ce;a++){const x=n(a);P.push(e(We,{_resizer:O,_index:a,_offset:l._getItemOffset(a),_hide:l._isUnmeasuredItem(a),_element:S,_children:x,_isHorizontal:R},Re(x,a)))}return e(g,{ref:B,width:R?q:void 0,height:R?void 0:q,scrolling:A!==_e,attrs:s.useMemo(()=>({...v,style:{display:R?"inline-block":"block",width:R?"auto":"100%",height:R?"100%":"auto",...v.style}}),Ce(v)),children:P})});try{f.displayName="WVList",f.__docgenInfo={description:"Virtualized list component controlled by the window scrolling. See {@link WVListProps} and {@link WVListHandle}.",displayName:"WVList",props:{children:{defaultValue:null,description:`Elements rendered by this component.

import{j as e,a as f}from"./jsx-runtime-c3d7f245.js";import{r as o}from"./index-c6dae603.js";import{S as le,d as ce}from"./common-4271bb5e.js";import{f as de,u as ue,A as me,a as he,b as M,r as E,U as pe,c as fe,e as ge,v as ye,V as ve,d as be,g as Se,h as we,i as _e,S as xe,j as Ie,k as Ce}from"./useRerender-d153835b.js";import{u as Re,L as ke}from"./ListItem-2787ef02.js";import{r as Le}from"./index-eb008d06.js";const u=o.forwardRef(({children:r,overscan:s=4,initialItemSize:n,initialItemCount:a,horizontal:i,cache:c,components:{Root:g=ve,Item:m="div"}=be,onScrollStop:b,onRangeChange:S,...p},y)=>{const k=o.useMemo(()=>de(r),[r]),d=k.length,A=Re(b),[l,H,N,v]=ue(()=>{const t=!!i,h=Se(d,n,a,c,!1,!n);return[h,we(h,t),_e(h,t),t]});d!==l._getItemsLength()&&l._update(me,[d]);const O=he(),[L,T]=l._getRange(),V=l._getScrollDirection(),re=l._getJumpCount(),D=l._getTotalSize(),q=o.useRef(null),z=V!==xe;M(()=>{const t=q[E],h=l._subscribe(pe+fe,ae=>{ae?Le.flushSync(O):O()}),w=H._observeRoot(t),ie=N._observe(t);return()=>{h(),w(),ie()}},[]),M(()=>{const t=l._flushJump();t&&N._fixScrollJump(t)},[re]),o.useEffect(()=>{z||A[E]&&A[E]()},[z]),o.useEffect(()=>{S&&S(L,T)},[L,T]),o.useImperativeHandle(y,()=>({get cache(){return l._getCache()}}),[]);const se=Ce(L,s,V),oe=Ie(T,s,V,d),B=[];for(let t=se;t<=oe;t++){const h=k[t],w=h.key;B.push(e(ke,{_resizer:H,_index:t,_offset:l._getItemOffset(t),_hide:l._isUnmeasuredItem(t),_element:m,_children:h,_isHorizontal:v},ge(w)?w:"_"+t))}return e(g,{ref:q,width:v?D:void 0,height:v?void 0:D,scrolling:z,attrs:o.useMemo(()=>({...p,style:{display:v?"inline-block":"block",width:v?"auto":"100%",height:v?"100%":"auto",...p.style}}),ye(p)),children:B})});try{u.displayName="WVList",u.__docgenInfo={description:"Virtualized list component controlled by the window scrolling. See {@link WVListProps} and {@link WVListHandle}.",displayName:"WVList",props:{children:{defaultValue:null,description:"Elements rendered by this component.",name:"children",required:!0,type:{name:"ReactNode"}},overscan:{defaultValue:{value:"4"},description:`Number of items to render above/below the visible bounds of the list. Lower value will have better performance but you can increase to avoid showing blank items in fast scrolling.
...
}`,...(F=(j=_.parameters)==null?void 0:j.docs)==null?void 0:F.source}}};var J,P,Y;x.parameters={...x.parameters,docs:{...(J=x.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: 200
    }}>
...
}`,...(Y=(P=x.parameters)==null?void 0:P.docs)==null?void 0:Y.source}}};var G,K,Z;I.parameters={...I.parameters,docs:{...(G=I.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      display: "flex",
...
}`,...(te=(ne=R.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};const De=["Default","Horizontal","Complex","InfiniteScrolling","ScrollRestoration"];export{I as Complex,_ as Default,x as Horizontal,C as InfiniteScrolling,R as ScrollRestoration,De as __namedExportsOrder,Oe as default};
//# sourceMappingURL=WVList.stories-fb654c6c.js.map

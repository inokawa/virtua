import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{f as n}from"./iframe-D8Mnq5OL.js";import{t as r}from"./react-dom-MfHBsvR7.js";import{t as i}from"./jsx-runtime-DeHZSEgm.js";import{M as a,P as o,_ as s,b as c,c as l,i as u,l as d,m as f,n as p,o as m,r as h,s as g,t as _,u as v,x as y}from"./useLatestRef-46ezEqq8.js";import{a as b,i as x,n as S,o as C,r as w,t as T}from"./useChildren-C27UtZ-h.js";import{n as E,r as D,t as O}from"./common-B5D_Jy0j.js";var k,A,j,M;function N(){return(N=t((()=>{k=n(),o(),C(),y(),f(),d(),g(),h(),_(),x(),A=r(),T(),j=i(),M=(0,k.forwardRef)(({children:e,data:t,bufferSize:n,itemSize:r,shift:i,horizontal:o,cache:d,ssrCount:f,as:h=`div`,item:g=`div`,onScroll:_,onScrollEnd:y},x)=>{h=h;let[C,T]=S(e,t),E=(0,k.useRef)(null),D=p(_),O=p(y),M=(0,k.useRef)(!!f),[N,P,F,I]=u(()=>{let e=!!o,t=b(T,r,d),n=a(t,f);return[n,t,c(n,e),e]});T!==N.$getItemsLength()&&N.$update(5,[T,i]);let[L,R]=(0,k.useReducer)(N.$getStateVersion,void 0,N.$getStateVersion),z=N.$isScrolling(),B=N.$getTotalSize(),V=[];v(()=>(M[l]=!1,N.$subscribe(1,e=>{e?(0,A.flushSync)(R):R()}),N.$subscribe(4,()=>{D.current&&D.current()}),N.$subscribe(8,()=>{O.current&&O.current()}),F.$observe(E[l]),()=>{N.$dispose(),F.$dispose()}),[]),v(()=>{F.$effect()},[L]),(0,k.useImperativeHandle)(x,()=>({get cache(){return P.$snapshot()},get scrollOffset(){return N.$getScrollOffset()},get viewportSize(){return N.$getViewportSize()},findItemIndex:N.$findItemIndex,getItemOffset:N.$getItemOffset,getItemSize:N.$getItemSize,scrollToIndex:(e,t)=>s(F,N,e,t)}),[]);for(let[e,t]=N.$getRange(n);e<=t;e++){let t=C(e);V.push((0,j.jsx)(w,{_resizer:F.$observeItem,_index:e,_offset:N.$getItemOffset(e),_hide:N.$isUnmeasuredItem(e),_as:g,_children:t,_isHorizontal:I,_isSSR:M[l]},m(t,e)))}return(0,j.jsx)(h,{ref:E,style:{contain:`size style`,overflowAnchor:`none`,flex:`none`,position:`relative`,width:I?B:`100%`,height:I?`100%`:B,pointerEvents:z?`none`:void 0},children:V})}),M.__docgenInfo={description:`{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.`,methods:[{name:`cache`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`scrollOffset`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`viewportSize`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`scrollToIndex`,docblock:null,modifiers:[],params:[{name:`index`,optional:!1,type:null},{name:`opts`,optional:!1,type:null}],returns:null}],displayName:`WindowVirtualizer`,props:{children:{required:!0,tsType:{name:`union`,raw:`ReactNode | ((data: T, index: number) => ReactElement)`,elements:[{name:`ReactNode`},{name:`unknown`}]},description:`Elements rendered by this component.
...
}`,...K.parameters?.docs?.source}}}})))()}J();export{V as Complex,z as Default,B as Horizontal,G as IncreasingItems,H as InfiniteScrolling,W as ScrollRestoration,K as ScrollTo,q as __namedExportsOrder,R as default};
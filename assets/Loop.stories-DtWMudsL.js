import{j as l}from"./jsx-runtime-u17CrQMm.js";import{a as t}from"./iframe-Bs9Z1BeY.js";import{r as a}from"./common-C_ovhmAN.js";import{V as T}from"./VList-BNGv5XfX.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-VWeeFjt1.js";import"./useLatestRef-DshNHEGi.js";import"./useChildren-DXMl-6UY.js";import"./index-C20cnVtU.js";import"./index-Bb5tyYUU.js";const x={component:T},c={name:"Loop",render:()=>{const m=t.useRef(0),f=()=>({id:m.current++}),u=e=>a(e,f),n=t.useRef(null),[p,o]=t.useState(()=>u(200)),i=t.useRef(-1),s=t.useRef(!1);return t.useLayoutEffect(()=>{n.current?.scrollToIndex(200/2)},[]),l.jsx(T,{ref:n,style:{flex:1},shift:s.current,onScroll:e=>{if(s.current=e-i.current<0,i.current=e,!n.current)return;const d=s.current;e<100?(o(r=>[...u(200/4),...r]),setTimeout(()=>{s.current=!d,o(r=>[...r.slice(0,600/4)])},50)):n.current.scrollSize-n.current.viewportSize-e<100&&(o(r=>[...r,...u(200/4)]),setTimeout(()=>{s.current=!d,o(r=>[...r.slice(200/4)])},50))},children:p.map(e=>l.jsx("div",{style:{height:100,backgroundColor:e.id%100===0?"darkgray":e.id%10===0?"smokegray":"white",borderBottom:"solid 1px #ccc"},children:e.id},e.id))})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  name: "Loop",
  render: () => {

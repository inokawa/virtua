import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as c}from"./iframe-6KVf9xvT.js";import{u as ie,A,g as E,a as D,b as G,r as v,U as Z,c as ae,d as de,e as q,f as ce,h as ue,i as me}from"./useLatestRef-B_qyb_Om.js";import{r as P}from"./index-BP5iqN4X.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Db-AAs5E.js";function he(...t){return c.useCallback(n=>{for(const a of t)a&&pe(a,n)},t)}function pe(t,n){typeof t=="function"?t(n):t&&(t.current=n)}const V=(t,n)=>`${t}-${n}`,fe=c.memo(({_children:t,_resizer:n,_rowIndex:a,_colIndex:h,_top:b,_left:p,_height:l,_width:d,_hide:u,_element:m})=>{const g=c.useRef(null);return G(()=>n.$observeItem(g[v],a,h),[h,a]),e.jsx(m,{ref:g,style:c.useMemo(()=>({contain:"layout style",display:"grid",position:"absolute",top:b,[me()?"right":"left"]:p,visibility:u?"hidden":"visible",minHeight:l,minWidth:d}),[b,p,d,l,u]),children:t})}),w=c.forwardRef(({children:t,row:n,col:a,cellHeight:h=40,cellWidth:b=100,bufferSize:p,initialRowCount:l,initialColCount:d,item:u="div",domRef:m,innerDomRef:g,onScroll:f,onScrollEnd:y,style:U,...B},F)=>{const[s,i,I,x]=ie(()=>{const r=q(n,h,l),o=q(a,b,d);return[r,o,ce(r,o),ue(r,o)]});n!==s.$getItemsLength()&&s.$update(A,[n]),a!==i.$getItemsLength()&&i.$update(A,[a]);const[X,N]=c.useReducer(s.$getStateVersion,void 0,s.$getStateVersion),[J,M]=c.useReducer(i.$getStateVersion,void 0,i.$getStateVersion),K=s.$isScrolling(),Y=i.$isScrolling(),Q=E(s),ee=E(i),_=c.useRef(null),L=D(f),O=D(y);G(()=>{const r=_[v],o=s.$subscribe(Z,j=>{j?P.flushSync(N):N()}),S=i.$subscribe(Z,j=>{j?P.flushSync(M):M()}),R=s.$subscribe(ae,()=>{L[v]&&L[v](s.$getScrollOffset())}),le=s.$subscribe(de,()=>{O[v]&&O[v]()});return I.$observeRoot(r),x.$observe(r),()=>{o(),S(),I.$dispose(),x.$dispose(),R(),le()}},[]),G(()=>{x.$fixScrollJump()},[X,J]),c.useImperativeHandle(F,()=>({get scrollTop(){return s.$getScrollOffset()},get scrollLeft(){return i.$getScrollOffset()},get scrollHeight(){return E(s)},get scrollWidth(){return E(i)},get viewportHeight(){return s.$getViewportSize()},get viewportWidth(){return i.$getViewportSize()},findStartIndex:()=>[i.$findStartIndex(),s.$findStartIndex()],findEndIndex:()=>[i.$findEndIndex(),s.$findEndIndex()],getItemOffset:(r,o)=>[i.$getItemOffset(r),s.$getItemOffset(o)],getItemSize:(r,o)=>[i.$getItemSize(r),s.$getItemSize(o)],resizeCols(r){I.$resizeCols(r)},resizeRows(r){I.$resizeRows(r)},scrollToIndex:x.$scrollToIndex,scrollTo:x.$scrollTo,scrollBy:x.$scrollBy}),[]);const ne=c.useMemo(()=>{const r=new Map;return(o,S)=>{let R=r.get(V(o,S));return R||r.set(V(o,S),R=t({rowIndex:o,colIndex:S})),R}},[t]),[te,re]=s.$getRange(p),[oe,se]=i.$getRange(p),W=[];for(let r=te;r<=re;r++)for(let o=oe;o<=se;o++)W.push(e.jsx(fe,{_resizer:I,_rowIndex:r,_colIndex:o,_top:s.$getItemOffset(r),_left:i.$getItemOffset(o),_height:s.$getItemSize(r),_width:i.$getItemSize(o),_hide:s.$isUnmeasuredItem(r)||i.$isUnmeasuredItem(o),_element:u,_children:ne(r,o)},V(r,o)));return e.jsx("div",{ref:he(_,m),...B,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",...U},children:e.jsx("div",{ref:g,style:{contain:"size paint style",overflowAnchor:"none",overflow:"clip",flex:"none",position:"relative",width:ee,height:Q,pointerEvents:K||Y?"none":void 0},children:W})})});w.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",methods:[{name:"scrollTop",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollLeft",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"scrollWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportHeight",docblock:null,modifiers:["get"],params:[],returns:null},{name:"viewportWidth",docblock:null,modifiers:["get"],params:[],returns:null},{name:"findStartIndex",docblock:null,modifiers:[],params:[],returns:null},{name:"findEndIndex",docblock:null,modifiers:[],params:[],returns:null},{name:"getItemOffset",docblock:null,modifiers:[],params:[{name:"indexX",optional:!1,type:null},{name:"indexY",optional:!1,type:null}],returns:null},{name:"getItemSize",docblock:null,modifiers:[],params:[{name:"indexX",optional:!1,type:null},{name:"indexY",optional:!1,type:null}],returns:null},{name:"resizeCols",docblock:null,modifiers:[],params:[{name:"cols",optional:!1,type:null}],returns:null},{name:"resizeRows",docblock:null,modifiers:[],params:[{name:"rows",optional:!1,type:null}],returns:null}],displayName:"VGrid",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(arg: {
  /**
   * row index of cell
   */
  rowIndex: number;
...
@defaultValue "div"`,defaultValue:{value:'"div"',computed:!1}},domRef:{required:!1,tsType:{name:"Ref",elements:[{name:"HTMLDivElement"}],raw:"Ref<HTMLDivElement>"},description:"Reference to the rendered DOM element (the one that scrolls)."},innerDomRef:{required:!1,tsType:{name:"Ref",elements:[{name:"HTMLDivElement"}],raw:"Ref<HTMLDivElement>"},description:"Reference to the inner rendered DOM element (the one that contains all the cells)."},onScroll:{required:!1,tsType:{name:"signature",type:"function",raw:"(offset: number) => void",signature:{arguments:[{type:{name:"number"},name:"offset"}],return:{name:"void"}}},description:"Callback invoked whenever scroll offset changes."},onScrollEnd:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback invoked when scrolling stops."}}};const Ie={component:w},T={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:n})=>e.jsxs("div",{style:{border:"solid 1px gray",background:"white",padding:4},children:[t," / ",n]})})},C={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:n})=>e.jsxs("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(n%2+1)*100,height:(t%2+1)*100},children:[t," / ",n]})})},H={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:n})=>e.jsxs("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(n%2+1)*100},children:[e.jsxs("div",{children:[t," / ",n]}),Array.from({length:t%8+1},()=>e.jsx("div",{children:"Hello world!"}))]})})},k={render:()=>e.jsx(w,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:n})=>e.jsxs("div",{style:{border:"solid 1px gray",background:"white",padding:4,height:(t%2+1)*100},children:[e.jsxs("div",{children:[t," / ",n]}),e.jsx("div",{children:Array.from({length:n%4+1},()=>e.jsx("span",{children:"Hello world!"}))})]})})},z={render:()=>{const[a,h]=c.useState(()=>new Map),[b,p]=c.useState(()=>new Map),l=c.useRef(null);function d(){const u=()=>Math.random()<.8?40+Math.round(200*Math.random()):80,m=new Map,g=new Map;for(let f=1;f<100;f++)m.set(f,u()),g.set(f,u());l.current?.resizeCols([...m.entries()]),l.current?.resizeRows([...g.entries()]),h(m),p(g)}return e.jsx(w,{ref:l,style:{height:"100vh"},row:100,col:100,cellHeight:80,cellWidth:80,children:({rowIndex:u,colIndex:m})=>e.jsxs("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:a.get(m)??80,height:b.get(u)??80},children:[e.jsxs("div",{children:[u," / ",m]}),m===0&&u===0?e.jsx("button",{onClick:d,children:"random"}):u===0?e.jsx("input",{type:"number",step:5,value:a.get(m)??80,style:{width:50},onChange:g=>{const f=g.target.valueAsNumber;l.current?.resizeCols([[m,f]]),h(y=>new Map(y).set(m,f))}}):m===0?e.jsx("input",{type:"number",step:5,value:b.get(u)??80,style:{width:50},onChange:g=>{const f=g.target.valueAsNumber;l.current?.resizeRows([[u,f]]),p(y=>new Map(y).set(u,f))}}):null]})})}},$={render:()=>{const[n,a]=c.useState([567,567]),[h,b]=c.useState([1e3,1e3]),p=c.useRef(null);return e.jsxs("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[e.jsxs("div",{children:[e.jsxs("label",{children:["col",e.jsx("input",{type:"number",value:n[0],onChange:l=>{a(d=>[Number(l.target.value),d[1]])}})]}),e.jsxs("label",{children:["row",e.jsx("input",{type:"number",value:n[1],onChange:l=>{a(d=>[d[0],Number(l.target.value)])}})]}),e.jsx("button",{onClick:()=>{p.current?.scrollToIndex(n[0],n[1])},children:"scroll to index"}),e.jsx("button",{onClick:()=>{a([Math.round(1e3*Math.random()),Math.round(1e3*Math.random())])},children:"randomize"})]}),e.jsx("div",{children:e.jsxs("div",{children:[e.jsxs("label",{children:["x",e.jsx("input",{type:"number",value:h[0],onChange:l=>{b(d=>[Number(l.target.value),d[1]])}})]}),e.jsxs("label",{children:["y",e.jsx("input",{type:"number",value:h[1],onChange:l=>{b(d=>[d[0],Number(l.target.value)])}})]}),e.jsx("button",{onClick:()=>{p.current?.scrollTo(h[0],h[1])},children:"scroll to offset"}),e.jsx("button",{onClick:()=>{p.current?.scrollBy(h[0],h[1])},children:"scroll by offset"})]})}),e.jsx(w,{ref:p,style:{height:"100vh"},row:1e3,col:1e3,children:({rowIndex:l,colIndex:d})=>e.jsxs("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:160,height:80},children:[l," / ",d]})})]})}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
}`,...$.parameters?.docs?.source}}};const Se=["Default","Fixed","DynamicHeight","DynamicWidth","Resizeable","ScrollTo"];export{T as Default,H as DynamicHeight,k as DynamicWidth,C as Fixed,z as Resizeable,$ as ScrollTo,Se as __namedExportsOrder,Ie as default};

import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{f as n}from"./iframe-Dciai4-q.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{n as i,t as a}from"./Virtualizer-B1AY3mTB.js";import{n as o,t as s}from"./en-DltMjSLJ.js";import{n as c,r as l}from"./common-LyHEjQi-.js";var u,d,f,p,m,h,g,_,v;function y(){return(y=t((()=>{i(),u=e(n(),1),s(),l(),d=r(),f={component:a},p={border:`solid 1px #ccc`,background:`#fff`,margin:10,padding:10,borderRadius:8,whiteSpace:`pre-wrap`},m=48,h=({visible:e})=>(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(`div`,{style:{flex:`none`,visibility:e?`visible`:`hidden`,height:m,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,d.jsx)(`span`,{className:`loader`})}),(0,d.jsx)(`style`,{children:`
      .loader {
        width: 24px;
        height: 24px;
        border-radius: 50%;

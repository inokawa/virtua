import{a as o,j as a}from"./jsx-runtime-sgeEVxPu.js";import{r as m}from"./index-yp3VsGQP.js";import{u as T,r as ie,i as Se,a as Ce,A as D,b as Ve,U as M,c as A,d as q,e as j,S as J,v as Te,V as Ge,f as Re,g as U,h as Ee,j as B}from"./useRerender-NAuSx9YU.js";import{r as He}from"./index-8dy-jdxy.js";const H=(l,r)=>`${l}-${r}`,Ne=m.memo(({_children:l,_resizer:r,_rowIndex:u,_colIndex:h,_top:f,_left:c,_height:t,_width:i,_hide:x,_element:G})=>{const g=m.useRef(null);return T(()=>r._observeItem(g[ie],u,h),[h,u]),o(G,{ref:g,style:m.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:f,[Se()?"right":"left"]:c,visibility:x?"hidden":"visible",minHeight:t,minWidth:i}),[f,c,i,t,x]),children:l})}),p=m.forwardRef(({children:l,row:r,col:u,cellHeight:h=40,cellWidth:f=100,overscan:c=2,initialRowCount:t,initialColCount:i,components:{Root:x=Ge,Cell:G="div"}=Re,...g},N)=>{const[s,d,k,b,v]=Ce(()=>{const e=U(r,h,t),n=U(u,f,i);return[e,n,Ee(e,n),B(e,!1),B(n,!0)]});r!==s._getItemsLength()&&s._update(D,[r]),u!==d._getItemsLength()&&d._update(D,[u]);const z=Ve(),[se,de]=s._getRange(),[ae,ce]=d._getRange(),R=s._getScrollDirection(),E=d._getScrollDirection(),ue=s._getJumpCount(),he=d._getJumpCount(),me=s._getScrollSize(),pe=d._getScrollSize(),O=m.useRef(null);T(()=>{const e=O[ie],n=Ie=>{Ie?He.flushSync(z):z()},y=s._subscribe(M+A,n),_=d._subscribe(M+A,n),_e=k._observeRoot(e),xe=b._observe(e),we=v._observe(e);return()=>{y(),_(),_e(),xe(),we()}},[]),T(()=>{const e=s._flushJump();e&&b._fixScrollJump(e)},[ue]),T(()=>{const e=d._flushJump();e&&v._fixScrollJump(e)},[he]),m.useImperativeHandle(N,()=>({get scrollOffset(){return[d._getScrollOffset(),s._getScrollOffset()]},get scrollSize(){return[d._getScrollSize(),s._getScrollSize()]},get viewportSize(){return[d._getViewportSize(),s._getViewportSize()]},scrollToIndex(e,n){v._scrollToIndex(e),b._scrollToIndex(n)},scrollTo(e,n){v._scrollTo(e),b._scrollTo(n)},scrollBy(e,n){v._scrollBy(e),b._scrollBy(n)}}),[]);const fe=m.useMemo(()=>{const e=new Map;return(n,y)=>{let _=e.get(H(n,y));return _||e.set(H(n,y),_=l({rowIndex:n,colIndex:y})),_}},[l]),ge=q(se,c,R),be=j(de,c,R,r),ve=q(ae,c,E),ye=j(ce,c,E,u),L=[];for(let e=ge;e<=be;e++)for(let n=ve;n<=ye;n++)L.push(o(Ne,{_resizer:k,_rowIndex:e,_colIndex:n,_top:s._getItemOffset(e),_left:d._getItemOffset(n),_height:s._getItemSize(e),_width:d._getItemSize(n),_hide:s._isUnmeasuredItem(e)||d._isUnmeasuredItem(n),_element:G,_children:fe(e,n)},H(e,n)));return o(x,{ref:O,width:pe,height:me,scrolling:R!==J||E!==J,attrs:m.useMemo(()=>({...g,style:{overflow:"auto",overflowAnchor:"none",contain:"strict",width:"100%",height:"100%",...g.style}}),Te(g)),children:L})});try{p.displayName="VGrid",p.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
}`,...(le=(oe=V.parameters)==null?void 0:oe.docs)==null?void 0:le.source}}};const Me=["Default","Fixed","DynamicHeight","DynamicWidth","ScrollTo"];export{w as Default,S as DynamicHeight,C as DynamicWidth,I as Fixed,V as ScrollTo,Me as __namedExportsOrder,De as default};

...
@defaultValue "div"`,name:"cellElement",required:!1,type:{name:"CustomCellComponentOrElement"}}}}}catch{}const ke={component:_},G={render:()=>t(_,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>f("div",{style:{border:"solid 1px gray",background:"white",padding:4},children:[n," / ",e]})})},O={render:()=>t(_,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>f("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100,height:(n%2+1)*100},children:[n," / ",e]})})},T={render:()=>t(_,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>f("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100},children:[f("div",{children:[n," / ",e]}),Array.from({length:n%8+1},()=>t("div",{children:"Hello world!"}))]})})},H={render:()=>t(_,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:n,colIndex:e})=>f("div",{style:{border:"solid 1px gray",background:"white",padding:4,height:(n%2+1)*100},children:[f("div",{children:[n," / ",e]}),t("div",{children:Array.from({length:e%4+1},()=>t("span",{children:"Hello world!"}))})]})})},k={render:()=>t(_,{style:{height:"100vh",direction:"rtl"},row:1e3,col:500,rtl:!0,children:({rowIndex:n,colIndex:e})=>f("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:100},children:[n," / ",e]})})},z={render:()=>{const[l,s]=u.useState([567,567]),[d,a]=u.useState([1e3,1e3]),m=u.useRef(null);return f("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[f("div",{children:[t("input",{type:"number",value:l[0],onChange:r=>{s(c=>[Number(r.target.value),c[1]])}}),t("input",{type:"number",value:l[1],onChange:r=>{s(c=>[c[0],Number(r.target.value)])}}),t("button",{onClick:()=>{var r;(r=m.current)==null||r.scrollToIndex(l[0],l[1])},children:"scroll to index"}),t("button",{onClick:()=>{s([Math.round(1e3*Math.random()),Math.round(1e3*Math.random())])},children:"randomize"})]}),t("div",{children:f("div",{children:[t("input",{type:"number",value:d[0],onChange:r=>{a(c=>[Number(r.target.value),c[1]])}}),t("input",{type:"number",value:d[1],onChange:r=>{a(c=>[c[0],Number(r.target.value)])}}),t("button",{onClick:()=>{var r;(r=m.current)==null||r.scrollTo(d[0],d[1])},children:"scroll to offset"}),t("button",{onClick:()=>{var r;(r=m.current)==null||r.scrollBy(d[0],d[1])},children:"scroll by offset"})]})}),t(_,{ref:m,style:{height:"100vh"},row:1e3,col:1e3,children:({rowIndex:r,colIndex:c})=>f("div",{style:{border:"solid 1px gray",background:"white",padding:4},children:[r," / ",c]})})]})}};var Z,ee,ne;G.parameters={...G.parameters,docs:{...(Z=G.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
}`,...(me=(he=k.parameters)==null?void 0:he.docs)==null?void 0:me.source}}};var pe,fe,ge;z.parameters={...z.parameters,docs:{...(pe=z.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  render: () => {
...
}`,...(ge=(fe=z.parameters)==null?void 0:fe.docs)==null?void 0:ge.source}}};const ze=["Default","Fixed","DynamicHeight","DynamicWidth","Rtl","ScrollTo"];export{G as Default,T as DynamicHeight,H as DynamicWidth,O as Fixed,k as Rtl,z as ScrollTo,ze as __namedExportsOrder,ke as default};
//# sourceMappingURL=VGrid.stories-6bbb5bdb.js.map

import{j as l}from"./jsx-runtime-BjG_zV1W.js";import{r as t}from"./iframe-TMlQV0rA.js";import{r as _}from"./common-BuJuiJCc.js";import{V as f}from"./VList-BT4-BJbN.js";import"./preload-helper-BQ24v_F8.js";import"./Virtualizer-tq6Nr31n.js";import"./useLatestRef-DVnat-hk.js";import"./useChildren-C5_-4RWu.js";import"./index-BtxpcH-d.js";const F={component:f},c={name:"Loop",render:()=>{const a=t.useRef(0),L=()=>({id:a.current++}),u=e=>_(e,L),s=t.useRef(null),[O,o]=t.useState(()=>u(200)),i=t.useRef(-1),n=t.useRef(!1);return t.useLayoutEffect(()=>{var e;(e=s.current)==null||e.scrollToIndex(200/2)},[]),l.jsx(f,{ref:s,style:{flex:1},shift:n.current,onScroll:e=>{if(n.current=e-i.current<0,i.current=e,!!s.current){if(e<100){const d=n.current;o(r=>[...u(200/4),...r]),setTimeout(()=>{n.current=!d,o(r=>[...r.slice(0,200*3/4)])})}else if(s.current.scrollSize-s.current.viewportSize-e<100){const d=n.current;o(r=>[...r,...u(200/4)]),setTimeout(()=>{n.current=!d,o(r=>[...r.slice(200/4)])})}}},children:O.map(e=>l.jsx("div",{style:{height:100,backgroundColor:e.id%100===0?"darkgray":e.id%10===0?"smokegray":"white",borderBottom:"solid 1px #ccc"},children:e.id},e.id))})}};var T,p,m;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: "Loop",
  render: () => {
...
}`,...(m=(p=c.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};const g=["Default"];export{c as Default,g as __namedExportsOrder,F as default};

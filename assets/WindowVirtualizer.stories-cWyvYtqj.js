import{a as e,j as a}from"./jsx-runtime-sgeEVxPu.js";import{r as i}from"./index-yp3VsGQP.js";import{S as ce,d as ue}from"./common-4ZgZpLnL.js";import{a as pe,A as me,b as he,u as M,r as C,U as fe,c as ge,l as ye,o as ve,d as be,n as we,S as xe,e as Se,s as Ie,t as _e}from"./useRerender-T4aaHfbF.js";import{u as Re,a as Ce,L as ke}from"./useChildren-5xHNz0Fd.js";import{r as ze}from"./index-8dy-jdxy.js";const g=i.forwardRef(({children:o,count:s,overscan:t=4,itemSize:l,shift:r,horizontal:m,cache:d,ssrCount:u,as:h="div",item:v="div",onScrollEnd:b,onRangeChange:f},S)=>{h=h;const[y,n]=Re(o,s),w=i.useRef(null),I=Ce(b),_=i.useRef(!!u),[p,A,W,N]=pe(()=>{const c=!!m,x=Se(n,l,u,d,!l);return[x,Ie(x,c),_e(x,c),c]});n!==p._getItemsLength()&&p._update(me,[n,r]);const B=he(p),[D,O]=p._getRange(),H=p._getScrollDirection(),le=p._getJumpCount(),P=p._getTotalSize(),U=[];M(()=>{_[C]=!1;const c=p._subscribe(fe+ge,de=>{de?ze.flushSync(B):B()}),x=p._subscribe(ye,()=>{I[C]&&I[C]()}),R=w[C];return A._observeRoot(R),W._observe(R),()=>{c(),x(),A._dispose(),W._dispose()}},[]),M(()=>{W._fixScrollJump()},[le]),i.useEffect(()=>{f&&f(D,O)},[D,O]),i.useImperativeHandle(S,()=>({get cache(){return p._getCacheSnapshot()}}),[]);for(let c=ve(D,t,H),x=be(O,t,H,n);c<=x;c++){const R=y(c);U.push(e(ke,{_resizer:A._observeItem,_index:c,_offset:p._getItemOffset(c),_hide:p._isUnmeasuredItem(c),_element:v,_children:R,_isHorizontal:N,_isSSR:_[C]},we(R,c)))}return e(h,{ref:w,style:{flex:"none",position:"relative",visibility:"hidden",width:N?P:"100%",height:N?"100%":P,pointerEvents:H!==xe?"none":"auto"},children:U})});try{g.displayName="WindowVirtualizer",g.__docgenInfo={description:"{@link Virtualizer } controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizer}.",displayName:"WindowVirtualizer",props:{children:{defaultValue:null,description:`Elements rendered by this component.
...
@defaultValue "div"`,name:"item",required:!1,type:{name:"keyof IntrinsicElements | CustomItemComponent"}},onScrollEnd:{defaultValue:null,description:"Callback invoked when scrolling stops.",name:"onScrollEnd",required:!1,type:{name:"(() => void)"}},onRangeChange:{defaultValue:null,description:"Callback invoked when visible items range changes.",name:"onRangeChange",required:!1,type:{name:"((startIndex: number, endIndex: number) => void)"}}}}}catch{}const q=o=>{const s=[20,40,80,77];return Array.from({length:o}).map((t,l)=>e("div",{style:{height:s[l%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:l},l))},Ve=o=>Array.from({length:o}).map((s,t)=>a("div",{style:{width:t%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",t]},t)),Oe={component:g},k={render:()=>e("div",{style:{padding:"200px 100px"},children:e("div",{style:{border:"solid 1px gray"},children:e(g,{children:q(1e3)})})})},z={render:()=>e("div",{style:{padding:"100px 200px"},children:e("div",{style:{display:"inline-block",border:"solid 1px gray",height:400},children:e(g,{horizontal:!0,children:Ve(1e3)})})})},V={render:()=>a("div",{style:{display:"flex",flexDirection:"column"},children:[e("div",{style:{background:"white",height:60,marginBottom:40},children:"header"}),a("div",{style:{display:"flex",flexDirection:"row"},children:[e("div",{style:{flex:1,display:"flex",paddingTop:600,margin:10},children:e(g,{children:q(1e3)})}),e("div",{style:{flex:3,margin:10},children:e(g,{children:Array.from({length:1e3}).map((o,s)=>e("div",{style:{height:200,borderRadius:8,margin:16,background:"#fff"},children:s},s))})}),e("div",{style:{flex:2,padding:20,paddingTop:300},children:e("div",{style:{top:0,height:400,position:"sticky",background:"white"}})})]}),e("div",{style:{background:"white",height:60,marginTop:40},children:"footer"})]})},E={render:()=>{const o=(v,b=0)=>{const f=[20,40,80,77];return Array.from({length:v}).map((S,y)=>(y+=b,e("div",{style:{height:f[y%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:y},y)))},[s,t]=i.useState(!1),l=async()=>{t(!0),await ue(1e3),t(!1)},r=100,[m,d]=i.useState(()=>o(r)),u=i.useRef(-1),h=m.length;return e("div",{style:{padding:"200px 100px 0px 100px"},children:a(g,{onRangeChange:async(v,b)=>{b+50>h&&u.current<h&&(u.current=h,await l(),d(f=>[...f,...o(r,f.length)]))},children:[m,s&&e(ce,{})]})})}},Ee=({id:o})=>{const s="window-list-cache-"+o,t=i.useRef(null),[l,r]=i.useMemo(()=>{const m=sessionStorage.getItem(s);if(!m)return[];try{return JSON.parse(m)}catch{return[]}},[]);return i.useLayoutEffect(()=>{if(!t.current)return;const m=t.current;window.scrollTo(0,l??0);let d=0;const u=()=>{d=window.scrollY};return window.addEventListener("scroll",u),u(),()=>{window.removeEventListener("scroll",u),sessionStorage.setItem(s,JSON.stringify([d,m.cache]))}},[]),e(g,{ref:t,cache:r,children:q(1e3)})},T={render:()=>{const[o,s]=i.useState(!0),[t,l]=i.useState("1");return a("div",{style:{position:"relative"},children:[a("div",{style:{position:"fixed",top:0,left:0,zIndex:10},children:[e("button",{onClick:()=>{s(r=>!r)},children:o?"hide":"show"}),["1","2","3"].map(r=>a("label",{children:[e("input",{type:"radio",checked:t===r,onChange:()=>{l(r)}}),r]},r))]}),o&&e(Ee,{id:t},t)]})}},L={render:()=>{const o=i.useRef(0),s=(n,w)=>Array.from({length:n}).map((I,_)=>(_+=w,{id:o.current++,index:_})),[t,l]=i.useState(!1),[r,m]=i.useState(4),[d,u]=i.useState(!1),[h,v]=i.useState(!0),[b,f]=i.useState(()=>s(r,0)),S=()=>{f(h?n=>{var w,I;return d?[...s(r,(((w=n[0])==null?void 0:w.index)??0)-r),...n]:[...n,...s(r,(((I=n[n.length-1])==null?void 0:I.index)??0)+1)]}:d?n=>n.slice(r):n=>n.slice(0,-r))};i.useEffect(()=>{if(!t)return;const n=setInterval(S,500);return()=>{clearInterval(n)}},[S,t]);const y=[20,40,80,77];return a("div",{style:{display:"flex",flexDirection:"column"},children:[a("div",{style:{position:"fixed",width:"100%",top:0,zIndex:1,backdropFilter:"blur(1px)"},children:[a("div",{children:[a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:!d,onChange:()=>{u(!1)}}),"append"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:d,onChange:()=>{u(!0)}}),"prepend"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:h,onChange:()=>{v(!0)}}),"increase"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:!h,onChange:()=>{v(!1)}}),"decrease"]}),e("input",{style:{marginLeft:4},value:r,type:"number",min:1,max:1e4,step:1,onChange:n=>{m(Number(n.target.value))}})]}),a("div",{children:[a("label",{style:{marginRight:16},children:[e("input",{type:"checkbox",style:{marginLeft:4},checked:t,onChange:()=>{l(n=>!n)}}),"auto"]}),e("button",{onClick:()=>{S()},children:"update"})]})]}),e("div",{style:{flex:1},children:e(g,{shift:d,children:b.map(n=>e("div",{style:{height:y[Math.abs(n.index)%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n.index},n.id))})})]})}};var j,F,J;k.parameters={...k.parameters,docs:{...(j=k.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: "200px 100px"
    }}>
...
}`,...(ae=(oe=L.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};const He=["Default","Horizontal","Complex","InfiniteScrolling","ScrollRestoration","IncreasingItems"];export{V as Complex,k as Default,z as Horizontal,L as IncreasingItems,E as InfiniteScrolling,T as ScrollRestoration,He as __namedExportsOrder,Oe as default};

import{a as l,j as a}from"./jsx-runtime-e162df28.js";import{r as u}from"./index-5284b0bf.js";import{b as f,c as O,r as he,a as Se,v as Ce,W as Ve,d as P,j as Ge,h as B,m as F,i as K}from"./Window-1e9c3c4d.js";import"./index-480187bb.js";const E=(t,e)=>`${t}-${e}`,Te=u.memo(({_children:t,_resizer:e,_vStore:c,_hStore:i,_rowIndex:g,_colIndex:s,_element:r,_isRtl:h})=>{const _=u.useRef(null),I=f(c,()=>c._getItemOffset(g),!0),S=f(i,()=>i._getItemOffset(s),!0),b=f(c,()=>c._isUnmeasuredItem(g),!0),C=f(i,()=>i._isUnmeasuredItem(s),!0),V=f(c,()=>c._getItemSize(g),!0),G=f(i,()=>i._getItemSize(s),!0);return O(()=>e._observeItem(_[he],g,s),[s,g]),l(r,{ref:_,style:u.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:I,[h?"right":"left"]:S,visibility:b||C?"hidden":"visible",minHeight:V,minWidth:G}),[I,S,G,V,b,C]),children:t})}),y=u.forwardRef(({children:t,row:e,col:c,cellHeight:i=40,cellWidth:g=100,overscan:s=2,initialRowCount:r,initialColCount:h,rtl:_,element:I=Ve,cellElement:S="div",...b},C)=>{const[V,G]=u.useState(!1),[M,me]=u.useState(!1),[m,p,W,w,x,pe]=Se(()=>{const n=!!_,o=()=>{},d=P(e,i,r,!1,G,o),v=P(c,g,h,!1,me,o);return[d,v,Ge(d,v),B(d,!1,n),B(v,!0,n),n]});m._updateCacheLength(e),p._updateCacheLength(c);const[fe,ge]=f(m,m._getRange),[ve,ye]=f(p,p._getRange),be=f(m,m._getJumpCount),we=f(p,p._getJumpCount),xe=f(m,m._getCorrectedScrollSize,!0),_e=f(p,p._getCorrectedScrollSize,!0),L=u.useRef(null);O(()=>{const n=L[he],o=W._observeRoot(n),d=w._initRoot(n),v=x._initRoot(n);return()=>{o(),d(),v()}},[]),O(()=>{const n=m._flushJump();n&&w._fixScrollJump(n)},[be]),O(()=>{const n=p._flushJump();n&&x._fixScrollJump(n)},[we]),u.useImperativeHandle(C,()=>({get scrollOffset(){return[p._getScrollOffset(),m._getScrollOffset()]},get scrollSize(){return[x._getActualScrollSize(),w._getActualScrollSize()]},get viewportSize(){return[p._getViewportSize(),m._getViewportSize()]},scrollToIndex(n,o){x._scrollToIndex(n),w._scrollToIndex(o)},scrollTo(n,o){x._scrollTo(n),w._scrollTo(o)},scrollBy(n,o){x._scrollTo(p._getScrollOffset()+n),w._scrollTo(m._getScrollOffset()+o)}}),[]);const q=u.useMemo(()=>{const n=new Map;return(o,d)=>{let v=n.get(E(o,d));return v||n.set(E(o,d),v=t({rowIndex:o,colIndex:d})),v}},[t]),j=F(fe-s,0),D=K(ge+s,e-1),J=F(ve-s,0),A=K(ye+s,c-1),Ie=u.useMemo(()=>{const n=[];for(let o=j;o<=D;o++)for(let d=J;d<=A;d++)n.push(l(Te,{_resizer:W,_vStore:m,_hStore:p,_rowIndex:o,_colIndex:d,_element:S,_children:q(o,d),_isRtl:pe},E(o,d)));return n},[q,j,D,J,A]);return l(I,{ref:L,width:_e,height:xe,scrolling:V||M,attrs:u.useMemo(()=>({...b,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",padding:0,margin:0,...b.style}}),Ce(b)),children:Ie})});try{y.displayName="VGrid",y.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
@defaultValue "div"`,name:"cellElement",required:!1,type:{name:"CustomCellComponentOrElement"}}}}}catch{}const Ne={component:y},T={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>a("div",{style:{border:"solid 1px gray",background:"white",padding:4},children:[t," / ",e]})})},R={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>a("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100,height:(t%2+1)*100},children:[t," / ",e]})})},k={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>a("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100},children:[a("div",{children:[t," / ",e]}),Array.from({length:t%8+1},()=>l("div",{children:"Hello world!"}))]})})},z={render:()=>l(y,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>a("div",{style:{border:"solid 1px gray",background:"white",padding:4,height:(t%2+1)*100},children:[a("div",{children:[t," / ",e]}),l("div",{children:Array.from({length:e%4+1},()=>l("span",{children:"Hello world!"}))})]})})},H={render:()=>l(y,{style:{height:"100vh",direction:"rtl"},row:1e3,col:500,rtl:!0,children:({rowIndex:t,colIndex:e})=>a("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:100},children:[t," / ",e]})})},N={render:()=>{const[e,c]=u.useState([567,567]),[i,g]=u.useState([1e3,1e3]),s=u.useRef(null);return a("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[a("div",{children:[a("label",{children:["col",l("input",{type:"number",value:e[0],onChange:r=>{c(h=>[Number(r.target.value),h[1]])}})]}),a("label",{children:["row",l("input",{type:"number",value:e[1],onChange:r=>{c(h=>[h[0],Number(r.target.value)])}})]}),l("button",{onClick:()=>{var r;(r=s.current)==null||r.scrollToIndex(e[0],e[1])},children:"scroll to index"}),l("button",{onClick:()=>{c([Math.round(1e3*Math.random()),Math.round(1e3*Math.random())])},children:"randomize"})]}),l("div",{children:a("div",{children:[a("label",{children:["x",l("input",{type:"number",value:i[0],onChange:r=>{g(h=>[Number(r.target.value),h[1]])}})]}),a("label",{children:["y",l("input",{type:"number",value:i[1],onChange:r=>{g(h=>[h[0],Number(r.target.value)])}})]}),l("button",{onClick:()=>{var r;(r=s.current)==null||r.scrollTo(i[0],i[1])},children:"scroll to offset"}),l("button",{onClick:()=>{var r;(r=s.current)==null||r.scrollBy(i[0],i[1])},children:"scroll by offset"})]})}),l(y,{ref:s,style:{height:"100vh"},row:1e3,col:1e3,children:({rowIndex:r,colIndex:h})=>a("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:160,height:80},children:[r," / ",h]})})]})}};var U,Y,$;T.parameters={...T.parameters,docs:{...(U=T.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
//# sourceMappingURL=VGrid.stories-c8c05540.js.map

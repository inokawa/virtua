import{a as r,j as e,F as R}from"./jsx-runtime-f8a6c6ea.js";import{r as n}from"./index-5284b0bf.js";import{f as d}from"./index-4a193f06.js";import{V as S}from"./VList-dfe3e697.js";import"./DefaultWindow-98d699cf.js";import"./index-480187bb.js";const D={component:S},v=i=>r(R,{children:[e("div",{style:{height:100,display:i.hidden?"none":"flex",alignItems:"center",justifyContent:"center",background:"white"},children:e("span",{className:"loader"})}),e("style",{children:`
      .loader {
        width: 48px;
        height: 48px;
        border-radius: 50%;
      ...
      }`})]}),T={borderBottom:"solid 1px #ccc",background:"white",display:"flex",flexDirection:"row",padding:10},k={width:200,minWidth:200},N=({name:i,text:a})=>r("div",{style:T,children:[e("div",{style:k,children:i}),e("div",{children:a})]}),s={render:()=>{const i=n.useRef(0),a=()=>({id:String(i.current++),name:`${d.name.firstName()} ${d.name.lastName()}`,text:d.lorem.paragraphs(4)}),w=50,l=()=>Array.from({length:w},()=>a()),[m,I]=n.useState(l),[b,p]=n.useState(!1),[h,C]=n.useState([-1,-1]),f=n.useRef(-1);return r("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[r("div",{style:{background:"white",borderBottom:"solid 1px #ccc"},children:["items: ",m.length," index: (",h[0],", ",h[1],")"]}),r(S,{style:{flex:1},itemSize:200,onRangeChange:async({start:t,end:g,count:o})=>{n.startTransition(()=>{C([t,g])}),g+30>o&&f.current<o&&(f.current=o,p(!0),await new Promise(c=>setTimeout(c,1500)),I(c=>[...c,...l()]),p(!1))},children:[m.map(t=>e(N,{id:t.id,name:t.name,text:t.text},t.id)),e(v,{hidden:!b})]})]})}};var u,x,y;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => {
    const id = useRef(0);
...
//# sourceMappingURL=InfiniteScrolling.stories-af0403d1.js.map

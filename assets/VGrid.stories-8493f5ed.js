import{j as o,a as u}from"./jsx-runtime-c3d7f245.js";import{r as f}from"./index-c6dae603.js";import{b as m,c as H,r as ae,a as _e,v as Ie,W as Se,d as D,j as Ce,k as J,m as A,i as P}from"./Window-a2af8e74.js";import"./index-eb008d06.js";const O=(t,e)=>`${t}-${e}`,Ve=f.memo(({_children:t,_resizer:e,_vStore:h,_hStore:d,_rowIndex:g,_colIndex:a,_element:r,_isRtl:p})=>{const _=f.useRef(null),I=m(h,()=>h._getItemOffset(g),!0),S=m(d,()=>d._getItemOffset(a),!0),b=m(h,()=>h._isUnmeasuredItem(g),!0),C=m(d,()=>d._isUnmeasuredItem(a),!0),i=m(h,()=>h._getItemSize(g),!0),s=m(d,()=>d._getItemSize(a),!0);return H(()=>e._observeItem(_[ae],g,a),[a,g]),o(r,{ref:_,style:f.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:I,[p?"right":"left"]:S,visibility:b||C?"hidden":"visible",minHeight:i,minWidth:s}),[I,S,s,i,b,C]),children:t})}),v=f.forwardRef(({children:t,row:e,col:h,cellHeight:d=40,cellWidth:g=100,overscan:a=2,initialRowCount:r,initialColCount:p,rtl:_,element:I=Se,cellElement:S="div",...b},C)=>{const[i,s,N,y,w,ce]=_e(()=>{const n=!!_,l=D(e,d,r,!1),c=D(h,g,p,!1);return[l,c,Ce(l,c),J(l,!1,n),J(c,!0,n),n]});i._updateCacheLength(e),s._updateCacheLength(h);const[ue,he]=m(i,i._getRange),[me,pe]=m(s,s._getRange),fe=m(i,i._getIsScrolling),ge=m(s,s._getIsScrolling),ve=m(i,i._getJumpCount),be=m(s,s._getJumpCount),ye=m(i,i._getCorrectedScrollSize,!0),we=m(s,s._getCorrectedScrollSize,!0),E=f.useRef(null);H(()=>{const n=E[ae],l=N._observeRoot(n),c=y._initRoot(n),x=w._initRoot(n);return()=>{l(),c(),x()}},[]),H(()=>{const n=i._flushJump();n&&y._fixScrollJump(n)},[ve]),H(()=>{const n=s._flushJump();n&&w._fixScrollJump(n)},[be]),f.useImperativeHandle(C,()=>({get scrollOffset(){return[s._getScrollOffset(),i._getScrollOffset()]},get scrollSize(){return[w._getActualScrollSize(),y._getActualScrollSize()]},get viewportSize(){return[s._getViewportSize(),i._getViewportSize()]},scrollToIndex(n,l){w._scrollToIndex(n),y._scrollToIndex(l)},scrollTo(n,l){w._scrollTo(n),y._scrollTo(l)},scrollBy(n,l){w._scrollTo(s._getScrollOffset()+n),y._scrollTo(i._getScrollOffset()+l)}}),[]);const L=f.useMemo(()=>{const n=new Map;return(l,c)=>{let x=n.get(O(l,c));return x||n.set(O(l,c),x=t({rowIndex:l,colIndex:c})),x}},[t]),M=A(ue-a,0),q=P(he+a,e-1),W=A(me-a,0),j=P(pe+a,h-1),xe=f.useMemo(()=>{const n=[];for(let l=M;l<=q;l++)for(let c=W;c<=j;c++)n.push(o(Ve,{_resizer:N,_vStore:i,_hStore:s,_rowIndex:l,_colIndex:c,_element:S,_children:L(l,c),_isRtl:ce},O(l,c)));return n},[L,M,q,W,j]);return o(I,{ref:E,width:we,height:ye,scrolling:fe||ge,attrs:f.useMemo(()=>({...b,style:{overflow:"auto",contain:"strict",width:"100%",height:"100%",padding:0,margin:0,...b.style}}),Ie(b)),children:xe})});try{v.displayName="VGrid",v.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.
...
@defaultValue "div"`,name:"cellElement",required:!1,type:{name:"CustomCellComponentOrElement"}}}}}catch{}const ze={component:v},V={render:()=>o(v,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4},children:[t," / ",e]})})},G={render:()=>o(v,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100,height:(t%2+1)*100},children:[t," / ",e]})})},T={render:()=>o(v,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:(e%2+1)*100},children:[u("div",{children:[t," / ",e]}),Array.from({length:t%8+1},()=>o("div",{children:"Hello world!"}))]})})},k={render:()=>o(v,{style:{height:"100vh"},row:1e3,col:500,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,height:(t%2+1)*100},children:[u("div",{children:[t," / ",e]}),o("div",{children:Array.from({length:e%4+1},()=>o("span",{children:"Hello world!"}))})]})})},R={render:()=>o(v,{style:{height:"100vh",direction:"rtl"},row:1e3,col:500,rtl:!0,children:({rowIndex:t,colIndex:e})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:100},children:[t," / ",e]})})},z={render:()=>{const[e,h]=f.useState([567,567]),[d,g]=f.useState([1e3,1e3]),a=f.useRef(null);return u("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[u("div",{children:[u("label",{children:["col",o("input",{type:"number",value:e[0],onChange:r=>{h(p=>[Number(r.target.value),p[1]])}})]}),u("label",{children:["row",o("input",{type:"number",value:e[1],onChange:r=>{h(p=>[p[0],Number(r.target.value)])}})]}),o("button",{onClick:()=>{var r;(r=a.current)==null||r.scrollToIndex(e[0],e[1])},children:"scroll to index"}),o("button",{onClick:()=>{h([Math.round(1e3*Math.random()),Math.round(1e3*Math.random())])},children:"randomize"})]}),o("div",{children:u("div",{children:[u("label",{children:["x",o("input",{type:"number",value:d[0],onChange:r=>{g(p=>[Number(r.target.value),p[1]])}})]}),u("label",{children:["y",o("input",{type:"number",value:d[1],onChange:r=>{g(p=>[p[0],Number(r.target.value)])}})]}),o("button",{onClick:()=>{var r;(r=a.current)==null||r.scrollTo(d[0],d[1])},children:"scroll to offset"}),o("button",{onClick:()=>{var r;(r=a.current)==null||r.scrollBy(d[0],d[1])},children:"scroll by offset"})]})}),o(v,{ref:a,style:{height:"100vh"},row:1e3,col:1e3,children:({rowIndex:r,colIndex:p})=>u("div",{style:{border:"solid 1px gray",background:"white",padding:4,width:160,height:80},children:[r," / ",p]})})]})}};var B,F,K;V.parameters={...V.parameters,docs:{...(B=V.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => {
    return <VGrid style={{
      height: "100vh"
    }} row={1000} col={500}>
...
//# sourceMappingURL=VGrid.stories-8493f5ed.js.map

import{j as e,a as z}from"./jsx-runtime-c3d7f245.js";import{r as o}from"./index-c6dae603.js";import{S as se,d as oe}from"./common-4271bb5e.js";import{f as ie,u as ae,a as le,A as ce,b as x,c as B,r as E,e as de,v as ue,V as me,d as pe,g as fe,h as he,i as ge,U as ye,j as M,k as ve,l as _e,S as be,m as xe,n as Ce}from"./Viewport-c4794a8d.js";import{L as Se}from"./ListItem-f83180fc.js";import{r as Ie}from"./index-eb008d06.js";const c=o.forwardRef(({children:r,overscan:i=4,initialItemSize:a,initialItemCount:d,horizontal:g,cache:y,components:{Root:w=me,Item:v="div"}=pe,onScrollStop:f,onRangeChange:h,...u},m)=>{const _=o.useMemo(()=>ie(r),[r]),l=_.length,W=ae(f),[n,A,H,p]=le(()=>{const t=!!g,s=fe(Ie.flushSync,l,a,d,y,!1,!a);return[s,he(s,t),ge(s,t),t]});l!==n._getItemsLength()&&n._update(ce,[l]);const[V,L]=x(n,n._getRange,ye+M),T=x(n,n._getScrollDirection,ve),te=x(n,n._getJumpCount,_e),D=x(n,n._getCorrectedScrollSize,M,!0),N=o.useRef(null),k=T!==be;B(()=>{const t=N[E],s=A._observeRoot(t),b=H._initRoot(t);return()=>{s(),b()}},[]),B(()=>{const t=n._flushJump();t&&H._fixScrollJump(t)},[te]),o.useEffect(()=>{k||W[E]&&W[E]()},[k]),o.useEffect(()=>{h&&h(V,L)},[V,L]),o.useImperativeHandle(m,()=>({get cache(){return n._getCache()}}),[]);const O=xe(V,i,T),U=Ce(L,i,T,l),re=o.useMemo(()=>{const t=[];for(let s=O;s<=U;s++){const b=_[s],q=b.key;t.push(e(Se,{_resizer:A,_store:n,_index:s,_element:v,_children:b,_isHorizontal:p},de(q)?q:"_"+s))}return t},[_,O,U]);return e(w,{ref:N,width:p?D:void 0,height:p?void 0:D,scrolling:k,attrs:o.useMemo(()=>({...u,style:{display:p?"inline-block":"block",width:p?"auto":"100%",height:p?"100%":"auto",...u.style}}),ue(u)),children:re})});try{c.displayName="WVList",c.__docgenInfo={description:"Virtualized list component controlled by the window scrolling. See {@link WVListProps} and {@link WVListHandle}.",displayName:"WVList",props:{children:{defaultValue:null,description:"Elements rendered by this component.",name:"children",required:!0,type:{name:"ReactNode"}},overscan:{defaultValue:{value:"4"},description:`Number of items to render above/below the visible bounds of the list. You can increase to avoid showing blank items in fast scrolling.
...
//# sourceMappingURL=WVList.stories-669f41aa.js.map

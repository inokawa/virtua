import{j as o,F as p,a}from"./jsx-runtime-CWvgoIdH.js";const d=(e,r)=>Array.from({length:e}).map((s,n)=>r(n)),i=e=>new Promise(r=>setTimeout(r,e)),t=({style:e,height:r=100})=>o(p,{children:[a("div",{style:{...e,height:r,display:"flex",alignItems:"center",justifyContent:"center",background:"white"},children:a("span",{className:"loader"})}),a("style",{children:`
      .loader {
        width: 48px;
        height: 48px;
        border-radius: 50%;

    ...
    return <div style={{
      ...
      flexDirection: "column"
        ...
        e.preventDefault();
          ...
          flex: 1,
          background: "#fff"
        }} rows={ROWS + 1} rowHeight={26} cols={cols} colWidth="width" pinnedRows={1} pinnedCols={1}

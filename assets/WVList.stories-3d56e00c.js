import{j as e,a as T}from"./jsx-runtime-c3d7f245.js";import{r as o}from"./index-c6dae603.js";import{S as ne}from"./components-951de649.js";import{f as te,u as re,a as se,b,c as M,r as z,e as oe,v as ie,W as ae,d as le,g as de,h as ce,m as ue,i as me}from"./Window-a2af8e74.js";import{L as pe}from"./ListItem-24126322.js";import"./index-eb008d06.js";const u=o.forwardRef(({children:r,overscan:i=4,initialItemSize:a,initialItemCount:m,horizontal:g,cache:S,element:R=ae,itemElement:y="div",onScrollStop:p,onRangeChange:l,...d},W)=>{const c=o.useMemo(()=>te(r),[r]),v=c.length,L=re(p),[n,E,H,f]=se(()=>{const t=!!g,s=le(v,a,m,!1,S);return[s,de(s,t),ce(s,t),t]});n._updateCacheLength(v);const[I,V]=b(n,n._getRange),k=b(n,n._getIsScrolling),$=b(n,n._getJumpCount),q=b(n,n._getCorrectedScrollSize,!0),A=o.useRef(null);M(()=>{const t=A[z],s=E._observeRoot(t),h=H._initRoot(t);return()=>{s(),h()}},[]),M(()=>{const t=n._flushJump();t&&H._fixScrollJump(t)},[$]),o.useEffect(()=>{k||L[z]&&L[z]()},[k]),o.useEffect(()=>{l&&l({start:I,end:V,count:v})},[I,V]),o.useImperativeHandle(W,()=>({get cache(){return n._getCache()}}),[]);const B=ue(I-i,0),N=me(V+i,v-1),ee=o.useMemo(()=>{const t=[];for(let s=B;s<=N;s++){const h=c[s];oe(h)&&t.push(e(pe,{_resizer:E,_store:n,_index:s,_element:y,_children:h,_isHorizontal:f,_isRtl:!1},h.key||s))}return t},[c,B,N]);return e(R,{ref:A,width:f?q:void 0,height:f?void 0:q,scrolling:k,attrs:o.useMemo(()=>({...d,style:{overflow:"visible",display:f?"inline-block":"block",width:f?"auto":"100%",height:f?"100%":"auto",padding:0,margin:0,...d.style}}),ie(d)),children:ee})});try{u.displayName="WVList",u.__docgenInfo={description:"Virtualized list component controlled by the window scrolling. See {@link WVListProps}.",displayName:"WVList",props:{children:{defaultValue:null,description:"Elements rendered by this component.",name:"children",required:!0,type:{name:"ReactNode"}},overscan:{defaultValue:{value:"4"},description:`Number of items to render above/below the visible bounds of the list. You can increase to avoid showing blank items in fast scrolling.
...
@defaultValue "div"`,name:"itemElement",required:!1,type:{name:"CustomItemComponentOrElement"}},onScrollStop:{defaultValue:null,description:"Callback invoked when scrolling stops.",name:"onScrollStop",required:!1,type:{name:"() => void"}},onRangeChange:{defaultValue:null,description:"Callback invoked when visible items range changes.",name:"onRangeChange",required:!1,type:{name:"(payload: { start: number; end: number; count: number; }) => void"}}}}}catch{}const Z=r=>{const i=[20,40,80,77];return Array.from({length:r}).map((a,m)=>e("div",{style:{height:i[m%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:m},m))},fe=r=>Array.from({length:r}).map((i,a)=>T("div",{style:{width:a%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",a]},a)),Ce={component:u},w={render:()=>e("div",{style:{padding:200},children:e(u,{style:{border:"solid 1px gray"},children:Z(1e3)})})},C={render:()=>e("div",{style:{padding:200},children:e(u,{horizontal:!0,style:{height:400,border:"solid 1px gray"},children:fe(1e3)})})},x={render:()=>T("div",{style:{display:"flex",flexDirection:"row"},children:[e("div",{style:{flex:1,display:"flex",paddingTop:600},children:e(u,{style:{margin:10},children:Z(1e3)})}),e("div",{style:{flex:3,paddingBottom:600},children:e(u,{style:{margin:10},children:Array.from({length:1e3}).map((r,i)=>e("div",{style:{height:200,borderRadius:8,margin:16,background:"#fff"},children:i},i))})}),e("div",{style:{flex:2,padding:20,paddingTop:300},children:e("div",{style:{top:0,height:400,position:"sticky",background:"white"}})})]})},_={render:()=>{const r=(p,l=0)=>{const d=[20,40,80,77];return Array.from({length:p}).map((W,c)=>(c+=l,e("div",{style:{height:d[c%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:c},c)))},[i,a]=o.useState(!1),m=async()=>{a(!0),await new Promise(p=>setTimeout(p,1e3)),a(!1)},g=100,[S,R]=o.useState(()=>r(g)),y=o.useRef(-1);return e("div",{style:{padding:"200px 200px 0px 200px"},children:T(u,{onRangeChange:async({end:p,count:l})=>{p+50>l&&y.current<l&&(y.current=l,await m(),R(d=>[...d,...r(g,d.length)]))},children:[S,e(ne,{show:i})]})})}};var O,j,F;w.parameters={...w.parameters,docs:{...(O=w.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: 200
    }}>
...
//# sourceMappingURL=WVList.stories-3d56e00c.js.map

import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n}from"./iframe-BSFc6UdR.js";import{t as r}from"./react-dom-BHc_xkoZ.js";import{t as i}from"./jsx-runtime-DeHZSEgm.js";import{C as a,E as o,S as s,_ as c,b as l,c as u,i as d,l as f,m as p,n as m,o as h,r as g,s as _,t as v,u as y,w as b,x}from"./useLatestRef-Bodcdt6V.js";import{i as S,n as C,r as w,t as T}from"./useChildren-B9yE9qUv.js";import{n as E,r as D,t as O}from"./common-B2nOmsgX.js";var k,A,j,M;function N(){return(N=t((()=>{k=n(),o(),a(),x(),p(),f(),_(),g(),v(),S(),A=r(),T(),j=i(),M=(0,k.forwardRef)(({children:e,data:t,bufferSize:n,itemSize:r,shift:i,horizontal:a,cache:o,ssrCount:f,as:p=`div`,item:g=`div`,onScroll:_,onScrollEnd:v},x)=>{p=p;let[S,T]=C(e,t),E=(0,k.useRef)(null),D=m(_),O=m(v),M=(0,k.useRef)(!!f),[N,P,F,I]=d(()=>{let e=!!a,t=s(T,r,o),n=b(t,f);return[n,t,l(n,e),e]});T!==N.$getItemsLength()&&N.$update(5,[T,i]);let[L,R]=(0,k.useReducer)(N.$getStateVersion,void 0,N.$getStateVersion),z=N.$isScrolling(),B=N.$getTotalSize(),V=F.$isNegative(),H=[];y(()=>(M[u]=!1,N.$subscribe(1,e=>{e?(0,A.flushSync)(R):R()}),N.$subscribe(4,()=>{D.current&&D.current()}),N.$subscribe(8,()=>{O.current&&O.current()}),F.$observe(E[u]),()=>{N.$dispose(),F.$dispose()}),[]),y(()=>{F.$fixScrollJump()},[L]),(0,k.useImperativeHandle)(x,()=>({get cache(){return P.$snapshot()},get scrollOffset(){return N.$getScrollOffset()},get viewportSize(){return N.$getViewportSize()},findItemIndex:N.$findItemIndex,getItemOffset:N.$getItemOffset,getItemSize:N.$getItemSize,scrollToIndex:(e,t)=>c(F,N,e,t)}),[]);for(let[e,t]=N.$getRange(n);e<=t;e++){let t=S(e);H.push((0,j.jsx)(w,{_resizer:F.$observeItem,_index:e,_offset:N.$getItemOffset(e,V),_hide:N.$isUnmeasuredItem(e),_as:g,_children:t,_isHorizontal:I,_isSSR:M[u]},h(t,e)))}return(0,j.jsx)(p,{ref:E,style:{contain:`size style`,overflowAnchor:`none`,flex:`none`,position:`relative`,width:I?B:`100%`,height:I?`100%`:B,pointerEvents:z?`none`:void 0},children:H})}),M.__docgenInfo={description:`{@link Virtualizer} controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.`,methods:[{name:`cache`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`scrollOffset`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`viewportSize`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`scrollToIndex`,docblock:null,modifiers:[],params:[{name:`index`,optional:!1,type:null},{name:`opts`,optional:!1,type:null}],returns:null}],displayName:`WindowVirtualizer`,props:{children:{required:!0,tsType:{name:`union`,raw:`ReactNode | ((data: T, index: number) => ReactElement)`,elements:[{name:`ReactNode`},{name:`unknown`}]},description:`Elements rendered by this component.

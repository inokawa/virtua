import{a as e,j as a}from"./jsx-runtime-CWvgoIdH.js";import{r as i}from"./index-D3g0PtM7.js";import{S as ce,d as ue}from"./common-D8xz_2Ta.js";import{a as pe,A as me,b as he,u as M,r as C,U as fe,c as ge,k as ye,d as ve,l as be,S as we,e as xe,o as Se,p as _e}from"./useRerender-DCov8uv_.js";import{u as Ie,a as Re,L as Ce}from"./useChildren-sFf71w10.js";import{r as ke}from"./index-4KpVZEbj.js";const g=i.forwardRef(({children:o,count:s,overscan:t=4,itemSize:l,shift:r,horizontal:p,cache:c,ssrCount:m,as:h="div",item:v="div",onScrollEnd:b,onRangeChange:f},S)=>{h=h;const[y,n]=Ie(o,s),w=i.useRef(null),_=Re(b),I=i.useRef(!!m),[u,A,W,N]=pe(()=>{const d=!!p,x=xe(n,l,m,c,!l);return[x,Se(x,d),_e(x,d),d]});n!==u._getItemsLength()&&u._update(me,[n,r]);const q=he(u),[D,O]=u._getRange(),B=u._getScrollDirection(),le=u._getJumpCount(),P=u._getTotalSize(),U=[];M(()=>{I[C]=!1;const d=u._subscribe(fe+ge,de=>{de?ke.flushSync(q):q()}),x=u._subscribe(ye,()=>{_[C]&&_[C]()}),R=w[C];return A._observeRoot(R),W._observe(R),()=>{d(),x(),A._dispose(),W._dispose()}},[]),M(()=>{W._fixScrollJump()},[le]),i.useEffect(()=>{f&&f(D,O)},[D,O]),i.useImperativeHandle(S,()=>({get cache(){return u._getCacheSnapshot()}}),[]);for(let[d,x]=ve(D,O,t,B,n);d<=x;d++){const R=y(d);U.push(e(Ce,{_resizer:A._observeItem,_index:d,_offset:u._getItemOffset(d),_hide:u._isUnmeasuredItem(d),_element:v,_children:R,_isHorizontal:N,_isSSR:I[C]},be(R,d)))}return e(h,{ref:w,style:{flex:"none",position:"relative",visibility:"hidden",width:N?P:"100%",height:N?"100%":P,pointerEvents:B!==we?"none":"auto"},children:U})});try{g.displayName="WindowVirtualizer",g.__docgenInfo={description:"{@link Virtualizer } controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizer}.",displayName:"WindowVirtualizer",props:{children:{defaultValue:null,description:`Elements rendered by this component.
...
@defaultValue "div"`,name:"item",required:!1,type:{name:"keyof IntrinsicElements | CustomItemComponent"}},onScrollEnd:{defaultValue:null,description:"Callback invoked when scrolling stops.",name:"onScrollEnd",required:!1,type:{name:"(() => void)"}},onRangeChange:{defaultValue:null,description:"Callback invoked when visible items range changes.",name:"onRangeChange",required:!1,type:{name:"((startIndex: number, endIndex: number) => void)"}}}}}catch{}const H=o=>{const s=[20,40,80,77];return Array.from({length:o}).map((t,l)=>e("div",{style:{height:s[l%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:l},l))},ze=o=>Array.from({length:o}).map((s,t)=>a("div",{style:{width:t%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",t]},t)),De={component:g},k={render:()=>e("div",{style:{padding:"200px 100px"},children:e("div",{style:{border:"solid 1px gray"},children:e(g,{children:H(1e3)})})})},z={render:()=>e("div",{style:{padding:"100px 200px"},children:e("div",{style:{display:"inline-block",border:"solid 1px gray",height:400},children:e(g,{horizontal:!0,children:ze(1e3)})})})},V={render:()=>a("div",{style:{display:"flex",flexDirection:"column"},children:[e("div",{style:{background:"white",height:60,marginBottom:40},children:"header"}),a("div",{style:{display:"flex",flexDirection:"row"},children:[e("div",{style:{flex:1,display:"flex",paddingTop:600,margin:10},children:e(g,{children:H(1e3)})}),e("div",{style:{flex:3,margin:10},children:e(g,{children:Array.from({length:1e3}).map((o,s)=>e("div",{style:{height:200,borderRadius:8,margin:16,background:"#fff"},children:s},s))})}),e("div",{style:{flex:2,padding:20,paddingTop:300},children:e("div",{style:{top:0,height:400,position:"sticky",background:"white"}})})]}),e("div",{style:{background:"white",height:60,marginTop:40},children:"footer"})]})},E={render:()=>{const o=(v,b=0)=>{const f=[20,40,80,77];return Array.from({length:v}).map((S,y)=>(y+=b,e("div",{style:{height:f[y%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:y},y)))},[s,t]=i.useState(!1),l=async()=>{t(!0),await ue(1e3),t(!1)},r=100,[p,c]=i.useState(()=>o(r)),m=i.useRef(-1),h=p.length;return e("div",{style:{padding:"200px 100px 0px 100px"},children:a(g,{onRangeChange:async(v,b)=>{b+50>h&&m.current<h&&(m.current=h,await l(),c(f=>[...f,...o(r,f.length)]))},children:[p,s&&e(ce,{})]})})}},Ve=({id:o})=>{const s="window-list-cache-"+o,t=i.useRef(null),[l,r]=i.useMemo(()=>{const p=sessionStorage.getItem(s);if(!p)return[];try{return JSON.parse(p)}catch{return[]}},[]);return i.useLayoutEffect(()=>{if(!t.current)return;const p=t.current;window.scrollTo(0,l??0);let c=0;const m=()=>{c=window.scrollY};return window.addEventListener("scroll",m),m(),()=>{window.removeEventListener("scroll",m),sessionStorage.setItem(s,JSON.stringify([c,p.cache]))}},[]),e(g,{ref:t,cache:r,children:H(1e3)})},T={render:()=>{const[o,s]=i.useState(!0),[t,l]=i.useState("1");return a("div",{style:{position:"relative"},children:[a("div",{style:{position:"fixed",top:0,left:0,zIndex:10},children:[e("button",{onClick:()=>{s(r=>!r)},children:o?"hide":"show"}),["1","2","3"].map(r=>a("label",{children:[e("input",{type:"radio",checked:t===r,onChange:()=>{l(r)}}),r]},r))]}),o&&e(Ve,{id:t},t)]})}},L={render:()=>{const o=i.useRef(0),s=(n,w)=>Array.from({length:n}).map((_,I)=>(I+=w,{id:o.current++,index:I})),[t,l]=i.useState(!1),[r,p]=i.useState(4),[c,m]=i.useState(!1),[h,v]=i.useState(!0),[b,f]=i.useState(()=>s(r,0)),S=()=>{f(h?n=>{var w,_;return c?[...s(r,(((w=n[0])==null?void 0:w.index)??0)-r),...n]:[...n,...s(r,(((_=n[n.length-1])==null?void 0:_.index)??0)+1)]}:c?n=>n.slice(r):n=>n.slice(0,-r))};i.useEffect(()=>{if(!t)return;const n=setInterval(S,500);return()=>{clearInterval(n)}},[S,t]);const y=[20,40,80,77];return a("div",{style:{display:"flex",flexDirection:"column"},children:[a("div",{style:{position:"fixed",width:"100%",top:0,zIndex:1,backdropFilter:"blur(1px)"},children:[a("div",{children:[a("label",{style:{marginRight:4},children:[e("input",{type:"checkbox",style:{marginLeft:4},checked:c,onChange:()=>{m(n=>!n)}}),"prepend"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:h,onChange:()=>{v(!0)}}),"increase"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:!h,onChange:()=>{v(!1)}}),"decrease"]}),e("input",{style:{marginLeft:4},value:r,type:"number",min:1,max:1e4,step:1,onChange:n=>{p(Number(n.target.value))}})]}),a("div",{children:[a("label",{style:{marginRight:16},children:[e("input",{type:"checkbox",style:{marginLeft:4},checked:t,onChange:()=>{l(n=>!n)}}),"auto"]}),e("button",{onClick:()=>{S()},children:"update"})]})]}),e("div",{style:{flex:1},children:e(g,{shift:c,children:b.map(n=>e("div",{style:{height:y[Math.abs(n.index)%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:n.index},n.id))})})]})}};var j,F,J;k.parameters={...k.parameters,docs:{...(j=k.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      padding: "200px 100px"
    }}>

import{a as e,j as a,F as ze}from"./jsx-runtime-sgeEVxPu.js";import{r as n}from"./index-yp3VsGQP.js";import{S as G,d as $}from"./common-jfrYHwuZ.js";import{V as m}from"./VList-CbmB9Duj.js";import"./useRerender-5UbPLih8.js";import"./useChildren-7Kvug2i9.js";import"./index-8dy-jdxy.js";const nn={component:m},k=r=>{const t=[20,40,80,77];return Array.from({length:r}).map((s,i)=>e("div",{style:{height:t[i%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:i},i))},w={render:()=>e(m,{style:{height:"100vh"},children:k(1e3)})},Ge=r=>Array.from({length:r}).map((t,s)=>a("div",{style:{width:s%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",s]},s)),T={render:()=>e("div",{style:{padding:10},children:e(m,{style:{width:"100%",height:200},horizontal:!0,children:Ge(1e3)})})},L={render:()=>e(m,{style:{width:400,height:400,padding:"80px 20px",background:"lightgray"},children:Array.from({length:1e3}).map((r,t)=>e("div",{style:{height:100,borderRadius:8,margin:10,padding:10,background:"white"},children:t},t))})},A={render:()=>{const r=n.useRef(null);return n.useEffect(()=>{var t;(t=r.current)==null||t.scrollToIndex(999)},[]),e(m,{ref:r,style:{height:"100vh"},reverse:!0,children:k(1e3)})}},_={render:()=>{const r="item";return a(ze,{children:[e(m,{style:{height:"100vh"},children:Array.from({length:1e3}).map((t,s)=>e("div",{className:r,style:{borderBottom:"solid 1px #ccc",background:"#fff"},children:s},s))}),e("style",{children:`
          .${r} {
            height: 40px;
        ...
        `})]})}},B={render:()=>e(m,{style:{height:"100vh"},overscan:1,children:Array.from({length:100}).map((r,t)=>e("div",{style:{borderBottom:"solid 1px #ccc"},children:Array.from({length:10}).map((s,i)=>{const o=i===0;return e("div",{style:{height:60,background:"#fff",...o&&{top:0,height:30,position:"sticky",borderBottom:"solid 1px #ccc"}},children:o?t:`${t} - ${i}`},i)})},t))})},V={render:()=>{const[t,s]=n.useState(567),[i,o]=n.useState("start"),[c,u]=n.useState(!1),[g,f]=n.useState(1e3),h=n.useRef(null);return a("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[a("div",{children:[e("input",{type:"number",value:t,onChange:l=>{s(Number(l.target.value))}}),e("button",{onClick:()=>{var l;(l=h.current)==null||l.scrollToIndex(t,{align:i,smooth:c})},children:"scroll to index"}),e("button",{onClick:()=>{s(Math.round(1e3*Math.random()))},children:"randomize"}),a("label",{style:{marginLeft:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:i==="start",onChange:()=>{o("start")}}),"start"]}),a("label",{style:{marginLeft:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:i==="center",onChange:()=>{o("center")}}),"center"]}),a("label",{style:{marginLeft:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:i==="end",onChange:()=>{o("end")}}),"end"]}),a("label",{style:{marginLeft:4},children:[e("input",{type:"checkbox",style:{marginLeft:4},checked:c,onChange:()=>{u(l=>!l)}}),"smooth"]})]}),e("div",{children:a("div",{children:[e("input",{type:"number",value:g,onChange:l=>{f(Number(l.target.value))}}),e("button",{onClick:()=>{var l;(l=h.current)==null||l.scrollTo(g)},children:"scroll to offset"}),e("button",{onClick:()=>{var l;(l=h.current)==null||l.scrollBy(g)},children:"scroll by offset"})]})}),e(m,{ref:h,style:{flex:1},children:k(1e3)})]})}},E={render:()=>{const r=n.useRef(0),t=[20,40,80,77],s=()=>{const c=r.current++;return{id:c,height:t[c%4]}},[i,o]=n.useState(()=>Array.from({length:1e3}).map(()=>s()));return a("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[e("div",{children:e("button",{onClick:()=>{o(c=>[...c,...Array.from({length:500}).map(()=>s())])},children:"append more"})}),e(m,{style:{flex:1},count:i.length,children:c=>{const u=i[c];return e("div",{style:{height:u.height,borderBottom:"solid 1px #ccc",background:"#fff"},children:c},u.id)}})]})}},F={render:()=>{const r=n.useRef(null),[t,s]=n.useState(-1),i=Array.from({length:1e3}).map((o,c)=>e("div",{style:{height:60,borderBottom:"solid 1px #ccc",background:t===c?"skyblue":"white",cursor:"pointer"},onClick:()=>{s(c)},children:c},c));return e(m,{ref:r,style:{height:400,width:400,margin:10},tabIndex:0,onKeyDown:o=>{if(r.current)switch(o.code){case"ArrowUp":o.preventDefault();const c=Math.max(t-1,0);s(c),r.current.scrollToIndex(c,{align:"nearest"});break;case"ArrowDown":o.preventDefault();const u=Math.min(t+1,i.length-1);s(u),r.current.scrollToIndex(u,{align:"nearest"});break}},children:i})}},$e=({id:r})=>{const t="list-cache-"+r,s=n.useRef(null),[i,o]=n.useMemo(()=>{const c=sessionStorage.getItem(t);if(!c)return[];try{return JSON.parse(c)}catch{return[]}},[]);return n.useLayoutEffect(()=>{if(!s.current)return;const c=s.current;return i&&c.scrollTo(i),()=>{sessionStorage.setItem(t,JSON.stringify([c.scrollOffset,c.cache]))}},[]),e(m,{ref:s,cache:o,style:{height:"100vh"},children:k(1e3)})},H={render:()=>{const[r,t]=n.useState(!0),[s,i]=n.useState("1");return a("div",{children:[e("button",{onClick:()=>{t(o=>!o)},children:r?"hide":"show"}),["1","2","3"].map(o=>a("label",{children:[e("input",{type:"radio",checked:s===o,onChange:()=>{i(o)}}),o]},o)),r&&e($e,{id:s},s)]})}},je=()=>e("div",{style:{padding:8,background:"#fff",borderBottom:"solid 1px #ccc"},children:e("div",{style:{height:60,background:"#eee"}})}),O={render:()=>{const r=n.useRef(0),t=f=>{const h=[20,40,80,77];return Array.from({length:f}).map((l,p)=>{const x=r.current++;return e("div",{style:{height:h[p%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:x},x)})},[s,i]=n.useState(!1),o=async()=>{i(!0),await $(3e3),g(f=>[...f,...t(c)]),i(!1)},c=100,[u,g]=n.useState(()=>t(c));return a("div",{style:{display:"flex",flexDirection:"column",height:"100vh"},children:[e("div",{children:e("button",{onClick:()=>{o()},children:"load more"})}),a(m,{style:{flex:1},children:[u,s&&Array.from({length:c}).map((f,h)=>e(je,{},`skeleton_${h}`))]})]})}},D={render:()=>{const r=(h,l=0)=>{const p=[20,40,80,77];return Array.from({length:h}).map((x,y)=>(y+=l,e("div",{style:{height:p[y%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:y},y)))},[t,s]=n.useState(!1),i=async()=>{s(!0),await $(1e3),s(!1)},o=100,[c,u]=n.useState(()=>r(o)),g=n.useRef(-1),f=c.length;return a(m,{style:{flex:1},onRangeChange:async(h,l)=>{l+50>f&&g.current<f&&(g.current=f,await i(),u(p=>[...p,...r(o,p.length)]))},children:[c,t&&e(G,{})]})}},N={render:()=>{const r=n.useRef(0),t=v=>{const S=[20,40,80,77];return Array.from({length:v}).map(()=>{const R=r.current++;return e("div",{style:{height:S[R%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:R},R)})},[s,i]=n.useState(!1),[o,c]=n.useState(!1),[u,g]=n.useState(!1),f=async(v=!1)=>{i(v);const S=v?c:g;S(!0),await $(1e3),S(!1)},h=n.useRef(null),l=100,[p,x]=n.useState(()=>t(l*2)),y=50,b=p.length,C=n.useRef(-1),d=n.useRef(-1),I=n.useRef(!1);return n.useEffect(()=>{var v;(v=h.current)==null||v.scrollToIndex(p.length/2+1),I.current=!0},[]),a(m,{ref:h,style:{flex:1},shift:!!s,onRangeChange:async(v,S)=>{I.current&&(S+y>b&&d.current<b?(d.current=b,await f(),x(R=>[...R,...t(l)])):v-y<0&&C.current<b&&(C.current=b,await f(!0),x(R=>[...t(l).reverse(),...R])))},children:[e(G,{style:o?void 0:{visibility:"hidden"}},"head"),p,e(G,{style:u?void 0:{visibility:"hidden"}},"foot")]})}},M={render:()=>{const r=n.useRef(null),t=n.useState(()=>k(1e3))[0],[s,i]=n.useState(0),[o,c]=n.useState(!1),[u,g]=n.useState([-1,-1]),[f,h]=n.useState(!1),[l,p]=n.useState(!1);return n.useEffect(()=>{r.current&&(r.current.scrollOffset===0?h(!0):h(!1),r.current.scrollOffset-r.current.scrollSize+r.current.viewportSize>=-1.5?p(!0):p(!1))},[s]),a("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[a("div",{style:{background:"white",borderBottom:"solid 1px #ccc"},children:[a("div",{children:["scrollTop: ",s]}),a("div",{children:["scrolling: ",o?"true":"false"]}),a("div",{children:["index: (",u[0],", ",u[1],")"]}),a("div",{children:["at top: ",f?"true":"false"]}),a("div",{children:["at bottom: ",l?"true":"false"]})]}),e(m,{ref:r,style:{flex:1},onScroll:x=>{n.startTransition(()=>{i(x),c(!0)})},onScrollStop:()=>{n.startTransition(()=>{c(!1)})},onRangeChange:async(x,y)=>{n.startTransition(()=>{g([x,y])})},children:t})]})}},U={render:()=>{const[r,t]=n.useState({0:!0,3:!0,6:!0,9:!0,12:!0});return e(m,{style:{height:"100vh"},children:Array.from({length:1e3}).map((s,i)=>{const o=!!r[i];return a("div",{style:{borderBottom:"solid 1px #ccc",background:o?"lightpink":"#fff",display:"flex",flexDirection:"row",transition:"0.5s ease"},children:[e("div",{children:e("button",{style:{height:"100%"},onClick:()=>{t(c=>({...c,[i]:!c[i]}))},children:o?"close":"open"})}),e("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",flex:1,height:o?200:40,transition:"0.5s ease"},children:i})]},i)})})}},P={render:()=>{const r=n.useRef(0),t=(d,I)=>Array.from({length:d}).map((v,S)=>(S+=I,{id:r.current++,index:S})),[s,i]=n.useState(!1),[o,c]=n.useState(4),[u,g]=n.useState(!1),[f,h]=n.useState(!0),[l,p]=n.useState(!1),[x,y]=n.useState(()=>t(o,0)),b=()=>{y(f?d=>{var I,v;return u?[...t(o,(((I=d[0])==null?void 0:I.index)??0)-o),...d]:[...d,...t(o,(((v=d[d.length-1])==null?void 0:v.index)??0)+1)]}:u?d=>d.slice(o):d=>d.slice(0,-o))};n.useEffect(()=>{if(!s)return;const d=setInterval(b,500);return()=>{clearInterval(d)}},[b,s]);const C=[20,40,80,77];return a("div",{style:{height:"100vh",display:"flex",flexDirection:"column"},children:[a("div",{children:[a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:!u,onChange:()=>{g(!1)}}),"append"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:u,onChange:()=>{g(!0)}}),"prepend"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:f,onChange:()=>{h(!0)}}),"increase"]}),a("label",{style:{marginRight:4},children:[e("input",{type:"radio",style:{marginLeft:4},checked:!f,onChange:()=>{h(!1)}}),"decrease"]}),e("input",{style:{marginLeft:4},value:o,type:"number",min:1,max:1e4,step:1,onChange:d=>{c(Number(d.target.value))}})]}),e("div",{children:a("label",{style:{marginRight:4},children:[e("input",{type:"checkbox",style:{marginLeft:4},checked:l,onChange:()=>{p(d=>!d)}}),"reverse"]})}),a("div",{children:[a("label",{style:{marginRight:16},children:[e("input",{type:"checkbox",style:{marginLeft:4},checked:s,onChange:()=>{i(d=>!d)}}),"auto"]}),e("button",{onClick:()=>{b()},children:"update"})]}),e(m,{style:{flex:1},shift:!!u,reverse:l,children:x.map(d=>e("div",{style:{height:C[Math.abs(d.index)%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:d.index},d.id))})]})}},Ke=n.forwardRef(({children:r,attrs:t,height:s},i)=>e("div",{ref:i,...t,children:e("ul",{style:{position:"relative",height:s,margin:0,overflow:"hidden"},children:r})})),Je=n.forwardRef(({children:r,style:t},s)=>e("li",{ref:s,style:{...t,marginLeft:30},children:r})),z={render:()=>a("div",{style:{width:400,height:400,border:"solid 1px darkgray",borderRadius:8,background:"lightgray",display:"flex",flexDirection:"column",overflow:"hidden"},children:[e("div",{style:{padding:4},children:"header"}),e(m,{style:{flex:1,background:"#fff"},components:{Root:Ke,Item:Je},overscan:20,children:Array.from({length:1e3}).map((r,t)=>t)})]})};var j,K,J;w.parameters={...w.parameters,docs:{...(j=w.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
    return <VList style={{
      height: "100vh"
...
}`,...(q=(X=T.parameters)==null?void 0:X.docs)==null?void 0:q.source}}};var Q,Y,Z;L.parameters={...L.parameters,docs:{...(Q=L.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: () => {
    return <VList style={{
      width: 400,
      height: 400,
...
}`,...(Z=(Y=L.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,ne,te;A.parameters={...A.parameters,docs:{...(ee=A.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => {
...
}`,...(te=(ne=A.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};var re,se,oe;_.parameters={..._.parameters,docs:{...(re=_.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: () => {
...
}`,...(be=(xe=H.parameters)==null?void 0:xe.docs)==null?void 0:be.source}}};var Se,Ie,Re;O.parameters={...O.parameters,docs:{...(Se=O.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Re=(Ie=O.parameters)==null?void 0:Ie.docs)==null?void 0:Re.source}}};var ke,Ce,we;D.parameters={...D.parameters,docs:{...(ke=D.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  render: () => {
...
}`,...(we=(Ce=D.parameters)==null?void 0:Ce.docs)==null?void 0:we.source}}};var Te,Le,Ae;N.parameters={...N.parameters,docs:{...(Te=N.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  render: () => {
    const id = useRef(0);
    const createRows = (num: number) => {
      const heights = [20, 40, 80, 77];
...
}`,...(Ae=(Le=N.parameters)==null?void 0:Le.docs)==null?void 0:Ae.source}}};var _e,Be,Ve;M.parameters={...M.parameters,docs:{...(_e=M.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  render: () => {
    const ref = useRef<VListHandle>(null);
  ...
  render: () => {
    ...
    return <div style={{
      ...
      flexDirection: "column"
        ...
        <VList style={{
        flex: 1
      }} shift={prepend ? true : false} reverse={reverse}>
...
}`,...(Pe=(Ue=z.parameters)==null?void 0:Ue.docs)==null?void 0:Pe.source}}};const tn=["Default","Horizontal","PaddingAndMargin","Reverse","Responsive","Sticky","ScrollTo","RenderProp","Keyboard","ScrollRestoration","Skeleton","InfiniteScrolling","BiDirectionalInfiniteScrolling","Statuses","WithState","IncreasingItems","Ul"];export{N as BiDirectionalInfiniteScrolling,w as Default,T as Horizontal,P as IncreasingItems,D as InfiniteScrolling,F as Keyboard,L as PaddingAndMargin,E as RenderProp,_ as Responsive,A as Reverse,H as ScrollRestoration,V as ScrollTo,O as Skeleton,M as Statuses,B as Sticky,z as Ul,U as WithState,tn as __namedExportsOrder,nn as default};

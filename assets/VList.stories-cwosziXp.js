import{a as e,j as a,F as Pe}from"./jsx-runtime-sgeEVxPu.js";import{r as n}from"./index-yp3VsGQP.js";import{S as G,d as $}from"./common-jfrYHwuZ.js";import{V as m}from"./VList-CbmB9Duj.js";import"./useRerender-5UbPLih8.js";import"./useChildren-7Kvug2i9.js";import"./index-8dy-jdxy.js";const nn={component:m},R=r=>{const t=[20,40,80,77];return Array.from({length:r}).map((s,i)=>e("div",{style:{height:t[i%4],borderBottom:"solid 1px #ccc",background:"#fff"},children:i},i))},w={render:()=>e(m,{style:{height:"100vh"},children:R(1e3)})},Ge=r=>Array.from({length:r}).map((t,s)=>a("div",{style:{width:s%3===0?100:60,borderRight:"solid 1px #ccc",background:"#fff"},children:["Column ",s]},s)),T={render:()=>e("div",{style:{padding:10},children:e(m,{style:{width:"100%",height:200},horizontal:!0,children:Ge(1e3)})})},A={render:()=>e(m,{style:{width:400,height:400,padding:"80px 20px",background:"lightgray"},children:Array.from({length:1e3}).map((r,t)=>e("div",{style:{height:100,borderRadius:8,margin:10,padding:10,background:"white"},children:t},t))})},L={render:()=>{const r=n.useRef(null);return n.useEffect(()=>{var t;(t=r.current)==null||t.scrollToIndex(999)},[]),e(m,{ref:r,style:{height:"100vh"},reverse:!0,children:R(1e3)})}},_={render:()=>{const r="item";return a(Pe,{children:[e(m,{style:{height:"100vh"},children:Array.from({length:1e3}).map((t,s)=>e("div",{className:r,style:{borderBottom:"solid 1px #ccc",background:"#fff"},children:s},s))}),e("style",{children:`
          .${r} {
            height: 40px;
...
}`,...(He=(Fe=U.parameters)==null?void 0:Fe.docs)==null?void 0:He.source}}};var Oe,De,Ne;z.parameters={...z.parameters,docs:{...(Oe=z.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  render: () => {
    const id = useRef(0);
...
}`,...(Ne=(De=z.parameters)==null?void 0:De.docs)==null?void 0:Ne.source}}};var Me,Ue,ze;P.parameters={...P.parameters,docs:{...(Me=P.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      width: 400,
      height: 400,
...
}`,...(ze=(Ue=P.parameters)==null?void 0:Ue.docs)==null?void 0:ze.source}}};const tn=["Default","Horizontal","PaddingAndMargin","Reverse","Responsive","Sticky","ScrollTo","RenderProp","Keyboard","ScrollRestoration","Skeleton","InfiniteScrolling","BiDirectionalInfiniteScrolling","Statuses","WithState","IncreasingItems","Ul"];export{N as BiDirectionalInfiniteScrolling,w as Default,T as Horizontal,z as IncreasingItems,D as InfiniteScrolling,F as Keyboard,A as PaddingAndMargin,E as RenderProp,_ as Responsive,L as Reverse,H as ScrollRestoration,V as ScrollTo,O as Skeleton,M as Statuses,B as Sticky,P as Ul,U as WithState,tn as __namedExportsOrder,nn as default};

import{a as o,j as h}from"./jsx-runtime-sgeEVxPu.js";import{r as m}from"./index-yp3VsGQP.js";import{u as G,r as ce,i as Se,a as Ve,A,b as q,g as w,U as J,c as j,o as B,d as U,S as W,v as Ce,e as P,f as Te,h as F}from"./useRerender-w40Cc3mi.js";import{r as K}from"./index-8dy-jdxy.js";const Ge=m.forwardRef(({children:l,attrs:n,width:d,height:a,scrolling:p},c)=>o("div",{ref:c,...n,children:o("div",{style:m.useMemo(()=>({contain:"content",position:"relative",visibility:"hidden",width:d??"100%",height:a??"100%",pointerEvents:p?"none":"auto"}),[d,a,p]),children:l})})),k=(l,n)=>`${l}-${n}`,Re=m.memo(({_children:l,_resizer:n,_rowIndex:d,_colIndex:a,_top:p,_left:c,_height:t,_width:u,_hide:x,_element:R})=>{const v=m.useRef(null);return G(()=>n._observeItem(v[ce],d,a),[a,d]),o(R,{ref:v,style:m.useMemo(()=>({display:"grid",margin:0,padding:0,position:"absolute",top:p,[Se()?"right":"left"]:c,visibility:x?"hidden":"visible",minHeight:t,minWidth:u}),[p,c,u,t,x]),children:l})}),f=m.forwardRef(({children:l,row:n,col:d,cellHeight:a=40,cellWidth:p=100,overscan:c=2,initialRowCount:t,initialColCount:u,components:{Root:x=Ge,Cell:R="div"}={},...v},L)=>{const[i,s,E,b,y]=Ve(()=>{const e=P(n,a,t),r=P(d,p,u);return[e,r,Te(e,r),F(e,!1),F(r,!0)]});n!==i._getItemsLength()&&i._update(A,[n]),d!==s._getItemsLength()&&s._update(A,[d]);const O=q(i),z=q(s),[ue,he]=i._getRange(),[me,pe]=s._getRange(),H=i._getScrollDirection(),N=s._getScrollDirection(),fe=i._getJumpCount(),ge=s._getJumpCount(),ve=w(i),be=w(s),D=m.useRef(null);G(()=>{const e=D[ce],r=i._subscribe(J+j,g=>{g?K.flushSync(O):O()}),_=s._subscribe(J+j,g=>{g?K.flushSync(z):z()});return E._observeRoot(e),b._observe(e),y._observe(e),()=>{r(),_(),E._dispose(),b._dispose(),y._dispose()}},[]),G(()=>{const e=i._flushJump();e&&b._fixScrollJump(e)},[fe]),G(()=>{const e=s._flushJump();e&&y._fixScrollJump(e)},[ge]),m.useImperativeHandle(L,()=>({get scrollOffset(){return[s._getScrollOffset(),i._getScrollOffset()]},get scrollSize(){return[w(s),w(i)]},get viewportSize(){return[s._getViewportSize(),i._getViewportSize()]},scrollToIndex(e,r){y._scrollToIndex(e),b._scrollToIndex(r)},scrollTo(e,r){y._scrollTo(e),b._scrollTo(r)},scrollBy(e,r){y._scrollBy(e),b._scrollBy(r)}}),[]);const ye=m.useMemo(()=>{const e=new Map;return(r,_)=>{let g=e.get(k(r,_));return g||e.set(k(r,_),g=l({rowIndex:r,colIndex:_})),g}},[l]),_e=B(ue,c,H),xe=U(he,c,H,n),we=B(me,c,N),Ie=U(pe,c,N,d),M=[];for(let e=_e;e<=xe;e++)for(let r=we;r<=Ie;r++)M.push(o(Re,{_resizer:E,_rowIndex:e,_colIndex:r,_top:i._getItemOffset(e),_left:s._getItemOffset(r),_height:i._getItemSize(e),_width:s._getItemSize(r),_hide:i._isUnmeasuredItem(e)||s._isUnmeasuredItem(r),_element:R,_children:ye(e,r)},k(e,r)));return o(x,{ref:D,width:be,height:ve,scrolling:H!==W||N!==W,attrs:m.useMemo(()=>({...v,style:{overflow:"auto",overflowAnchor:"none",contain:"strict",width:"100%",height:"100%",...v.style}}),Ce(v)),children:M})});try{f.displayName="VGrid",f.__docgenInfo={description:"Virtualized grid component. See {@link VGridProps} and {@link VGridHandle}.",displayName:"VGrid",props:{children:{defaultValue:null,description:"A function to create elements rendered by this component.",name:"children",required:!0,type:{name:"(arg: { rowIndex: number; colIndex: number; }) => ReactNode"}},row:{defaultValue:null,description:"Total row length of grid.",name:"row",required:!0,type:{name:"number"}},col:{defaultValue:null,description:"Total column length of grid.",name:"col",required:!0,type:{name:"number"}},cellHeight:{defaultValue:{value:"40"},description:`Cell height hint for unmeasured items. It's recommended to specify this prop if item sizes are fixed and known, or much larger than the defaultValue. It will help to reduce scroll jump when items are measured.

import{c as u,b as y,i as k,d as I,u as h,h as C,t as S,j as _,e as b,s as f}from"./iframe-CWRXK0qT.js";import{V as p}from"./VList-h4WZv_Og.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-BFtdb-dX.js";import"./utils-C24_TLi6.js";var A=S("<div>"),V=S('<div style="border-bottom:solid 1px #ccc;padding-right:4px;padding-left:4px">');const E={component:p},L=40,l=new Set([0,100,200,300,400,500,600,700,800,900]),g=_(),P=e=>{const[c]=h(g);return(()=>{var t=A(),a=e.ref;return typeof a=="function"?C(a,t):e.ref=t,k(t,()=>e.children),I(n=>b(t,{...e.style,...l.has(e.index)&&{"z-index":1},...c()===e.index&&{position:"sticky",top:0}},n)),t})()},o={name:"Sticky Group",render:()=>{let e;const[c,t]=u(0),[a]=u(Array.from({length:1e3}).map((n,i)=>({id:i})));return y(g.Provider,{value:[c,t],get children(){return y(p,{ref:n=>e=n,get data(){return a()},item:P,get keepMounted(){return[c()]},onScroll:()=>{if(!e)return;const n=e.findItemIndex(e.scrollOffset),i=[...l].reverse().find(d=>n>=d);t(i)},children:(n,i)=>{const d=()=>l.has(i());return(()=>{var s=V();return k(s,()=>n.id),I(r=>{var x=(d()?L:80)+"px",m=d()?"#B8C1C8":"#fff",v=d()?"#fff":void 0;return x!==r.e&&f(s,"height",r.e=x),m!==r.t&&f(s,"background",r.t=m),v!==r.a&&f(s,"color",r.a=v),r},{e:void 0,t:void 0,a:void 0}),s})()}})}})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: "Sticky Group",
  render: () => {

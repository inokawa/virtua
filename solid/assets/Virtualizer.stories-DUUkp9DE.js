import{i as n,d as v,e as g,t as d,h as M,F as f,l as S,m as L,n as O}from"./web-DxNzkiKp.js";import{V as _}from"./Virtualizer-D_JO4PCp.js";import"./utils-C0mXXBYW.js";var I=d("<div style=height:500px;overflow:auto;><table><thead><tr>"),N=d("<th>Header"),R=d("<td>, "),U=d("<div style=max-height:400px;overflow:auto;><div>"),W=d("<div>Header"),j=d("<div>"),z=d("<div>, ");const E={component:_},b=p=>Array.from({length:p}).map((t,e)=>e),o=[100,200,300,100,200,300,100,300,400,200],m={render:()=>{let t;return(()=>{var e=I(),r=e.firstChild,i=r.firstChild,s=i.firstChild,l=t;return typeof l=="function"?M(l,e):t=e,s.style.setProperty("height","40px"),n(s,v(f,{each:o,children:(y,h)=>(()=>{var a=N();return a.firstChild,`${y}px`!=null?a.style.setProperty("width",`${y}px`):a.style.removeProperty("width"),n(a,h,null),a})()})),n(r,v(_,{scrollRef:t,startMargin:40,get data(){return b(1e4)},as:"tbody",item:"tr",children:(y,h)=>v(f,{each:o,children:(a,T)=>(()=>{var c=R(),D=c.firstChild;return`${a}px`!=null?c.style.setProperty("width",`${a}px`):c.style.removeProperty("width"),n(c,h,D),n(c,T,null),c})()})}),null),e})()}},u={render:()=>(()=>{var p=U(),t=p.firstChild;return t.style.setProperty("display","grid"),t.style.setProperty("position","sticky"),t.style.setProperty("top","0"),t.style.setProperty("background-color","white"),t.style.setProperty("z-index","1"),t.style.setProperty("width","fit-content"),n(t,()=>o.map((e,r)=>(()=>{var i=W();return i.firstChild,i.style.setProperty("padding","10px"),n(i,r,null),g(s=>(s=`${o[r]}px`)!=null?i.style.setProperty("width",s):i.style.removeProperty("width")),i})())),n(p,v(_,{get data(){return b(1e4)},item:e=>(()=>{var r=j();return S(r,L(e,{get style(){return{display:"grid","grid-template-columns":`repeat(${o.length}, 1fr)`,"border-bottom":"1px solid black",...e.style,width:"fit-content"}}}),!1,!0),n(r,()=>e.children),r})(),overscan:5,children:(e,r)=>O(()=>o.map((i,s)=>(()=>{var l=z(),y=l.firstChild;return l.style.setProperty("padding","10px"),n(l,r,y),n(l,s,null),g(h=>(h=`${o[s]}px`)!=null?l.style.setProperty("width",h):l.style.removeProperty("width")),l})()))}),null),g(e=>(e=`repeat(${o.length}, 1fr)`)!=null?t.style.setProperty("grid-template-columns",e):t.style.removeProperty("grid-template-columns")),p})()};var $,x,w;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => {

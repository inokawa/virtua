import{c as A,l as o,o as L,p as O,t as w,f as i,i as z,a as _,F as R,b as N,r as H,q as I,e as D,v as U}from"./iframe-D0g34sj7.js";import{c as P,h as j,U as G,b as M,d as F,L as J,j as Y,i as B,A as K}from"./utils-DvlZUOr8.js";import"./preload-helper-PPVm8Dsz.js";var Q=w("<div style=overflow-anchor:none>");const y=n=>{let l;const{ref:u,data:f,children:$,itemSize:p,shift:m,horizontal:h=!1,cache:T,onScrollEnd:ee}=n,e=P(n.data.length,p,void 0,T,!p),S=Y(e,h),g=j(e,h),[d,E]=A(e.$getStateVersion());e.$subscribe(G,()=>{E(e.$getStateVersion())}),e.$subscribe(M,()=>{n.onScroll?.()}),e.$subscribe(F,()=>{n.onScrollEnd?.()});const V=o(t=>{d();const a=e.$getRange(n.bufferSize);return t&&B(t,a)?t:a}),k=o(()=>d()&&e.$isScrolling()),x=o(()=>d()&&e.$getTotalSize());L(()=>{n.ref&&n.ref({get cache(){return e.$getCacheSnapshot()},get scrollOffset(){return e.$getScrollOffset()},get viewportSize(){return e.$getViewportSize()},findItemIndex:e.$findItemIndex,getItemOffset:e.$getItemOffset,getItemSize:e.$getItemSize,scrollToIndex:g.$scrollToIndex}),S.$observeRoot(l),g.$observe(l),U(()=>{n.ref&&n.ref(),e.$dispose(),S.$dispose(),g.$dispose()})}),O(H(d,()=>{g.$fixScrollJump()}));const W=o(()=>{const t=n.data.length;I(()=>{t!==e.$getItemsLength()&&e.$update(K,[t,n.shift])});const a=[];for(let[r,c]=V();r<=c;r++)a.push(n.data[r]);return a});return(()=>{var t=Q(),a=l;return typeof a=="function"?D(a,t):l=t,i(t,"contain","size style"),i(t,"flex","none"),i(t,"position","relative"),z(t,_(R,{get each(){return W()},children:(r,c)=>{const s=o(()=>V()[0]+c()),v=o(()=>(d(),e.$getItemOffset(s()))),C=o(()=>(d(),e.$isUnmeasuredItem(s()))),q=o(()=>I(()=>n.children(r,s)));return _(J,{get _index(){return s()},get _resizer(){return S.$observeItem},get _offset(){return v()},get _hide(){return C()},get _children(){return q()},_isHorizontal:h})}})),N(r=>{var c=h?x()+"px":"100%",s=h?"100%":x()+"px",v=k()?"none":void 0;return c!==r.e&&i(t,"width",r.e=c),s!==r.t&&i(t,"height",r.t=s),v!==r.a&&i(t,"pointer-events",r.a=v),r},{e:void 0,t:void 0,a:void 0}),t})()};try{y.displayName="WindowVirtualizer",y.__docgenInfo={description:"{@link Virtualizer } controlled by the window scrolling. See {@link WindowVirtualizerProps} and {@link WindowVirtualizerHandle}.",displayName:"WindowVirtualizer",props:{ref:{defaultValue:null,description:"Get reference to {@link WindowVirtualizerHandle}.",name:"ref",required:!1,type:{name:"((handle?: WindowVirtualizerHandle | undefined) => void) | undefined"}},data:{defaultValue:null,description:"The data items rendered by this component.",name:"data",required:!0,type:{name:"readonly T[]"}},children:{defaultValue:null,description:"The elements renderer function.",name:"children",required:!0,type:{name:"(data: T, index: Accessor<number>) => Element"}},bufferSize:{defaultValue:null,description:`Extra item space in pixels to render before/after the viewport. The minimum value is 0. Lower value will give better performance but you can increase to avoid showing blank items in fast scrolling.
...
**The length of items should be the same as when you take the snapshot, otherwise restoration may not work as expected.**`,name:"cache",required:!1,type:{name:"CacheSnapshot | undefined"}},onScroll:{defaultValue:null,description:"Callback invoked whenever scroll offset changes.",name:"onScroll",required:!1,type:{name:"(() => void) | undefined"}},onScrollEnd:{defaultValue:null,description:"Callback invoked when scrolling stops.",name:"onScrollEnd",required:!1,type:{name:"(() => void) | undefined"}}}}}catch{}var X=w("<div><div>"),Z=w('<div style="border-bottom:solid 1px #ccc">');const ie={component:y},b={render:()=>{const n=[20,40,80,77],l=Array.from({length:1e3}).map((u,f)=>n[f%4]);return(()=>{var u=X(),f=u.firstChild;return i(u,"padding","200px 100px"),i(f,"border","solid 1px gray"),z(f,_(y,{data:l,children:($,p)=>(()=>{var m=Z();return i(m,"height",$+"px"),i(m,"background","#fff"),z(m,p),m})()})),u})()}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: () => {

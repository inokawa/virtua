import{c as u,a as y,i as p,b as g,t as h,d as b,u as A,e as V,s as L,f}from"./iframe-CUoe0nz5.js";import{V as C}from"./VList-Bc67g-5d.js";import"./preload-helper-BQ24v_F8.js";import"./Virtualizer-LdD4HCB5.js";import"./utils-CvSqHCVq.js";var P=h("<div>"),G=h('<div style="border-bottom:solid 1px #ccc;padding-right:4px;padding-left:4px">');const z={component:C},H=40,x=new Set([0,100,200,300,400,500,600,700,800,900]),_=b(),B=e=>{const[c]=A(_);return(()=>{var t=P(),s=e.ref;return typeof s=="function"?V(s,t):e.ref=t,p(t,()=>e.children),g(n=>L(t,{...e.style,...x.has(e.index)&&{"z-index":1},...c()===e.index&&{position:"sticky",top:0}},n)),t})()},o={name:"Sticky Group",render:()=>{let e;const[c,t]=u(0),[s]=u(Array.from({length:1e3}).map((n,i)=>({id:i})));return y(_.Provider,{value:[c,t],get children(){return y(C,{ref:n=>e=n,get data(){return s()},item:B,get keepMounted(){return[c()]},onScroll:()=>{if(!e)return;const n=e.findStartIndex(),i=[...x].reverse().find(d=>n>=d);t(i)},children:(n,i)=>{const d=()=>x.has(i());return(()=>{var a=G();return p(a,()=>n.id),g(r=>{var l=(d()?H:80)+"px",v=d()?"#B8C1C8":"#fff",m=d()?"#fff":void 0;return l!==r.e&&f(a,"height",r.e=l),v!==r.t&&f(a,"background",r.t=v),m!==r.a&&f(a,"color",r.a=m),r},{e:void 0,t:void 0,a:void 0}),a})()}})}})}};var k,S,I;o.parameters={...o.parameters,docs:{...(k=o.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: "Sticky Group",
  render: () => {

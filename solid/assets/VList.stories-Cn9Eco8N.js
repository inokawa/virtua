import{b as _,t as m,s as l,i as o,c as h,d as y,f as N}from"./iframe-D80vSxR5.js";import{V as v}from"./VList-DlmPz4Cl.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-BMf8T_mf.js";import"./utils-C1rJU4CS.js";var I=m('<div style="border-bottom:solid 1px #ccc">'),M=m("<div>"),R=m('<div style="border-right:solid 1px #ccc">'),j=m("<div style=flex-direction:column><div>offset: </div><div>scrolling: </div><div><input type=number><button>scrollToIndex</button></div><div><button>append</button><label><input type=checkbox>prepend");const K={component:v},g={render:()=>{const c=[20,40,80,77],a=Array.from({length:1e3}).map((n,t)=>c[t%4]);return _(v,{data:a,style:{height:"100vh"},children:(n,t)=>(()=>{var s=I();return l(s,"height",n+"px"),l(s,"background","#fff"),o(s,t),s})()})}},f={render:()=>{const c=[40,180,77],a=Array.from({length:1e3}).map((n,t)=>c[t%3]);return(()=>{var n=M();return l(n,"padding","10px"),o(n,_(v,{data:a,style:{width:"100%",height:"200px"},horizontal:!0,children:(t,s)=>(()=>{var d=R();return l(d,"width",t+"px"),l(d,"background","#fff"),o(d,s),d})()})),n})()}},u={render:()=>{const c=[20,40,180,77],a=r=>({index:r,height:c[r%4]}),[n,t]=h(Array.from({length:1e3}).map((r,p)=>a(p))),[s,d]=h(0),[V,$]=h(!1),[k,A]=h(567),[b,E]=h(!1);let T;return(()=>{var r=j(),p=r.firstChild;p.firstChild;var x=p.nextSibling;x.firstChild;var C=x.nextSibling,S=C.firstChild,O=S.nextSibling,D=C.nextSibling,L=D.firstChild,w=L.nextSibling,z=w.firstChild;return l(r,"height","100%"),l(r,"display","flex"),o(p,s,null),o(x,()=>String(V()),null),S.$$input=e=>{A(Number(e.target.value))},O.$$click=()=>{T?.scrollToIndex(k())},L.$$click=()=>{t(e=>{const i=Array.from({length:100}).map((H,P)=>a(P+e.length));return b()?[...i,...e]:[...e,...i]})},z.addEventListener("change",()=>{E(e=>!e)}),o(r,_(v,{ref:e=>{T=e},get data(){return n()},get shift(){return b()},style:{height:"100vh"},onScroll:e=>{d(e),$(!0)},onScrollEnd:()=>{$(!1)},children:e=>(()=>{var i=I();return l(i,"background","#fff"),o(i,()=>e.index),y(H=>l(i,"height",e.height+"px")),i})()}),null),y(()=>S.value=k()),y(()=>z.checked=b()),r})()}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: () => {

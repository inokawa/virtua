...
And do not use index of items as `key`, especially when you want to toggle `shift` prop to true. Prepending will increase every indexes of items so that will cause strange behavior.

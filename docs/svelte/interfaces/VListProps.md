...
Defined in: [src/svelte/VList.type.ts:10](https://github.com/inokawa/virtua/blob/db45242c520cde38c38f994dbae0ae7f5538323a/src/svelte/VList.type.ts#L10)

Props of [VList](../type-aliases/VList.md).

## Extends

- `Pick`\<[`VirtualizerProps`](VirtualizerProps.md)\<`T`\>, `"data"` \| `"getKey"` \| `"bufferSize"` \| `"itemSize"` \| `"ssrCount"` \| `"shift"` \| `"horizontal"` \| `"children"` \| `"onscroll"` \| `"onscrollend"` \| `"keepMounted"` \| `"cache"` \| `"itemProps"`\>.`ViewportComponentAttributes`

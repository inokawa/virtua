...
Defined in: [src/svelte/VList.type.ts:10](https://github.com/inokawa/virtua/blob/af21e2bd82efe1198a3f0bf26daa7f18b0bf14eb/src/svelte/VList.type.ts#L10)
...
> `optional` **aria-dropeffect**: `null` \| `"copy"` \| `"link"` \| `"none"` \| `"move"` \| `"execute"` \| `"popup"`
...
> `optional` **aria-haspopup**: `null` \| `"dialog"` \| `"menu"` \| `"grid"` \| `"listbox"` \| `"tree"` \| `Booleanish`

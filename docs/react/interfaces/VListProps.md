...
Defined in: [src/react/VList.tsx:17](https://github.com/inokawa/virtua/blob/5072790752661114900e737891909dbe90b54dd0/src/react/VList.tsx#L17)

Props of [VList](../variables/VList.md).

## Extends

- `Pick`\<[`VirtualizerProps`](VirtualizerProps.md)\<`T`\>, `"children"` \| `"data"` \| `"overscan"` \| `"itemSize"` \| `"shift"` \| `"horizontal"` \| `"cache"` \| `"ssrCount"` \| `"item"` \| `"onScroll"` \| `"onScrollEnd"` \| `"keepMounted"`\>.[`ViewportComponentAttributes`](../type-aliases/ViewportComponentAttributes.md)
...
Defined in: [src/react/VList.tsx:37](https://github.com/inokawa/virtua/blob/5072790752661114900e737891909dbe90b54dd0/src/react/VList.tsx#L37)

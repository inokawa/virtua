import{c as F,i as Z,h as l,j as N,C as p,J as q,B as k,H as x,D as n,I as T,k as u,q as B,F as J,s as L,f as ee,g as re}from"./legacy-Dknq7eTc.js";import{b as s,e as E,i as M}from"./ListItem-BQqOrctg.js";import{V as H}from"./Virtualizer-Cm_CV5Dj.js";var te=p("<div> </div>"),oe=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function U(g,f){F(f,!1);const m=[20,40,180,77],_=Array.from({length:1e3}).map((v,a)=>m[a%4]),b=400;Z();var d=oe();s(d,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

import{f as p,n as $,a as l,b as N,d as T,j as R,t as H,c as n,q as E,g as u,s as S,h as K,k as q,l as D}from"./iframe-DLL8TZbQ.js";import{i as I}from"./legacy-Cxx8kGZN.js";import{s,b as V,e as F,i as M}from"./ListItem-BYaoFvmo.js";import{V as k}from"./Virtualizer-DWKfP9pM.js";import"./preload-helper-PPVm8Dsz.js";var L=p("<div> </div>"),U=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function W(g,f){T(f,!1);const m=[20,40,180,77],b=Array.from({length:1e3}).map((v,a)=>m[a%4]),_=400;I();var d=U();s(d,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

import{w as p,I as $,b as l,d as N,e as T,K as M,H,x as n,J as E,i as u,g as R,s as S,c as D,f as J}from"./iframe-Dn5NlTzw.js";import{i as L}from"./legacy-Bc1IPWOQ.js";import{r as s,k as V,m as F,u as K}from"./ListItem-BwFLpkQu.js";import{V as k}from"./Virtualizer-DxXnW1HN.js";import"./preload-helper-PPVm8Dsz.js";var U=p("<div> </div>"),W=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function j(g,f){T(f,!1);const m=[20,40,180,77],b=Array.from({length:1e3}).map((v,a)=>m[a%4]),_=400;L();var d=W();s(d,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

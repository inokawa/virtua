import{I as k,d as D,e as K,w as x,H as w,b,J as f,x as l,g as h,h as P,K as g,s as u,i as r,L as Q}from"./iframe-COGvZPqL.js";import{i as N}from"./legacy-BgmTW5l_.js";import{r as T,k as R,t as U}from"./ListItem-D1KzzovQ.js";import{V as H,b as W}from"./VList-BOHQu6DW.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-CJTRO5HA.js";var X=x("<div> </div>");function Y(n,e){K(e,!1);const o=[20,40,180,77],v=Array.from({length:1e3}).map((s,a)=>o[a%4]);N(),H(n,{get data(){return v},style:"height: 100vh;",getKey:(a,i)=>i,children:(a,i=k,d=k)=>{var t=X(),c=l(t);w(()=>{T(t,`
        height: ${i()??""}px;
        background: white;

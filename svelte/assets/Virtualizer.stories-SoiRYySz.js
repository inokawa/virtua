import{f as p,n as $,a as l,b as N,d as T,o as R,j as H,e as n,k as E,g as m,s as S,i as K,v as D,w as I}from"./iframe-BBd0Fu8Q.js";import{i as L,c as s,b as V,e as F,f as M}from"./legacy-CLAQAVar.js";import{V as k}from"./Virtualizer-Dfu8uqha.js";import"./preload-helper-PPVm8Dsz.js";var U=p("<div> </div>"),W=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function q(g,f){T(f,!1);const u=[20,40,180,77],b=Array.from({length:1e3}).map((v,a)=>u[a%4]),_=400;L();var d=W();s(d,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

import{n as e}from"./chunk-BneVvdWh.js";import{B as t,D as n,G as r,H as i,J as a,L as o,N as s,O as c,T as l,V as u,W as d,X as f,Y as p,Z as m,d as h,h as g,j as _,k as v,l as y,m as b,o as x,p as S,u as C,w,z as T}from"./iframe-D-MTZr4W.js";import{r as E,t as D}from"./svelte-BDi6qKWW.js";import{t as O}from"./legacy-Dd3ziU-t.js";function k(e,t){r(t,!1);let n=[20,40,180,77],i=Array.from({length:1e3}).map((e,t)=>n[t%4]);y(),E(e,{get data(){return i},style:`height: 100vh;`,getKey:(e,t)=>t,children:(e,t=f,n=f)=>{var r=A(),i=o(r,!0);p(r),s(()=>{g(r,`
        height: ${t()??``}px;
        background: white;

import{n as z,b as I,d as T,f as x,t as w,a as b,q as g,c as l,s as f,p as Q,j as _,h as v,g as r,o as R}from"./iframe-DLL8TZbQ.js";import{i as N}from"./legacy-Cxx8kGZN.js";import{s as K,b as U,a as W}from"./ListItem-BYaoFvmo.js";import{V as A,b as X}from"./VList-lihAUzNi.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-DWKfP9pM.js";var Y=x("<div> </div>");function Z(a,t){T(t,!1);const e=[20,40,180,77],u=Array.from({length:1e3}).map((s,n)=>e[n%4]);N(),A(a,{get data(){return u},style:"height: 100vh;",getKey:(n,i)=>i,children:(n,i=z,c=z)=>{var o=Y(),d=l(o);w(()=>{K(o,`
        height: ${i()??""}px;
        background: white;

import{p as N,a as l,b as T,f as p,k as L,t as H,n as $,c as n,h as E,g as u,d as U,s as W,o as Z,q as ee}from"./iframe-B_aFPW-l.js";import{i as te,c as d,b as j,e as F,f as M}from"./legacy-CgqApKn8.js";import{V as A}from"./Virtualizer-D8E_PJqy.js";import"./preload-helper-BQ24v_F8.js";var re=p("<div> </div>"),oe=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function B(g,f){N(f,!1);const m=[20,40,180,77],_=Array.from({length:1e3}).map((v,a)=>m[a%4]),b=400;te();var s=oe();d(s,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

import{f as p,n as $,a as l,b as N,c as T,i as R,t as H,m as n,r as E,g as u,s as S,h as K,j as D,k as I}from"./iframe-CX1VFtIp.js";import{i as L}from"./legacy-CZSj3VAJ.js";import{s,b as V,e as F,i as M}from"./ListItem-4PeDk6zc.js";import{V as k}from"./Virtualizer-Bfq-f6BG.js";import"./preload-helper-PPVm8Dsz.js";var U=p("<div> </div>"),W=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function q(g,f){T(f,!1);const m=[20,40,180,77],b=Array.from({length:1e3}).map((v,a)=>m[a%4]),_=400;L();var d=W();s(d,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

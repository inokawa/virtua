import{i as e}from"./preload-helper-xPQekRTU.js";import{$ as t,B as n,F as r,I as i,J as a,R as o,V as s,W as c,_t as l,bt as u,dt as d,f,ft as p,gt as m,it as h,m as g,nt as _,o as v,ot as y,st as b,u as x,v as S,x as C,y as w,yt as T}from"./iframe-C99BiTed.js";import{i as E,t as D}from"./svelte-CsGQFKdt.js";import{t as O}from"./legacy-CVNOeiym.js";function k(e,n){p(n,!1);let o=[20,40,180,77],s=Array.from({length:1e3}).map((e,t)=>o[t%4]);x(),E(e,{get data(){return s},style:`height: 100vh;`,getKey:(e,t)=>t,children:(e,n=T,o=T)=>{var s=A(),c=t(s,!0);l(s),a(()=>{C(s,`
        height: ${n()??``}px;
        background: white;

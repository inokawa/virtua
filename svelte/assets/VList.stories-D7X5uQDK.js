import{n as A,b as K,c as S,t as D,a as x,m as $,r as _,l as i,s as m,p as R,f as d,g as e,d as b,h as p,q as U}from"./iframe-DhmU-Orz.js";import{i as B}from"./legacy-Db7wDzvL.js";import{s as V,b as W,a as X}from"./ListItem-DZ4P1HdF.js";import{V as H,b as Y}from"./VList-DRyvgQgr.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-BOIJ_JA5.js";var Z=$("<div> </div>");function tt(h,f){S(f,!1);const g=[20,40,180,77],u=Array.from({length:1e3}).map((c,t)=>g[t%4]);B(),H(h,{get data(){return u},style:"height: 100vh;",getKey:(t,l)=>l,children:(t,l=A,a=A)=>{var r=Z(),n=i(r);D(()=>{V(r,`
        height: ${l()??""}px;
        background: white;

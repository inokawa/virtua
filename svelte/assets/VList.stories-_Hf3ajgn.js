import{n as A,b as K,c as S,f as $,t as D,a as x,r as _,m as i,s as m,p as R,h as d,g as e,d as b,i as p,q as U}from"./iframe-CX1VFtIp.js";import{i as B}from"./legacy-CZSj3VAJ.js";import{s as V,b as W,a as X}from"./ListItem-4PeDk6zc.js";import{V as H,b as Y}from"./VList-DrU0mQwd.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-Bfq-f6BG.js";var Z=$("<div> </div>");function tt(h,f){S(f,!1);const g=[20,40,180,77],u=Array.from({length:1e3}).map((c,t)=>g[t%4]);B(),H(h,{get data(){return u},style:"height: 100vh;",getKey:(t,l)=>l,children:(t,l=A,a=A)=>{var r=Z(),n=i(r);D(()=>{V(r,`
        height: ${l()??""}px;
        background: white;

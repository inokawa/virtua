import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{E as t,G as n,I as r,L as i,R as a,S as o,T as s,Y as c,_t as l,bt as u,ct as d,d as f,et as p,ft as m,p as h,pt as g,rt as _,s as v,st as y,tt as b,vt as x,xt as S,z as C}from"./iframe-0A2iH7bm.js";import{n as w,t as T}from"./Virtualizer-Ck65dhML.js";import{t as E}from"./legacy-MQwxS09g.js";function D(e,t){g(t,!1);let n=[20,40,80,77],a=Array.from({length:1e3}).map((e,t)=>n[t%4]);f();var s=k();o(s,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;
...
`);var d=p(s);o(d,`background-color: burlywood; height: 400px;`);var h=_(d,2);T(h,{get data(){return a},getKey:(e,t)=>t,startMargin:400,children:(e,t=u,n=u)=>{var a=O(),s=p(a,!0);x(a),c(()=>{o(a,`
      ...
      `),r(s,n())}),i(e,a)},$$slots:{default:!0}}),l(2),x(s),i(e,s),m()}var O,k;function A(){return(A=e((()=>{S(),E(),v(),w(),O=C(`<div> </div>`),k=C(`<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>`)})))()}function j(e,t){g(t,!0);let a=[20,40,80,77],s=Array.from({length:1e3}).map((e,t)=>a[t%4]),l=d(void 0);var f=N();o(f,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;
  /* opt out browser's scroll anchoring on header/footer because it will conflict to scroll anchoring of virtualizer */

import{n as A,p as K,a as S,t as D,b as x,f as $,s as _,c as i,d as m,e as R,g as d,h as e,i as b,j as p,k as U}from"./iframe-DTdt-vSd.js";import{i as B}from"./legacy-BKoB70m6.js";import{s as V,b as W,a as X}from"./ListItem-B2FbpipZ.js";import{V as H,b as Y}from"./VList-vAb2Qcgf.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-El0PbQbN.js";var Z=$("<div> </div>");function tt(h,f){S(f,!1);const g=[20,40,180,77],u=Array.from({length:1e3}).map((c,t)=>g[t%4]);B(),H(h,{get data(){return u},style:"height: 100vh;",getKey:(t,l)=>l,children:(t,l=A,a=A)=>{var r=Z(),n=i(r);D(()=>{V(r,`
        height: ${l()??""}px;
        background: white;

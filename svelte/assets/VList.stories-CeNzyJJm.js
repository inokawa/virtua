import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{G as t,H as n,I as r,L as i,S as a,V as o,Y as s,_t as c,at as l,b as u,bt as d,ct as f,d as p,et as m,ft as h,h as g,p as _,pt as v,rt as y,s as b,st as x,vt as S,xt as C,y as w,z as T}from"./iframe-Xmr8eDEC.js";import{n as E,t as D}from"./VList-CWHLkR_g.js";import{t as O}from"./legacy-CYoZgZhr.js";function k(e,t){v(t,!1);let n=[20,40,180,77],o=Array.from({length:1e3}).map((e,t)=>n[t%4]);p(),D(e,{get data(){return o},style:`height: 100vh;`,getKey:(e,t)=>t,children:(e,t=d,n=d)=>{var o=A(),c=m(o,!0);S(o),s(()=>{a(o,`
        height: ${t()??``}px;
        background: white;

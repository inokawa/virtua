import{G as $,e as l,g as F,h as N,J as R,F as H,D as p,C as n,H as T,i as u,a as S,s as K,d as G,f as I}from"./iframe-Sd25QDp4.js";import{i as J}from"./legacy-CNGs5lSI.js";import{r as s,k as V,m as E,u as M}from"./ListItem-D3qDVHWj.js";import{V as k}from"./Virtualizer-BLIpTfSw.js";import"./preload-helper-PPVm8Dsz.js";var L=p("<div> </div>"),U=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function W(g,f){N(f,!1);const m=[20,40,180,77],b=Array.from({length:1e3}).map((v,a)=>m[a%4]),_=400;J();var d=U();s(d,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

import{I as k,d as D,e as K,w as x,H as w,b,J as f,x as l,g as h,h as P,K as g,s as u,i as r,L as Q}from"./iframe-CuePRPV4.js";import{i as N}from"./legacy-TdCXcsII.js";import{r as T,k as R,t as U}from"./ListItem-O4Nk-tcJ.js";import{V as H,b as W}from"./VList-Cq3h6Ai6.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-ClfLloM5.js";var X=x("<div> </div>");function Y(n,e){K(e,!1);const o=[20,40,180,77],v=Array.from({length:1e3}).map((s,a)=>o[a%4]);N(),H(n,{get data(){return v},style:"height: 100vh;",getKey:(a,i)=>i,children:(a,i=k,d=k)=>{var t=X(),c=l(t);w(()=>{T(t,`
        height: ${i()??""}px;
        background: white;

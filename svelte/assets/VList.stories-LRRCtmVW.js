import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{C as t,G as n,H as r,I as i,L as a,V as o,Y as s,_t as c,at as l,bt as u,ct as d,d as f,et as p,ft as m,h,p as g,pt as _,rt as v,s as y,st as b,vt as x,x as S,xt as C,y as w,z as T}from"./iframe-CNY-yPbo.js";import{n as E,t as D}from"./VList-C1yDFxTL.js";import{t as O}from"./legacy-DFtytx0t.js";function k(e,n){_(n,!1);let r=[20,40,180,77],o=Array.from({length:1e3}).map((e,t)=>r[t%4]);f(),D(e,{get data(){return o},style:`height: 100vh;`,getKey:(e,t)=>t,children:(e,n=u,r=u)=>{var o=A(),c=p(o,!0);x(o),s(()=>{t(o,`
        height: ${n()??``}px;
        background: white;

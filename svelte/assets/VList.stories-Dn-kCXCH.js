import{G as D,g as T,h as S,F as H,e as x,D as $,H as b,C as i,a as m,b as R,s as d,i as e,I as _,J as p,K as U}from"./iframe-BejLQ092.js";import{i as N}from"./legacy-wHCGpZOS.js";import{r as V,k as W,t as X}from"./ListItem-BgY3xKk5.js";import{V as I,b as Y}from"./VList-FV2vtMnt.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-Cz9bL6a4.js";var Z=$("<div> </div>");function tt(h,g){S(g,!1);const f=[20,40,180,77],u=Array.from({length:1e3}).map((c,t)=>f[t%4]);N(),I(h,{get data(){return u},style:"height: 100vh;",getKey:(t,l)=>l,children:(t,l=D,a=D)=>{var r=Z(),n=i(r);H(()=>{V(r,`
        height: ${l()??""}px;
        background: white;

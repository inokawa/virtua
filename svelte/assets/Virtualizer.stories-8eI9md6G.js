import{f as p,n as $,a as l,b as N,d as T,o as L,j as H,e as n,k as E,g as u,s as U,i as W,v as Z,w as ee}from"./iframe-CJlrgrMM.js";import{i as te,c as d,b as q,e as F,f as M}from"./legacy-Bhyk44Gs.js";import{V as A}from"./Virtualizer-7KwORP1v.js";import"./preload-helper-BQ24v_F8.js";var re=p("<div> </div>"),oe=p('<div><div>header</div> <!> <div style="background-color: steelblue; height: 600px;">footer</div></div>');function B(g,f){T(f,!1);const m=[20,40,180,77],_=Array.from({length:1e3}).map((v,a)=>m[a%4]),b=400;te();var s=oe();d(s,`
  width: 100%;
  height: 100vh;
  overflow-y: auto;

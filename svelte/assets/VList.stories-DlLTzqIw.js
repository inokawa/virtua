import{n as k,b as I,d as T,f as x,t as w,a as b,q as g,c as l,s as h,p as P,j as f,h as u,g as r,o as Q}from"./iframe-DbuMeVFe.js";import{i as E}from"./legacy-KpyL8NFU.js";import{s as K,b as R,a as U}from"./ListItem-BQOwxyW6.js";import{V as A,b as W}from"./VList-CvjYw4yZ.js";import"./preload-helper-PPVm8Dsz.js";import"./Virtualizer-Bhuau8v8.js";var X=x("<div> </div>");function Y(n,e){T(e,!1);const o=[20,40,180,77],v=Array.from({length:1e3}).map((s,a)=>o[a%4]);E(),A(n,{get data(){return v},style:"height: 100vh;",getKey:(a,i)=>i,children:(a,i=k,d=k)=>{var t=X(),c=l(t);w(()=>{K(t,`
        height: ${i()??""}px;
        background: white;
